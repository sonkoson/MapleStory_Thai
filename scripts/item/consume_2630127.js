...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        말 += "#L0##i5002561# #b#z5002561##k 받기\r\n";
        말 += "#L1##i5002562# #b#z5002562##k 받기\r\n";
        말 += "#L2##i5002563# #b#z5002563##k 받기\r\n";
        ...
        if (selection == 0) {
            ...
            cm.sendOk("#fs11#" + 검정 + " #i5002561# #b#z5002561#" + 검정 + "을 지급했다네! 캐시창을 확인해보게.");
            ...
            cm.sendOk("#fs11#" + 검정 + " #i5002562# #b#z5002562#" + 검정 + "을 지급했다네! 캐시창을 확인해보게.");
            ...
            cm.sendOk("#fs11#" + 검정 + " #i5002563# #b#z5002563#" + 검정 + "을 지급했다네! 캐시창을 확인해보게.");
