...
function action(mode, type, selection) {
	...
	seld = selection;
	cm.sendYesNoS("#fs11#정말 받고싶은 아이템이 #i"+심볼[selection]+"# #d#z"+심볼[selection]+"##k (이)가 맞으신가요?", 0x04, 9010061);
    } else if (status == 2) {
	...
	cm.sendOkS("#fs11##i"+심볼[seld]+"# #d#z"+심볼[seld]+"# #b"+지급개수+" 개#k 를 지급 해드렸습니다.", 0x04, 9010061);
	cm.dispose();
    }
}