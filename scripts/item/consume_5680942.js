...
var allstat = 0, atk = 100; // 1회당 올스텟, 공마 증가치
...
function action(mode, type, sel) {
    ...
    if (status == 0) {
        var txt = "#fs11##fc0xFF000000#캐시아이템을 #b#z5680942##fc0xFF000000#로 강화할 수 있다는 사실을 알고 계시나요? #b원하시는 캐시아이템#fc0xFF000000#을 골라주세요.\r\n#r(1회당  공,마 100 증가 중첩가능 / 최대 모든상자합산 50회)#k\r\n";
        ...
        if (!cm.haveItem(5680942, 1)) {
            cm.sendOk("#fs11##fc0xFF000000#1회 강화하기 위해선 #b" + price + " #z5680942##fc0xFF000000#가 필요합니다.");
            cm.dispose();
            return;
        }
