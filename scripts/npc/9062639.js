...
function action(mode, type, selection) {
    ...
    if (St == 0) {
        var choose = 연보+":: 상점 시스템입니다 원하시는 상점을 선택해주세요! #k#fs30#\r\n";
        //choose = "#fc0xFFD5D5D5#───────────────────────────#k\r\n\r\n";
        choose += "#fs12##L0##fc0xFF6B66FF#" + 강화 + " 강화아이템 상점#l";        choose += "#L4##fc0xFF030066#" + 보스 + " 보스결정석 판매#l\r\n\r\n";
        choose += "#L1##fc0xFF6B66FF#" + 소비 + " 소비아이템 상점#l";                choose += "#L1000##fc0xFF030066#" + 소비 + " 안드로이드 상점#l\r\n\r\n";
        choose += "#L3##fc0xFF6B66FF#" + 보조 + " 보조아이템 상점#l";                choose += "#L7##fc0xFF030066# 유니온소비 상점#l";        
        ...
        choose += "\r\n\r\n#fc0xFFD5D5D5#───────────────────────────#k\r\n";
        choose += "#L16##fc0xFF8C8C8C#" + 엠블렘 + " 출석코인 상점#l　";         choose += "#L102##fc0xFF8C8C8C#" + 엠블렘 + " 메소코인 상점#l　";
        ...
        choose += "\r\n\r\n#fc0xFFD5D5D5#───────────────────────────#k\r\n";
        choose += "#L18##fc0xFFF15F5F#" + 포인트 + " 홍보포인트 상점#l　";
        choose += "#L19##fc0xFFF15F5F#" + 포인트 + " 후원포인트 상점#l";
          choose += "\r\n\r\n#fc0xFFD5D5D5#───────────────────────────#k\r\n";
        choose +="#L8##fc0xFF8041D9# 앱솔랩스장비 상점#l";
        ...
        if (selection == 0) {
            ...
            말 = "#fs11##b"+서버이름+" 잠수 포인트#k" + 검정 + " 획득 방법에 대해 알려주겠네.\r\n\r\n"
