...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		switch (isclear) {
			case 1:
				var msg = "타락한 세계수를 구원해주시오.."+enter+enter;
				msg += "#fUI/UIWindow2.img/UtilDlgEx/list1#\r\n#d#L1#(Lv."+제한레벨+") #b#e[일일 퀘스트]#n#k #d타락한 세계수";

				cm.sendSimple(msg);
			break;
			case 2:
				var msg = "안녕 #b#h ##k! 오늘의 의뢰는 이런 것들이 있소."+enter+enter;
				msg += "#fUI/UIWindow2.img/UtilDlgEx/list0#\r\n#r#e[일일 퀘스트] : 타락한 세계수#n#k"+enter;
			...
			case 4:
				var msg = "타락한 세계수를 구원해주시오.."+enter+enter;
				msg += "#fUI/UIWindow2.img/UtilDlgEx/list1#\r\n#d#L1#(Lv."+제한레벨+") #b#e[일일 퀘스트]#n#k #d타락한 세계수 2";
		...
		if (getk("isclear") == 1 || getk("isclear") == 4) {
			var msg = "#k안녕 #b#h #!#k 오늘의 의뢰는 이런 것들이 있소."+enter+enter;
			msg += isitem ? "#r#e[일일 퀘스트] : 타락한 세계수#n#k"+enter : "#fUI/UIWindow2.img/UtilDlgEx/list0#\r\n#r#e[일일 퀘스트] : 타락한 세계수#n#k"+enter;
		...
		var msg = "안녕 #b#h #!#k 오늘의 의뢰는 이런 것들이 있소."+enter+enter;
		msg += isitem ? "#fUI/UIWindow2.img/UtilDlgEx/list0#\r\n#r#e[일일 퀘스트] : 타락한 세계수#n#k"+enter : "#fUI/UIWindow2.img/UtilDlgEx/list0#\r\n#r#e[일일 퀘스트] : 타락한 세계수#n#k"+enter;
		msg += isitem ? "\r\n목표 전리품 : #b#i"+getk("mobid")+"##z"+getk("mobid")+"# "+getk("mobq")+"개#k"+enter+enter : "처치 대상 : #b#o"+getk("mobid")+"# "+getk("mobq")+"마리#k"+enter+enter;
		msg += "그럼, 일이 끝난 후에 다시 와줘.";
		cm.sendOk(msg);
		cm.dispose();
