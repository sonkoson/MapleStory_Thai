...
req = [
[0, [[4310248,300]], 500000000],
[0, [[4310248,600]], 2000000000],
[0, [[4310248,900]], 3000000000],
[0, [[4310248,3000]], 5000000000],
[0, [[4310248,5000]], 7000000000],
[0, [[4310248,10000]], 10000000000],
[0, [[4310248,20000]], 12000000000],
[0, [[4310248,100000]], 50000000000],
//[0, [[4310248,50000]], 20000000000],
...
function action(mode, type, selection) {     
 ...
 if (before == 0) {
        cm.gainItem(4310248, -300);
}
 if (before == 1) {
        cm.gainItem(4310248, -600);
}
 if (before == 2) {
        cm.gainItem(4310248, -900);
}
 if (before == 3) {
        cm.gainItem(4310248, -3000);
}
 if (before == 4) {
        cm.gainItem(4310248, -5000);
}
 if (before == 5) {
        cm.gainItem(4310248, -10000);
}
 if (before == 6) {
        cm.gainItem(4310248, -20000);
}
 if (before == 7) {
        cm.gainItem(4310248, -30000);
}
 if (before == 8) {
        cm.gainItem(4310248, -50000);
}
        cm.dispose();
    }
}
