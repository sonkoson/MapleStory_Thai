...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        choose += "#L23##fc0xFF030066#" + 잠수 + " 출석 코인 상점#l";
        choose += "#fs11##L20#" + 분홍콩 + " " + 분홍 + "츄릅 코인상점   #k#l\r\n"; // 여기 공백에 띄어쓰기 넣으시면 돼요
        choose += "#L21#" + 네오젬 + " " + 빨강 + "매그너스코인 상점#k#l";
        choose += "#L22#" + 검은콩 + " #fc0xFF4374D9#잠수 코인상점#k#l\r\n\r\n";
        choose += "#fc0xFFF15F5F#★──────────장비상점────────────★#k\r\n";
        ...
        if (selection == 0) {
            ...
            말 = "#fs11##L20#" + 분홍콩 + " " + 분홍 + "츄릅코인 상점#k" + 검정 + "을 이용하고 싶습니다.#l\r\n";
            말 += "#L11#" + 네오젬 + " " + 파랑 + "네오젬  상점#k" + 검정 + "을 이용하고 싶습니다.#l\r\n";
            말 += "#L12#" + 검은콩 + " #fc0xFF4374D9#잠수코인 상점#k" + 검정 + "을 이용하고 싶습니다.#l\r\n";
