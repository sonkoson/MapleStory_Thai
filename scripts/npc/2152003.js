...
var items = [
   {'itemid' : 2630120, 'qty' : 1, 'allstat' : 0, 'atk' : 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
   'recipes' : [[4310029, 10000], [4310308, 5000], [4310248, 10000]], 'price' : 5000000000, 'chance' : 1, //재료, 비용, 확률
   'fail' : [[4310308, 100]] //실패시 지급되는 아이템
   },
...
function action(mode, type, sel) {
   ...
   if (status == 0) {
      var msg = "이걸 어디서 구했는지는 비밀이야."+enter;
