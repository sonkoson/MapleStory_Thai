...
function action(mode, type, selection) {
   ing = [
      [[4036465,2], [4001843,2], [4001869,2], [4001868,5], [4001894,2], [4001893,5], [1143029,1], [4021009,1], [4021031,1000], [2635911,2000], [4036491,25]],
      ]; // 재료
   epsol = [2439614]; // 완제
   chance = 5; // 확률
   if (mode == 0 || mode == 0) {
   ...
   if (status == 0) {
      말 = "\r\n#fs11##fc0xFF000000#제네시스 무기를 제작하시겠습니까?#n\r\n\r\n";
      말+= "#L0##b제작하겠습니다.";
      cm.sendSimple(말);
   } else if (status == 1) {
