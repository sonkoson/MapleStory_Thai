...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		if (!cm.haveItem(price, 1)) {
			cm.sendOk("#fs11##fc0xFF000000#강화하기 위해선 #b#z" + price + "##fc0xFF000000#이 필요합니다.");
			cm.dispose();
			return;
		}
