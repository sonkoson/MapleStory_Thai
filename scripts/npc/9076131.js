...
function action(M, T, S) {
	...
	if(St == 0) {
		...
		if(cm.getMapId() == 933031000){
			cm.sendNext("#fs11#안녕하세요 저는 여신 미네르바를 모시는 시종 이크입니다. 돌로 변해버린 여신 미네르바님을 구하기 위해선 곳곳에 흩어진 #b여신상의 조각#k을 모아야 해요. 자, 먼저 <휴게실>로 가서 첫번째 조각을 찾아주세요. <휴게실>로 가는 포탈은 아래에 있습니다.");
			...
			cm.sendNext("#fs11#덕분에 여신상의 두 번째 조각을 찾을 수 있었어요. 자, 이걸로 여신상을 복원해 주세요.");
