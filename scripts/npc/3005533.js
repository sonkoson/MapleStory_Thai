...
var items = [
   {
      ...
      'fail': [[1012632, 1],[4319999, 10000], [4319995, 10], [4319996, 10]] //성공시 지급되는 아이템
   },
   {
      ...
      'fail': [[1022278, 1],[4319999, 10000], [4319995, 10], [4319996, 10]] //성공시 지급되는 아이템
   },
   {
      ...
      'fail': [[1032316, 1],[4319999, 10000], [4319995, 10], [4319996, 10]] //성공시 지급되는 아이템
   },
   {
      ...
      'fail': [[1122430, 1],[4319999, 10000], [4319995, 10], [4319996, 10]] //성공시 지급되는 아이템
   },
   {
      ...
      'fail': [[1132308, 1],[4319999, 10000], [4319995, 10], [4319996, 10]] //성공시 지급되는 아이템
   },
...

   {
      ...
      'fail': [[1162080, 1],[4319999, 10000], [4319995, 10], [4319996, 10]] //성공시 지급되는 아이템
   },
   {
   ...
   },
   {
      ...
      'fail': [[1672082, 1],[4319999, 10000], [4319995, 10], [4319996, 10]] //성공시 지급되는 아이템
   },
   {
      ...
      'fail': [[1113306, 1],[4319999, 10000], [4319995, 10], [4319996, 10]] //성공시 지급되는 아이템
   },
   {
      ...
      'fail': [[1182285, 1],[4319999, 10000], [4319995, 10], [4319996, 10]] //성공시 지급되는 아이템
   },
]
