    ...
    if (status == 0) {
        ...
        if (cm.haveItem(need, 5)) {
            ...
            switch(enhanceValue) {
                ...
                var beforeOption = selectedItem.getLuk();

                selectedItem.setLuk(selectedItem.getLuk() + enhanceOption);
                ...
                chat += "#d" + "변경된 능력치 : [LUK] #k" + beforeOption + " + #b15" + enter + enter;
