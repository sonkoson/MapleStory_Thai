...
var jobs = [
	...
	{ 'jobid': 15400, 'jobname': "칼리", 'job': "레프", 'stat': 4, 'sk': [150033224] }
]
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		var 게임약관 = "#fs11#       "+서버이름+" 전직 도우미\r\n";
		게임약관 += "" + 회색 + "────────────────────────────\r\n";
		게임약관 += " " + 검정 + "#e"+서버이름+"#n#k에 온 #b#h ##k 용사님 만나서 반가워요!\r\n";
		게임약관 += "저는 " + 검정 + "부우섬을 지키고 있는#k #fs11##e" + 검정 + "트리켓#n#k#fs11# 이라고 해요!\r\n";
		게임약관 += " #e" + 검정 + ""+서버이름+"#k#n는 #b용사님들과 함께 만들어가는 서버#k에요 !\r\n";
		게임약관 += "앞으로 잘 부탁하고 무슨 일이 생기면 #r언제든지#k 절 불러주세요!\r\n";
		게임약관 += "" + 회색 + "────────────────────────────\r\n";
		게임약관 += "#b#h ##k님이 " + 검정 + "#e"+서버이름+"#n#k는 #r모든 플레이 기록#k은 서버에 #r저장#k되며, 필요에 의해 타인에게 #r공개#k되거나 #r증거#k로 활용될 수 있습니다.\r\n\r\n";
...
function SecondJob(i) {
	var adventure = "#fs11##b#h ##k 용사님! #b"+서버이름+" 스토리#k에서 즐길 직업을 선택해주세요!" + enter;
	switch (i) {
		case 1:
			adventure += "현재 당신이 선택한 직업군은 #b전사#k 입니다.\r\n";
			adventure += "#L110# #r파이터#k로 #b"+서버이름+" 스토리#k에 참여할게!\r\n";
			adventure += "#L120# #r페이지#k로 #b"+서버이름+" 스토리#k에 참여할게!\r\n";
			adventure += "#L130# #r스피어맨#k으로 #b"+서버이름+" 스토리#k에 참여할게!\r\n";
			break;
		case 2:
			adventure += "현재 당신이 선택한 직업군은 #b마법사#k 입니다.\r\n";
			adventure += "#L210# #r불,독위자드#k로 #b"+서버이름+" 스토리#k에 참여할게!\r\n";
			adventure += "#L220# #r썬,콜위자드#k로 #b"+서버이름+" 스토리#k에 참여할게!\r\n";
			adventure += "#L230# #r클레릭#k으로 #b"+서버이름+" 스토리#k에 참여할게!\r\n";
			break;
		case 3:
			adventure += "현재 당신이 선택한 직업군은 #b궁수#k 입니다.\r\n";
			adventure += "#L310# #r헌터#k로 #b"+서버이름+" 스토리#k에 참여할게!\r\n";
			adventure += "#L320# #r사수#k로 #b"+서버이름+" 스토리#k에 참여할게!\r\n";
			//adventure += "#L330# #r패스파인더#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 4:
			adventure += "현재 당신이 선택한 직업군은 #b도적#k 입니다.\r\n";
			adventure += "#L410# #r어쌔신#k로 #b"+서버이름+" 스토리#k에 참여할게!\r\n";
			adventure += "#L420# #r시프#k로 #b"+서버이름+" 스토리#k에 참여할게!\r\n";
			break;
		case 5:
			adventure += "현재 당신이 선택한 직업군은 #b해적#k 입니다.\r\n";
			adventure += "#L510# #r인파이터#k로 #b"+서버이름+" 스토리#k에 참여할게!\r\n";
			adventure += "#L520# #r건슬링거#k로 #b"+서버이름+" 스토리#k에 참여할게!\r\n";
			break;
	}
	return adventure;
}
...
function FirstJob(i) {
	var chat = "#fs11#용사님! #b"+서버이름+" 서버#k에서 즐길 직업을 선택해주세요!" + enter;
	switch (i) {
		case 0:
			chat += "#L1# #r전사#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			chat += "#L2# #r마법사#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			chat += "#L3# #r궁수#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			chat += "#L4# #r도적#k으로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			chat += "#L5# #r해적#k으로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			chat += "#L330# #r패스파인더#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			chat += "#L430# #r듀얼블레이드#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			chat += "#L530# #r캐논슈터#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 1000:
			chat += "#L1100# #r소울마스터#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			chat += "#L1200# #r플레임위자드#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			chat += "#L1300# #r윈드브레이커#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			chat += "#L1400# #r나이트워커#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			chat += "#L1500# #r스트라이커#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 2000:
			chat += "#L2100# #r아란#k으로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 2001:
			chat += "#L2200# #r에반#k으로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 2002:
			chat += "#L2300# #r메르세데스#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 2003:
			chat += "#L2400# #r팬텀#k으로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 2004:
			chat += "#L2700# #r루미너스#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 2005:
			chat += "#L2500# #r은월#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 3000:
			chat += "#L3200# #r배틀메이지#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			chat += "#L3300# #r와일드헌터#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			chat += "#L3500# #r메카닉#k으로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			chat += "#L3700# #r블래스터#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 3001:
			chat += "#L3100# #r데몬슬레이어#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			chat += "#L3101# #r데몬어벤져#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 3002:
			chat += "#L3600# #r제논#k으로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 5000:
			chat += "#L5100# #r미하일#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 6000:
			chat += "#L6100# #r카이저#k으로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 6001:
			chat += "#L6500# #r엔젤릭버스터#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 6002:
			chat += "#L6400# #r카데나#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 6003:
			chat += "#L6300# #r카인#k으로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 10112:
			chat += "#L10112# #r제로#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 14000:
			chat += "#L14200# #r키네시스#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 15000:
			chat += "#L15200# #r일리움#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 15001:
			chat += "#L15500# #r아크#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 15002:
			chat += "#L15100# #r아델#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 15003:
             chat += "#L15400# #r칼리#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
            break;
		case 16000:
			chat += "#L16400# #r호영#k으로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
		case 16001:
			chat += "#L16200# #r라라#k로 #b"+서버이름+" 서버#k에 참여할게!\r\n";
			break;
	}
	cm.sendOkS(chat, 0x4);
}