...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		msg += "#L1##fc0xFF990033#[PRAY]#fc0xFF6600CC# 육성 다이어리 (필수)#l#n\r\n";
		//msg += "#L7##fc0xFF990033#[PRAY]#fc0xFF6600CC# 성장 패스 이용하기 (필수)#l#n\r\n\r\n\r\n";
		//msg += "#L99##fc0xFFED4C00#울창한 전당으로 이동하기 (퀘스트맵)#k#l#n\r\n";
		msg += "#L103##fc0xFF00B700#슈피겔만의 파티퀘스트 하우스로 이동하기#k#l#n\r\n\r\n\r\n";
		...
		msg += "#fc0xFF3162C7##L10##fUI/UIWindow4.img/pointShop/100296/iconShop# 보스 랭크 승급#l #fc0xFF990066##L14##fUI/UIWindow4.img/pointShop/3887/iconShop# 준비중           #l#fc0xFF996600##L12##fUI/UIWindow4.img/pointShop/16393/iconShop# 연금술 이용#l"+enter;
		msg += "#fc0xFF3162C7##L9##fUI/UIWindow4.img/pointShop/100296/iconShop# 스탯 랭크 승급#l#fc0xFF990066# #L15##fUI/UIWindow4.img/pointShop/3887/iconShop# 준비중#l#fc0xFF990066#\r\n"+enter;
		cm.sendSimple(msg);
	} else if (status == 1) {
		seld = sel;
		switch (sel) {
