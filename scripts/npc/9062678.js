...
function action(mode, type, sel) {
	...
	if (status == 0) {
		var msg = "#fs13#"+enter;
		msg += "#fc0xFF000000#각종 데미지스킨이 준비되어 있는 것 같다#b"+enter;
		msg += "랜덤 - #i"+need+"##z"+need+"# "+qty+"개"+enter;
		msg += "선택 - #i"+선택필요+"##z"+선택필요+"# "+선택개수+"개#b"+enter +enter;
		msg += "#L2#랜덤으로 뽑아볼래."+enter +enter;
		msg += "#L3#데미지 스킨을 선택할래요!!"+enter +enter;
		...
		switch (sel) {
			...
			break;
			case 3:
				var msg = "원하시는 데미지스킨을 선택해주세요. #fs11##b"+enter;
