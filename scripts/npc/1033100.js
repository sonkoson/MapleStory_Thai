...
var items = [
   {'itemid' : 1142067, 'qty' : 1, 'allstat' : 0, 'atk' : 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
   'recipes' : [[1142066, 1], [4310248, 2000]], 'price' : 2000000000, 'chance' : 100, //재료, 비용, 확률
   'fail' : [[1142067, 1]] //실패시 지급되는 아이템
   },
...
function action(mode, type, sel) {
   ...
   if (status == 0) {
      var msg = "Veteran이 되고 싶으시다고요? 맡겨만 주세요!!"+enter;
      ...
      if (item['price'] > 0)
         msg += "#i5200002#"+item['price']+" 메소 (20억)"+enter;
