   ...
   cm.sendSimpleS(말, 0x04, 2192030);
        ...
        if (selection == 0) {
            if (!cm.haveItem(4310000, 1)) {
                cm.sendOkS("#fs11##i4310000# #b#z4310000##k 아이템이 부족하다네.", 0x04, 2192030);
                cm.dispose();
                return;
            }
            ...
            if (!cm.haveItem(4310001, 1)) {
                cm.sendOkS("#fs11##i4310001# #b#z4310001##k 아이템이 부족하다네.", 0x04, 2192030);
                cm.dispose();
                return;
            }
            ...
            if (!cm.haveItem(4310002, 1)) {
                cm.sendOkS("#fs11##i4310002# #b#z4310002##k 아이템이 부족하다네.", 0x04, 2192030);
                cm.dispose();
                return;
            }
            ...
            if (!cm.haveItem(4310003, 1)) {
                cm.sendOkS("#fs11##i4310003# #b#z4310003##k 아이템이 부족하다네.", 0x04, 2192030);
                cm.dispose();
                return;
            }
            ...
            if (!cm.haveItem(4310004, 1)) {
                cm.sendOkS("#fs11##i4310004# #b#z4310004##k 아이템이 부족하다네.", 0x04, 2192030);
                cm.dispose();
                return;
            }
