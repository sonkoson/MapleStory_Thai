    ...
    if (status == 0) {
        ...
        if (cm.haveItem(need, 5)) {
            ...
            switch(enhanceValue) {
                ...
                var beforeOption = selectedItem.getStr();

                selectedItem.setStr(selectedItem.getStr() + enhanceOption);
                ...
                chat += "#d" + "변경된 능력치 : [STR] #k" + beforeOption + " + #b15" + enter + enter;
