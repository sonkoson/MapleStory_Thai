...
var shops = [
    { 'itemid': 4310229, 'qty': 1, 'price': 1 }, // 유니온 코인
]
...
function action(mode, type, sel) {
    ...
    if (status == 0) {
        ...
        var msg = "가지고있는 유니온코인을 상점에서 거래할수있게 코인으로 교환해주고 있어요!" + enter;
        msg += "현재 #b#h ##k님의 유니온코인은 #b" + p + "P#k입니다.#fs11##b" + enter;
        ...
        if (Math.floor(selditem['itemid'] / 1000000) > 1) {
            ...
            if (p < selditem['price']) {
                cm.sendOk("선택하신 아이템을 사기엔 코인이 부족합니다.");
                cm.dispose();
                return;
            }
            isEquip = true;
