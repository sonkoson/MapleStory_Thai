    ...
    if (status == 0) {
        ...
        if (cm.haveItem(need, 5)) {
            ...
            switch(enhanceValue) {
                ...
                var beforeOption = selectedItem.getInt();

                selectedItem.setInt(selectedItem.getInt() + enhanceOption);
                ...
                chat += "#d" + "변경된 능력치 : [INT] #k" + beforeOption + " + #b15" + enter + enter;
