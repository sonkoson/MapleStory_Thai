...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (selection == 0) {
            ...
            말 = "#fs11##L10#" + 분홍콩 + " " + 분홍 + "분홍콩 상점#k" + 검정 + "을 이용하고 싶습니다.#l\r\n";
