...
var items = [
   {'itemid' : 1142068, 'qty' : 1, 'allstat' : 0, 'atk' : 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
   'recipes' : [[1142067, 1], [4310248, 3000]], 'price' : 3000000000, 'chance' : 100, //재료, 비용, 확률
   'fail' : [[1142068, 1]] //실패시 지급되는 아이템
   },
...
function action(mode, type, sel) {
   ...
   if (status == 0) {
      var msg = "Elite가 되고 싶으시다고요? 맡겨만 주세요!!"+enter;
