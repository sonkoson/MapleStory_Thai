...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        //choose += "#fs11##L0##fc0xFF000000#" + 강화 + " [PRAY] 제네시스 무기제작#l\r\n\r\n";
        //choose += "#fs11##L2##fc0xFF000000#" + 강화 + " [PRAY] 안드로이드승급#l\r\n\r\n";	
        //choose += "#fs11##L1##fc0xFF000000#" + 강화 + " [PRAY] 에테르넬 승급#l\r\n\r\n";
        //choose += "#fs11##L3##fc0xFF000000#" + 강화 + " [PRAY] 에테르넬 승급#l\r\n\r\n";	
        //choose += "#fs11##L4##fc0xFF000000#" + 강화 + " [PRAY] 칠흑 아이템 승급#l\r\n\r\n";		
        //choose += "#fs11##L5##fc0xFF000000#" + 강화 + " 기타 악세 아이템 제작#l\r\n\r\n";		
        choose += "#fs11##L6##fc0xFF000000#" + 강화 + " [PRAY] 후원 커스텀 제작#l\r\n\r\n";
        choose += "#fs11##L7##fc0xFF000000#" + 강화 + " [PRAY] 후원 커스텀 제작 2기#l\r\n\r\n";
       // choose += "#fs11##L9##fc0xFF000000#" + 강화 + " 에디큡 블랙큐브 제작#l\r\n\r\n";
