...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        choose += "#fs11##L0##fc0xFF000000#" + 강화 + " [PRAY] 메모리즈 승급#l\r\n\r\n";
        choose += "#fs11##L1##fc0xFF000000#" + 강화 + " [PRAY] 진 메모리즈 승급#l\r\n\r\n";	
        choose += "#fs11##L2##fc0xFF000000#" + 강화 + " [PRAY] PRAY 메모리즈 승급#l\r\n\r\n";
 //       choose += "#fs11##L3##fc0xFF000000#" + 강화 + " [PRAY] PRAY 시프 승급#l\r\n\r\n";	
  //      choose += "#fs11##L4##fc0xFF000000#" + 강화 + " [PRAY] PRAY PRAY렛 승급#l\r\n\r\n";		
   //     choose += "#fs11##L5##fc0xFF000000#" + 강화 + " [PRAY] 초월PRAY 승급#l\r\n\r\n";	
  //      choose += "#fs11##L6##fc0xFF000000#" + 강화 + " [PRAY] 라이징 승급#l\r\n\r\n";
