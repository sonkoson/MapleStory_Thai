...
function action(mode, type, selection) {
    ...
    */
    ...
    questlist = [
        [4000001, "mob", 150, false, 10, 100010001],
    ...
    */
    ...
    if (status == 0) {
        ...
        말 = "#fc0xFF6600CC##e#fs11#[PRAY] 육성 다이어리#n#k\r\n\r\n";
        말 += "#b" + questlist.length + " 개#k 의 #b#e[PRAY] 육성 다이어리#k#n를 완성하고 보상을 받아가세요.\r\n#r#e#fs12#[ 퀘스트를 클릭하면 해당 맵으로 이동합니다. ]#k#fs11##n\r\n";
        말 += "#b * 모든 다이어리 완료보상 : #b#i1182000##z1182000# #r1개#k\r\n";
        ...
        if (cm.getPlayer().getKeyValue(20190710, "questallcompleted") == -1) {
            ...
            if (questcompleted == questlist.length || cm.getPlayer().getGMLevel() >= 11) { // GMLUNA
                말 += "완료가능)#k#l"
            } else {
                말 += "진행중)#r\r\n"
