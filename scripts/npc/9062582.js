...
var seld = -1;
var items = [
   {'itemid' : 1012830, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //후원 마크 커스텀
   'recipes' : [[1014110, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
   'fail' : [[1014100, 1]]//실패시 얻는물건
   },


   {'itemid' : 1022410, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //안대
   'recipes' : [[1022560, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
   'fail' : [[1022550, 1]]//실패시 얻는물건
   },
   
   
   {'itemid' : 1032530, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //이어링
   'recipes' : [[1032680, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
   'fail' : [[1032670, 1]]//실패시 얻는물건
   },
   
   
   {'itemid' : 1122710, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //스타 펜던트
   'recipes' : [[1124110, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
   'fail' : [[1124100, 1]]//실패시 얻는물건
   },


   {'itemid' : 1122711, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //moon펜던트
   'recipes' : [[1124111, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
   'fail' : [[1124101, 1]]//실패시 얻는물건
   },
   
   
   {'itemid' : 1132530, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //벨트
   'recipes' : [[1132680, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
   'fail' : [[1132670, 1]]//실패시 얻는물건
   },   


   {'itemid' : 1152414, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //견장
   'recipes' : [[1152564, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
   'fail' : [[1152554, 1]]//실패시 얻는물건
   },


   {'itemid' : 1162430, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //포켓 구슬
   'recipes' : [[1162580, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
   'fail' : [[1162570, 1]]//실패시 얻는물건
   },
   
   
   {'itemid' : 1182430, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //뱃지
   'recipes' : [[1182580, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
   'fail' : [[1182580, 1]]//실패시 얻는물건
   },
   
   
   {'itemid' : 1190415, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //엠블렘
   'recipes' : [[1192110, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
   'fail' : [[1192100, 1]]//실패시 얻는물건
   },


   {'itemid' : 1008180, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //헬멧
   'recipes' : [[1008330, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
   'fail' : [[1008320, 1]]//실패시 얻는물건
   },
   
   
   {'itemid' : 1103680, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //망토
   'recipes' : [[1103830, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
   'fail' : [[1103820, 1]]//실패시 얻는물건
   },  

   
   {'itemid' : 1042880, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //셔츠
   'recipes' : [[1044130, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
   'fail' : [[1044120, 1]]//실패시 얻는물건
   },
   
   
   {'itemid' : 1082980, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //장갑
   'recipes' : [[1083130, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
   'fail' : [[1083120, 1]]//실패시 얻는물건
   },   


   {'itemid' : 1062580, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //팬츠
   'recipes' : [[1062730, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
   'fail' : [[1062720, 1]]//실패시 얻는물건
   },


   {'itemid' : 1073880, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //신발
   'recipes' : [[1074030, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
   'fail' : [[1074020, 1]]//실패시 얻는물건
   },
   
   
   {'itemid' : 1113680, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //반지 블루
   'recipes' : [[1114130, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
   'fail' : [[1114120, 1]]//실패시 얻는물건
   },
   
   
   {'itemid' : 1113681, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //반지 레드
   'recipes' : [[1114131, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
   'fail' : [[1114121, 1]]//실패시 얻는물건
   },


   {'itemid' : 1113682, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //반지 그린
   'recipes' : [[1114132, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
   'fail' : [[1114122, 1]]//실패시 얻는물건
   },
   
   
   {'itemid' : 1113683, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //반지 퍼플
   'recipes' : [[1114133, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
   'fail' : [[1114123, 1]]//실패시 얻는물건
   },
   
   
   {'itemid' : 1672320, 'qty' : 1, 'allstat': 3000, 'atk': 8000, //하트
   'recipes' : [[1672470, 1], [4033897, 20000]], 'price' : 1, 'chance' : 100, //확률
