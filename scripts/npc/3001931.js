    ...
    if (status == 0) {
        ...
        if (selection == 0) {
            ...
            if (recoms_num == 0) cm.sendOk("#fs11##fc0xFF000000#아직 #b" + cm.getPlayer().getName() + "#fc0xFF000000#님을 추천하신 분이 없네요.\r\n열심히 #fc0xFF990033#[FANCY]y#fc0xFF000000#를 알린다면, 보상이 따를 것 입니다."), cm.dispose();
                ...
                cm.getPlayer().dropMessage(1, 10000 * Integer.parseInt(recoms_num) + " #b홍보 포인트를 지급 받았습니다.");
                var c = DatabaseConnection.getConnection();
