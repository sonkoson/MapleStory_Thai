...
var items = [
   {'itemid' : 2635906, 'qty' : 1, 
   'recipes' : [[4001716, 10]], 'price' : 10, 'chance' : 35,
   'fail' : [[2635911, 1]]
   },
...
function action(mode, type, sel) {
   ...
   if (status == 0) {
      var msg = "#fs11#인생은 도박이지"+enter;
      msg += "#fs11#클릭하면 바로 도박 시작이라네.#fs12##b"+enter;
      for (i = 0; i < items.length; i++)
         msg += "#fs11##L"+i+"##i"+items[i]['itemid']+"##z"+items[i]['itemid']+"# 도전"+enter;
      ...
      var msg = "#fs11#선택하신 도박 은 다음과 같습니다.#fs11##b"+enter;
      ...
      msg += enter;
      msg += "#fs11##k도박 하기위한 필요한 재료입니다.#fs11##d"+enter+enter;
