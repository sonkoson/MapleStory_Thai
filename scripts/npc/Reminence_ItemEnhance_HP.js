    ...
    if (status == 0) {
        ...
        if (cm.haveItem(need, 5)) {
            ...
            switch(enhanceValue) {
                ...
                var beforeOption = selectedItem.getHp();

                selectedItem.setHp(selectedItem.getHp() + enhanceOption);
                ...
                chat += "#d" + "변경된 능력치 : [HP]#k" + beforeOption + " + #b300" + enter + enter;
