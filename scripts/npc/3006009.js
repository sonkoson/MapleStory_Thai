...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        choose += "#fs11##L0##fc0xFF000000#" + 강화 + " #fc0xFFFF5AD9#[2T] 파프니르 승급#l\r\n\r\n";
        choose += "#fs11##L2##fc0xFF000000#" + 강화 + " #fc0xFFFF5AD9#[2T] 아케인쉐이드 승급#l\r\n\r\n";	
        choose += "#fs11##L1##fc0xFF000000#" + 강화 + " #fc0xFFFF5AD9#[3T]에테르넬 승급#l\r\n\r\n";
       // choose += "#fs11##L3##fc0xFF000000#" + 강화 + " [FANCY] 에테르넬 승급#l\r\n\r\n";	
        choose += "#fs11##L4##fc0xFF000000#" + 강화 + " #fc0xFFFF5AD9#[E] 칠흑 아이템 승급#l\r\n\r\n";
        choose += "#fs11##L6##fc0xFF000000#" + 강화 + " #fc0xFFFF5AD9#[E] 아스칼론링 제작#l\r\n\r\n";			
        choose += "#fs11##L5##fc0xFF000000#" + 강화 + " #fc0xFFFF5AD9#기타 악세 아이템 제작#l\r\n\r\n";	
