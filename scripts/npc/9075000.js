...
function action(mode, type, selection) {
   ...
   if (status == 0) {
      ...
      //말 += "#fs11##fc0xFF4641D9##L1#[PRAY]#k "+검정+"#i1004808# 아케인 강화 시스템 을 이용하고싶어요!#l\r\n\r\n";
      말 += "#fs11##fc0xFF4641D9##L2#[PRAY]#k "+검정+"#i1012632# 특별 잠재능력 시스템 을 이용하고 싶어요!#l\r\n\r\n";
      말 += "#fs11##fc0xFF4641D9##L3#[PRAY]#k "+검정+"#i1702792# 치창템 강화 시스템 을 이용하고싶어요!#l\r\n\r\n";
      cm.sendSimple(말);
   } else if (status == 1) {
      if (selection == 1) {
         cm.dispose();
