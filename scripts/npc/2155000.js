...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		switch (isclear) {
			...
			case 4:
				var msg = "어서 오시게나.말랑이."+enter+enter;
				msg += "#fUI/UIWindow2.img/UtilDlgEx/list1#\r\n#d#L1#(Lv."+제한레벨+") #b#e[일일 퀘스트]#n#k #d헤이븐 '기계무덤' 2";
		...
		if (getk("isclear") == 1 || getk("isclear") == 4) {
			...
			msg += isitem ? "#r#e[일일 퀘스트] : 헤이븐 '기계무덤'#n#k"+enter : "#fUI/UIWindow2.img/UtilDlgEx/list0#\r\n#r#e[일일 퀘스트] : 헤이븐 '기계무덤'#n#k"+enter;
		...
		var msg = "안녕 #b#h #!#k 오늘의 의뢰는 이런 것들이 있어!"+enter+enter;
		msg += isitem ? "#fUI/UIWindow2.img/UtilDlgEx/list0#\r\n#r#e[일일 퀘스트] : 헤이븐 '기계무덤'#n#k"+enter : "#fUI/UIWindow2.img/UtilDlgEx/list0#\r\n#r#e[일일 퀘스트] : 헤이븐 '기계무덤'#n#k"+enter;
		msg += isitem ? "\r\n목표 전리품 : #b#i"+getk("mobid")+"##z"+getk("mobid")+"# "+getk("mobq")+"개#k"+enter+enter : "처치 대상 : #b#o"+getk("mobid")+"# "+getk("mobq")+"마리#k"+enter+enter;
		msg += "그럼, 일이 끝난 후에 다시 와줘.\r\n보상을 받기전 장비창을 20칸 이상 비워주세요.";
		cm.sendOk(msg);
		cm.dispose();
