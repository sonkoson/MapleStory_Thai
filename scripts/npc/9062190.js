...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		switch (sel) {
			...
			case 2:
				var msg = "";
                                //msg += "#L9##fs11##fUI/UIWindow8.img/EldaGauge/tooltip/50#  (Lv. 공용)#r 퀘스트의 전당 이동 #k(서브퀘스트 클리어)#n#k"+enter;
                                //msg += "#L11##fs11##fUI/UIWindow8.img/EldaGauge/tooltip/50#  (Lv. 공용)#r 카오 다이어리 수집 #k(다이어리 수집가!)#n#k"+enter+enter;
				msg += "#L1##fs11##fUI/UIWindow.img/Quest/icon0#  (Lv. 190)#d 헤이븐 - #b긴급 지원#n#k#l"+enter+enter;
				msg += "         └ 보상 : #b#z2435719# 5개#k\r\n";
				msg += "#L7##fs11##fUI/UIWindow.img/Quest/icon0#  (Lv. 190)#d 버려진 야영지 - #b어둠 퇴치#n#k#l"+enter+enter;
			...
			break;
			case 3:
				var msg = "#fs11#안녕하세요 ? 프로스트 스카디의 #b게임 컨텐츠#k 목록입니다.\r\n무슨 컨텐츠를 이용하시겠어요 ?"+enter+enter;
				msg += "#L8##fs11##i3801529# #d티어 승급 시스템 :: 티어별 패시브 효과 보상\r\n\r\n";
				msg += "#L1##fs11##i3801523# #d배고픈 무토 :: 아케인심볼 보상\r\n";
				msg += "#L2##fs11##i3801524# #d드림 브레이커 :: 아케인심볼 보상\r\n";
				msg += "#L3##fs11##i3801525# #d스피릿 세이비어 :: 아케인심볼 보상\r\n\r\n";
				msg += "#L4##fs11##i3801526# #d와글와글 하우스 :: 어센틱심볼 보상\r\n";
				msg += "#L6##fs11##i3801527# #d불꽃 늑대 :: 어센틱심볼, 파워 성장의 비약 보상\r\n\r\n";
				msg += "#L7##fs11##i3801530# #d라이브 탕윤 식당 :: 티어 승급 코인 보상\r\n";
				msg += "#L9##fs11##i3801531# #d라이브 퍼즐 마스터 :: 티어 승급 코인 보상\r\n\r\n";
				msg += "#L5##fs11##i3801528# #d갓 오브 컨트롤 :: 보상 없음";
				//msg += "#L7##fs11##i3801529# #d마피아 게임 :: 메소 보상";
				cm.sendSimple(msg);
			break;
			case 4:
/*
...
*/
			...
			case 5:
				var msg = "";
				msg += "#L1##fs11##i3801525# #d길드(Guild) #b생성 / 관리 "+enter+enter;
				msg += "#L2##fs11##i3801526# #d연합(Alliance) #b생성 / 관리";
                //msg += "#L3##fs11##i3801525# #d경쟁전(원정대) #b생성 / 시작";
				//msg += "#L4#선택지4"+enter;
				//msg += "#L5#선택지5"+enter;
				cm.sendSimple(msg);
                        case 6:
				var msg = "";
				//msg += "#L1##fs11##i3801525# #d웨딩 빌리지 이동 #b(결혼 시스템)"+enter+enter;
			...
			break;
            case 7:
				var msg = "#fs11#인내심을 테스트 해보고 싶으신가요 ?\r\n#b점프맵#k을 클리어하고 보상도 받아보세요! #fs20##r(보상추가중)#k#fs11#"+enter+enter;
				msg += "#L1##fs11##d인내의 숲"+enter;
				msg += "#L2##fs11#끈기의 숲"+enter;
				msg += "#L3##fs11#고지를 향해서"+enter;
				msg += "#L4##fs11#펫 산책로 (헤네시스)"+enter;
				msg += "#L5##fs11#펫 산책로 (루디브리엄)"+enter;
				cm.sendSimple(msg);
			break;
            case 8:
				var msg = "";
