...
var skills = [
	...
	["ww_sharp", 3121002, "샤프아이즈", 30000, true], 
    ["ww_winb", 5121009, "윈드 부스터", 30000, true],
	["ww_holy", 2311003, "홀리심불", 50000, true],
            ["ww_buck", 5321054, "벅 샷", 70000, true],
            ["ww_crsca", 1311015, " 크오체", 70000, true],
			//["ww_sk", 400051015, " 스크류", 400000, true],
            ["ww_quiver", 4341002, "파이널 컷", 100000, true],
			//["ww_Blessed", 400011052, "블래스드 해머", 800000, true],
]
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		//		msg += "#L4# #d무적 배우기#k "+enter;
		//		msg += "#L5# #d퀴버 카트리지 배우기#k "+enter;
		//		msg += "#L999# #dLUNA어오라 배우기#k "+enter;
//msg += "#L9# #d후원 스킬 상점#k "+enter;
		...
		switch (sel) {
            ...
            case 4:
				...
				cm.sendSimple("#fs11##s1221054# 무적 스킬을 습득했습니다.");
				cm.dispose();
			break;
			case 5:
				if (!cm.haveItem(4036804, 1)) {
				...
				cm.sendSimple("#fs11##s3100010# 퀴버 카트리지 스킬을 습득했습니다.");
				cm.dispose();
			return;
			case 999: //LUNA어오라
				if (!cm.haveItem(4036804, 1)) {
				...
				cm.sendSimple("#fs11##s2121054# 파이어오라 스킬을 습득했습니다.");
				cm.dispose();
			return;
                        case 6:
				cm.dispose();
