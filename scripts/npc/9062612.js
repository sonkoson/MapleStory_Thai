...
var skills = [
	["ww_magu", 2001002, "매직 가드", 1000000, true],
	["ww_sharp", 3121002, "샤프아이즈", 2000000, true], 
    	["ww_winb", 5121009, "윈드 부스터", 1000000, true],
	["ww_holy", 2311003, "홀리심불", 2000000, true],
            ["ww_buck", 5321054, "벅 샷", 10000000, true],
            ["ww_crsca", 1311015, " 크오체", 4000000, true],
            ["ww_cut", 4341002, "파이널 컷", 5000000, true],
	//["ww_Blessed", 400011052, "블래스드 해머", 16000000, true],
]

var skills1 = [
	["ww_tripling", 13100022, "트라이플링 윔", 150000, true],
	["ww_tripling", 99999, "트라이플링 윔 추가타", 100000, true]
]
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		var msg ="#fs11##d현재 #h #님의 홍보포인트 : #r"+cm.getPlayer().getHPoint()+"P#b"+enter;
                //msg += "#L15# #d악의정수 뽑기 시스템#k (가챠)"+enter;
		//msg += "#L7# #d후원 포인트 상점#k (아이템)"+enter;
                msg += "#L2# #d홍보 스킬 상점#k "+enter;
...
//msg += "#L9# #dVIP후원 스킬 상점#k "+enter;
		...
		switch (sel) {
			...
			break;
			case 2:
				var msg = "#fn나눔고딕 ExtraBold##fs15#홍보 스페셜 스킬 목록#Cgray# #fs10##r(Special Skill)#k#fs12#"+enter;
				msg += " 현재 #h #님의 홍보포인트 : #r"+cm.getPlayer().getHPoint()+"P#k#fs11#"+enter;
			...
			return;
				...
				msg += "트라이플링 윔 중복구매 가능하니 조심하세요."+enter;
				for (i = 0; i < skills1.length; i++) {
					if (skills1[i][1] == 99999) {
						msg += "#L"+i+"##s13100022# #e"+skills1[i][2]+"#n 구매하기 #e#r("+skills1[i][3]+"P + #i4001168# 10개)#k#n#l"+enter;
						continue;
					}
					if (skills1[i][4])
						msg += "#L"+i+"##s"+skills1[i][1]+"# #e"+skills1[i][2]+"#n 제작하기 #e#r("+skills1[i][3]+"P + #i4001168# 10개)#k#n#l"+enter;
