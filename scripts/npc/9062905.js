...
function action(mode, type, selection) {
    ...
    if (status == 0) {
    	var chat = "#fs11##b#z" + useItem + "##k만 있다면 잠재능력을 변경 해드립니다!\r\n\r\n어떤 #d장비#k의 #d잠재능력#k을 변경하고 싶으신가요 ?\r\n\r\n";
    	chat += "#L0##b장비 아이템#k#l\r\n";
    	//chat += "#L1##b캐시 아이템#k#l";
    	cm.sendSimple(chat);
    } else if (status == 1) {
        ...
        var chat = "#fs11#어떤 #d아이템#k의 #d잠재능력#k을 변경하고 싶으신가요 ?\r\n\r\n#r주의 : 잠재능력 수치는 아이템 레벨에 따라 변동될 수 있습니다.#k\r\n\r\n";
        ...
        cm.sendYesNo("#fs11#잠재능력 변경에 성공 하였습니다.\r\n잠재능력을 더 변경 하시겠습니까 ?");
    } else if (status == 6) {
        status = 1;
