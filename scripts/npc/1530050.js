...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		choose += "#L1##b" + 버리기 + "아이템 버리기#l";
		choose += "#L3##b" + 길드 + "길드 업무보기#l";
                choose += "#L0##b" + 펫 + "일반펫 교환소   #l\r\n";
		choose += "#L4##fc0xFF2F9D27#" + 버리기 + "메카닉 위장색#l";
		choose += "#L5##fc0xFF2F9D27#" + 길드 + "창고 이용하기#l";
		choose += "#L6##fc0xFF2F9D27#" + 펫 + "특별스킬 학습#l\r\n\r\n";
		choose += "#fc0xFFD5D5D5#──────────────────────────#k\r\n";
		choose += "#L7##fc0xFFFF3636#원클릭 큐브#l";
		choose += "#L8##fc0xFFFF3636#원클릭 환불#l";
		choose += "#L9##fc0xFFFF3636#원클릭 강불#l\r\n\r\n";
		choose += "#fc0xFFD5D5D5#──────────────────────────#k\r\n\r\n";
		choose += "#L10##fc0xFF660058#■  팬텀 스틸 스킬#k을 이용하겠습니다.#l\r\n";
		choose += "#L11##fc0xFF660058#■  뽑기 시스템#k을 이용하겠습니다.#l\r\n";
		choose += "#L12##fc0xFF660058#■  택배 시스템#k을 이용하겠습니다.#l\r\n";
