...
var seld = -1;
var items = [
    {'itemid': 1012850, 'qty': 1, 'allstat2': 400, 'atk2': 500, //후원 마크 커스텀
        'recipes': [[1012830, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1012830, 'qty': 1,
    },

    {'itemid': 1022430, 'qty': 1, 'allstat2': 400, 'atk2': 500, //안대
        'recipes': [[1022410, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1022410, 'qty': 1,
    },

    {'itemid': 1032550, 'qty': 1, 'allstat2': 400, 'atk2': 500, //이어링
        'recipes': [[1032530, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1032530, 'qty': 1,
    },

    {'itemid': 1122730, 'qty': 1, 'allstat2': 400, 'atk2': 500, //스타 펜던트
        'recipes': [[1122710, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1122710, 'qty': 1,
    },

    {'itemid': 1122731, 'qty': 1, 'allstat2': 400, 'atk2': 500, //moon펜던트
        'recipes': [[1122711, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1122711, 'qty': 1,
    },

    {'itemid': 1132550, 'qty': 1, 'allstat2': 400, 'atk2': 500, //벨트
        'recipes': [[1132530, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1132530, 'qty': 1,
    },

    {'itemid': 1152434, 'qty': 1, 'allstat2': 400, 'atk2': 500, //견장
        'recipes': [[1152414, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1152414, 'qty': 1,
    },

    {'itemid': 1162450, 'qty': 1, 'allstat2': 400, 'atk2': 500, //포켓 구슬
        'recipes': [[1162430, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1162430, 'qty': 1,
    },

    {'itemid': 1182450, 'qty': 1, 'allstat2': 400, 'atk2': 500, //뱃지
        'recipes': [[1182430, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1182430, 'qty': 1,
    },

    {'itemid': 1190435, 'qty': 1, 'allstat2': 400, 'atk2': 500, //엠블렘
        'recipes': [[1190415, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1190415, 'qty': 1,
    },

    {'itemid': 1008200, 'qty': 1, 'allstat2': 400, 'atk2': 500, //헬멧
        'recipes': [[1008180, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1008180, 'qty': 1,
    },

    {'itemid': 1103719, 'qty': 1, 'allstat2': 400, 'atk2': 500, //망토
        'recipes': [[1103700, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1103700, 'qty': 1,
    },

    {'itemid': 1042900, 'qty': 1, 'allstat2': 400, 'atk2': 500, //셔츠
        'recipes': [[1042880, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1042880, 'qty': 1,
    },

    {'itemid': 1083010, 'qty': 1, 'allstat2': 400, 'atk2': 500, //장갑
        'recipes': [[1082980, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1082980, 'qty': 1,
    },

    {'itemid': 1062600, 'qty': 1, 'allstat2': 400, 'atk2': 500, //팬츠
        'recipes': [[1062580, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1062580, 'qty': 1,
    },

    {'itemid': 1073900, 'qty': 1, 'allstat2': 400, 'atk2': 500, //신발
        'recipes': [[1073880, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1073880, 'qty': 1,
    },

    {'itemid': 1113700, 'qty': 1, 'allstat2': 400, 'atk2': 500, //반지 블루
        'recipes': [[1113680, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1113680, 'qty': 1,
    },

    {'itemid': 1113701, 'qty': 1, 'allstat2': 400, 'atk2': 500, //반지 레드
        'recipes': [[1113681, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1113681, 'qty': 1,
    },

    {'itemid': 1113702, 'qty': 1, 'allstat2': 400, 'atk2': 500, //반지 그린
        'recipes': [[1113682, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1113682, 'qty': 1,
    },

    {'itemid': 1113703, 'qty': 1, 'allstat2': 400, 'atk2': 500, //반지 퍼플
        'recipes': [[1113683, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1113683, 'qty': 1,
    },

    {'itemid': 1672340, 'qty': 1, 'allstat2': 400, 'atk2': 500, //하트
        'recipes': [[1672310, 1], [4031788, 20000], [4008001,1]], 'price': 1, 'chance': 60,//확률
        'fail': 1672310, 'qty': 1,
    },
]
...
function gainFail(i) {
    ...
    if (ise) {
        ...
        vitem.setPotential5(30086);
        vitem.setPotential6(30086);
		vitem.setBossDamage(5);
        vitem.setTotalDamage(5);
        Packages.server.MapleInventoryManipulator.addFromDrop(cm.getClient(), vitem, false);
    } else {
