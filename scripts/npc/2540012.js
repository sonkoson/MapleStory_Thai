...
var items = [
   {'itemid' : 2432446, 'qty' : 1, 'allstat' : 0, 'atk' : 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
   'recipes' : [[2432445, 10]], 'price' : 1000000000, 'chance' : 100, //재료, 비용, 확률
   'fail' : [[2432446, 1]] //실패시 지급되는 아이템
   },
...
function action(mode, type, sel) {
   ...
   if (status == 0) {
      var msg = "해준다...교환...에픽...10개로...유니크..."+enter;
      ...
      msg += enter;
      msg += "#fs12##k이거...들고와...#fs11##d"+enter+enter;
      ...
      msg +="#fs12#"+enter;
      msg += canMake ? "#b선택하신 아이템을 만들기 위한 재료들이 모두 모였습니다."+enter+"정말 제작하시려면 '예'를 눌러주세요." : "#r너...에픽...강화...석...부족...해...";
