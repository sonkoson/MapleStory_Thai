...
function action(mode, type, selection) {
   ...
   if (status == 0) {
      ...
      말 += "#fs11##fc0xFF4641D9##L1#[PRAY]#k "+검정+"유니온 코인을 교환하고 싶습니다..#l\r\n";
      말 += "#fs11##fc0xFF4641D9##L2#[PRAY]#k "+검정+"사냥 코인을 교환하고 싶습니다..#l\r\n\r\n";
      //  말 += "#k#fs#───────────────────────────\r\n#b#fn돋움##fs11##b";
/*      말 += "#fs11##fc0xFF4641D9##L3#[PRAY]#k "+검정+"십자코인 상점을 이용하고 싶어요!#l\r\n";
      말 += "#fs11##fc0xFF4641D9##L4#[PRAY]#k "+검정+"잠수코인 상점을 이용하고 싶어요!#l\r\n";
      말 += "#fs11##fc0xFF4641D9##L5#[PRAY]#k "+검정+"하얀 결정 - F 상점을 이용하고 싶어요!#l\r\n";
      말 += "#fs11##fc0xFF4641D9##L6#[PRAY]#k "+검정+"출석코인 상점을 이용하고 싶어요!#l\r\n";
      말 += "#fs11##fc0xFF4641D9##L7#[PRAY]#k "+검정+"매그코인 상점을 이용하고 싶어요!#l\r\n";
      말 += "#fs11##fc0xFF4641D9##L8#[PRAY]#k "+검정+"앱솔코인 상점을 이용하고 싶어요!#l\r\n";
      말 += "#fs11##fc0xFF4641D9##L9#[PRAY]#k "+검정+"아케인코인 상점을 이용하고 싶어요!#l\r\n";*/
      cm.sendSimple(말);
   } else if (status == 1) {
      if (selection == 1) {
         cm.dispose();
      ...
      if (selection == 0) {
         말 = "#fs11#→ #fc0xFF4375DB#환생 횟수#k 랭킹입니다.\r\n확인하고 싶은 랭킹 순위를 확인해주세요.\r\n";
         말 += "#L0#"+T2+O2+P2+" "+Num2+"#k #fs14##e랭킹#l #L1#"+T10+O10+P10+" "+Num1+Num0+"#k 랭킹#l\r\n";
         cm.sendSimple(말);
      } else if (selection == 1) {
         cm.dispose();
         cm.openNpc(1540005);
