...
var seld = -1;
var items = [
    {'itemid': 1008190, 'qty': 1, 'allstat': 400, 'atk': 1500, //커스텀 모자
        'recipes': [[1008170, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },

    {'itemid': 1012840, 'qty': 1, 'allstat': 400, 'atk': 1500, //마크
        'recipes': [[1012820, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },

    {'itemid': 1022420, 'qty': 1, 'allstat': 400, 'atk': 1500, //안대
        'recipes': [[1022400, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },

    {'itemid': 1032540, 'qty': 1, 'allstat': 400, 'atk': 1500, //이어링
        'recipes': [[1032520, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },

    {'itemid': 1122720, 'qty': 1, 'allstat': 400, 'atk': 1500, //스타펜던트
        'recipes': [[1122700, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },

    {'itemid': 1122721, 'qty': 1, 'allstat': 400, 'atk': 1500, //문펜던트
        'recipes': [[1122701, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },

    {'itemid': 1132540, 'qty': 1, 'allstat': 400, 'atk': 1500, //벨트 기존템이름교체
        'recipes': [[1132520, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },

    {'itemid': 1152424, 'qty': 1, 'allstat': 400, 'atk': 1500, //견장
        'recipes': [[1152404, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },

    {'itemid': 1162440, 'qty': 1, 'allstat': 400, 'atk': 1500, //마도서
        'recipes': [[1162420, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },

    {'itemid': 1182440, 'qty': 1, 'allstat': 400, 'atk': 1500, //뱃지
        'recipes': [[1182420, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },

    {'itemid': 1103690, 'qty': 1, 'allstat': 400, 'atk': 1500, //망토
        'recipes': [[1103670, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },

    {'itemid': 1042890, 'qty': 1, 'allstat': 400, 'atk': 1500, //셔츠
        'recipes': [[1042870, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },

    {'itemid': 1082990, 'qty': 1, 'allstat': 400, 'atk': 1500, //장갑
        'recipes': [[1082970, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },

    {'itemid': 1062590, 'qty': 1, 'allstat': 400, 'atk': 1500, //팬츠
        'recipes': [[1062570, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },

    {'itemid': 1073890, 'qty': 1, 'allstat': 400, 'atk': 1500, //신발
        'recipes': [[1073870, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },
    {'itemid': 1113690, 'qty': 1, 'allstat': 400, 'atk': 1500, //블루링
        'recipes': [[1113670, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },

    {'itemid': 1113691, 'qty': 1, 'allstat': 400, 'atk': 1500, //레드링
        'recipes': [[1113671, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },

    {'itemid': 1113692, 'qty': 1, 'allstat': 400, 'atk': 1500, //그린링
        'recipes': [[1113672, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },

    {'itemid': 1113693, 'qty': 1, 'allstat': 400, 'atk': 1500, //퍼플링
        'recipes': [[1113673, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },

    {'itemid': 1672330, 'qty': 1, 'allstat': 400, 'atk': 1500, //하트
        'recipes': [[1672310, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },

    {'itemid': 1190425, 'qty': 1, 'allstat': 400, 'atk': 1500, //엠블렘 엠블이름 교체 
        'recipes': [[1190405, 1], [4033897, 20000]], 'price': 1, 'chance': 100, //확률
        'fail': [[4001716, 10]]//실패시 얻는물건
    },
]
