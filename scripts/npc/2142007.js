...
var seld = -1;
var items = [
    {'itemid': 1142945, 'qty': 1, 'allstat2': 100, 'atk2': 100, //커스텀 모자
        'recipes': [[1142944, 1]], 'price': 1, 'chance': 100, //확률
		'fail': 1142944, 'qty': 1, 'allstat': 1, 'atk': 1,
    },

    {'itemid': 1142946, 'qty': 1, 'allstat2': 200, 'atk2': 200, //마크
        'recipes': [[1142945, 1], [4001716, 100]], 'price': 1, 'chance': 80, //확률
		'fail': 1142945, 'qty': 1, 'allstat': 100, 'atk': 100,
    },

    {'itemid': 1142947, 'qty': 1, 'allstat2': 400, 'atk2': 400, //안대
        'recipes': [[1142946, 1], [4001716, 150]], 'price': 1, 'chance': 60, //확률
		'fail': 1142946, 'qty': 1, 'allstat': 200, 'atk': 200,
    },

    {'itemid': 1142948, 'qty': 1, 'allstat2': 600, 'atk2': 600, //이어링
        'recipes': [[1142947, 1], [4001716, 200]], 'price': 1, 'chance': 40, //확률
		'fail': 1142947, 'qty': 1, 'allstat': 400, 'atk': 400,
    },

    {'itemid': 1142949, 'qty': 1, 'allstat2': 1000, 'atk2': 1000, //스타펜던트
        'recipes': [[1142948, 1], [4001716, 250]], 'price': 1, 'chance': 30, //확률
		'fail': 1142948, 'qty': 1, 'allstat': 600, 'atk': 600,
    },

    {'itemid': 1143291, 'qty': 1, 'allstat2': 1400, 'atk2': 1400, //문펜던트
        'recipes': [[1142949, 1], [4001716, 500]], 'price': 1, 'chance': 20, //확률
		'fail': 1142949, 'qty': 1, 'allstat': 1000, 'atk': 1000,
    },

    {'itemid': 1143292, 'qty': 1, 'allstat2': 2000, 'atk2': 2000, //벨트 기존템이름교체
        'recipes': [[1143291, 1], [4001716, 1000]], 'price': 1, 'chance': 10, //확률
		'fail': 1143291, 'qty': 1, 'allstat': 1400, 'atk': 1400,
    },
]
...
function gainItem(i) {
    ...
    if (ise) {
        ...
        vitem.setState(20);
        vitem.setPotential1(40656);
        vitem.setPotential2(40656);
        vitem.setPotential3(40656);
        vitem.setPotential4(40656);
        vitem.setPotential5(40656);
        vitem.setPotential6(40656);
