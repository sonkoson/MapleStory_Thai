...
function action(mode, type, selection) {
    ...
    if (status == 0) {
	var choose = "#fs11#현재 준비중 입니다.";
	//choose += "#b?? 랭크 시스템#d을 관리하는 #b빌리#k라고 합니다 무엇을 도와드릴까요?\r\n";
        //choose += "#L8##b메인랭크 티어 시스템#l\r\n";
        //choose += "#L32##b라이딩 뽑기#l\r\n";
        //choose += "#L9##b후원랭크 티어 시스템#l\r\n";
        //choose += "#L10##b시드링 뽑기#l\r\n";
        //choose += "#L35##b훈장 뽑기#l";
	cm.sendSimple(choose);
        ...
        if (s == 33) {
               ...
               //InterServerHandler.EnterCS(cm.getClient(), cm.getPlayer(), false);
				...
				cm.dispose();
				cm.openNpcCustom(cm.getClient(), 1540104, "Damageskin");
        } else if (s == 34) {
				cm.dispose();
