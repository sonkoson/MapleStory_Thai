...
function action(mode, type, sel) {
	...
	if (status == 0) {
      말 = ""+검정+"#e[팬시]#n 랭킹 시스템 입니다.\r\n"
      말 += "#fs11##fc0xFF4641D9##L1#[팬시]#k "+검정+"레벨 랭킹을 확인하고 싶습니다.#l\r\n";
      말 += "#fs11##fc0xFF4641D9##L2#[팬시]#k "+검정+"메소 랭킹을 확인하고 싶습니다.#l\r\n";
      말 += "#fs11##fc0xFF4641D9##L3#[팬시]#k "+검정+"인기도 랭킹을 확인하고 싶습니다.#l\r\n";
		//msg +="#L4#길드 랭킹"+enter;
