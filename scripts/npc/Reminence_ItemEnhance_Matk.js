    ...
    if (status == 0) {
       ...
       if (!Packages.constants.GameConstants.isWeapon(selectedItem.getItemId())) {
            ...
            switch(enhanceValue) {
                ...
                var beforeOption = selectedItem.getMatk();

                selectedItem.setMatk(selectedItem.getMatk() + enhanceOption);
                ...
                chat += "#d" + "변경된 능력치 : [마력] #k" + beforeOption + " + #b15" + enter + enter;
