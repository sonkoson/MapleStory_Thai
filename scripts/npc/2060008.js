...
var items = [
    {
        'itemid': 1113070, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
        'recipes': [[4310007, 1000], [4009547, 200]], 'price': 3000000000, 'chance': 30, //재료, 비용, 확률
        'fail': [[2450134, 1]] //실패시 지급되는 아이템
    },
]
...
function action(mode, type, sel) {
    ...
    if (status == 0) {
        var msg = "최고의 반지 세공사, 이 제라드에게 맡겨주게나." + enter;
        ...
        if (item['price'] > 0)
            msg += "#i5200002#" + item['price'] + " 메소 (30억)" + enter;
