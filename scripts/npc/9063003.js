...
var items = [
   {'itemid' : 2439614, 'qty' : 1, 'allstat' : 0, 'atk' : 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
   'recipes' : [[4036465, 100], [4310029, 1000]], 'price' : 0, 'chance' : 100, //재료, 비용, 확률
   'fail' : [[2439614, 1]] //실패시 지급되는 아이템
   },
...
function action(mode, type, sel) {
   ...
   if (status == 0) {
      var msg = "검은마법사의 편린을 가져다주면 그 힘이담긴 무기를 주겠네."+enter;
      ...
      if (item['price'] > 0)
         msg += "#i5200002#"+item['price']+" 메소 (15억)"+enter;
