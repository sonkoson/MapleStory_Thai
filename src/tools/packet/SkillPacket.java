...
public class SkillPacket {
    ...
    public static byte[] CreateSubObtacle(final MapleCharacter chr, final int skillid) {
        ...
        for (int i = 1; i <= 5; ++i) {
            mplew.writeInt(i);
            mplew.writeInt(0);
            mplew.writeInt(skillid == 151141002 ? 58 : 0);
            mplew.writeInt(i - 1);
            mplew.writeInt(chr.getId());
            mplew.writeInt(0);
    ...
    public static byte[] CreateSworldObtacle(final MapleMagicSword ms) {
        ...
        if (ms.core()) {
            ...
            mplew.writeInt(ms.getObjectId());
            mplew.writeInt(0);
            mplew.writeInt(ms.getSourceid() == 151141004 ? 60 : 7);
            mplew.writeInt(ms.getSwordCount());
            mplew.writeInt(ms.getChr().getId());
            mplew.writeInt(0);
            mplew.writeInt(0);
    ...
    public static byte[] stackMonster(ArrayList<MapleMonster> monsters, int skillId1, int skillId2, int type, int duration) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        for (MapleMonster monster : monsters) {
            mplew.writeInt(monster.getObjectId());
            mplew.writeInt(monster.stigmaStack);
            mplew.writeInt(0);
            mplew.writeInt(duration);
        }
    ...
    public static byte[] stackAttackMonster(ArrayList<MapleMonster> monsters, int skillId, int type, int delay) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.MONSTER_STACK_ATTACK.getValue());
    ...
    public static byte[] hexaStackMonster(ArrayList<MapleMonster> monsters, int skillId, int duration) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.HEXA_MONSTER_STACK.getValue());
        
        mplew.writeInt(skillId);
        mplew.write(1);
        
        mplew.writeInt(monsters.size()); // Monster Size
        for (MapleMonster monster : monsters) {
            mplew.writeInt(monster.getObjectId());
            mplew.writeInt(1);
            mplew.writeInt(0);
    ...
    public static byte[] hexaStackAttackMonster(ArrayList<MapleMonster> monsters, int skillId, int attackSkillId, int delay) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.HEXA_MONSTER_STACK_ATTACK.getValue());
