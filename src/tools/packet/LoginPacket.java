...
public class LoginPacket {
    ...
    public static final byte[] debugClient2(boolean first) {
        ...
        if (!first) {
            mplew.write(HexTool.getByteArrayFromHexString("29 00 00 00 69 B2 1C E6 46 1D 69 48 90 5B 85 52 2A 77 B4 18 8A DE 74 40 2A EE E5 53 6E 50 A9 68 53 6B 1A 32 B5 47 82 06 F1 52 14 7C 00"));
        }
    ...
    public static final byte[] ingameNeeded2() {
        ...
        mplew.write(HexTool.getByteArrayFromHexString("03 00 00 00 06 00 00 00 FC 03 00 00 2A 00 32 30 30 30 3A 31 7C 33 35 30 30 3A 32 7C 35 30 30 30 3A 33 7C 36 35 30 30 3A 34 7C 38 30 30 30 3A 35 7C 39 39 39 39 39 3A 36 03 00 41 6C 6C 13 00 00 00 1C 05 00 00 11 00 73 65 74 5F 69 6E 74 7C 31 30 34 31 33 30 31 34 36 03 00 41 6C 6C 14 00 00 00 19 05 00 00 0D 00 42 6C 61 63 6B 4C 69 73 74 7C 30 2C 35 03 00 41 6C 6C"));
    ...
    public static final byte[] ingameNeeded3() {
        ...
        mplew.write(HexTool.getByteArrayFromHexString("04 00 00 00 01 00 00 00 63 00 00 00 D0 07 00 00 00 00 00 00 00 00 00 00 64 00 00 00 C7 00 00 00 A0 0F 00 00 00 00 00 00 00 00 00 00 C8 00 00 00 03 01 00 00 40 1F 00 00 05 00 00 00 F4 01 00 00 04 01 00 00 2C 01 00 00 98 3A 00 00 05 00 00 00 E8 03 00 00"));
