...
import static tools.packet.PacketHelper.addInventoryInfo;
...
public class CWvsContext {
    ...
    public static class InventoryPacket {
        ...
        // 아이템 정렬
        public static byte[] updateItemSort(MapleInventoryType type, short slot) {
        ...
        public static byte[] ItemSortLockCash(MapleInventoryType type, short slot, int Itemid, int quantity, boolean isLock) {
            MaplePacketLittleEndianWriter packet = new MaplePacketLittleEndianWriter();
            packet.writeShort(SendPacketOpcode.INVENTORY_OPERATION.getValue());
            packet.write(1);
            packet.writeInt(1);
            ...
            packet.write(type.getType());
            packet.writeShort(slot);
            packet.write(3); // Inventory Type
            packet.writeInt(Itemid);
            packet.write(1);
            packet.writeLong(PacketHelper.getTime(-6));
            packet.writeLong(PacketHelper.getTime(-7));
            packet.writeInt(-1);
            packet.write(1);
            packet.writeLong(System.currentTimeMillis());
            packet.writeInt(0);
            packet.writeInt(isLock ? ItemSortType.CASH_LOCK.getValue() : ItemSortType.NONE_VALUE.getValue()); // 0x1000
            packet.writeLong(-2729106466389983132L);
            packet.write(1);
            packet.writeShort(0);
            packet.writeShort(0xFFF7);
            packet.writeLong(0);
            packet.writeInt(0);
            packet.writeShort(0);
            packet.write(0);
        ...
        public static byte[] ItemSortLockEtc(MapleInventoryType type, short slot, int Itemid, int quantity, boolean isLock) {
            MaplePacketLittleEndianWriter packet = new MaplePacketLittleEndianWriter();
            packet.writeShort(SendPacketOpcode.INVENTORY_OPERATION.getValue());
            packet.write(1);
            packet.writeInt(1);
            ...
            packet.writeShort(0);
            packet.writeInt(isLock ? ItemSortType.CONSUME_LOCK.getValue() : ItemSortType.NONE_VALUE.getValue()); // 0x1000
            packet.writeShort(0);
            return packet.getPacket();
        }

        public static byte[] ItemSortLockInstall(MapleInventoryType type, short slot, int Itemid, int quantity, boolean isLock) {
            MaplePacketLittleEndianWriter packet = new MaplePacketLittleEndianWriter();
            packet.writeShort(SendPacketOpcode.INVENTORY_OPERATION.getValue());
            packet.write(1);
            packet.writeInt(1);
            ...
            packet.writeShort(quantity);
            packet.writeShort(0);
            packet.writeInt(isLock ? ItemSortType.INSTALL_LOCK.getValue() : ItemSortType.NONE_VALUE.getValue()); // 0x1000
            packet.writeShort(0);
            return packet.getPacket();
        }

        public static byte[] ItemSortLockCody(MapleInventoryType type, short slot, int Itemid, int quantity, boolean isLock) {
            MaplePacketLittleEndianWriter packet = new MaplePacketLittleEndianWriter();
            packet.writeShort(SendPacketOpcode.INVENTORY_OPERATION.getValue());
            packet.write(1);
            packet.writeInt(1);
            ...
            packet.writeLong(PacketHelper.getTime(PacketHelper.MAX_TIME));
            packet.writeInt(-1);
            packet.write(1);
            packet.writeInt(0);
            packet.writeInt(28);
            ...
            packet.writeLong(0);
            packet.write(0);
            packet.writeInt(isLock ? ItemSortType.CODY_LOCK.getValue() : ItemSortType.NONE_VALUE.getValue()); // 0x800
            packet.writeLong(0);
            packet.writeLong(0);
            packet.write(0);
            packet.writeLong(PacketHelper.getTime(System.currentTimeMillis()));
            packet.writeLong(PacketHelper.getTime(-5));
            packet.writeLong(0);
            packet.writeLong(0);
            packet.writeInt(0);
            packet.writeShort(0);
            packet.writeShort(-1);
            packet.writeLong(PacketHelper.getTime(-1));
            packet.writeLong(PacketHelper.getTime(-2));
            packet.writeLong(PacketHelper.getTime(-1));
            return packet.getPacket();
        }

        public static byte[] ItemSortLockEquip(MapleInventoryType type, short slot, int Itemid, int quantity, boolean isLock) {
            MaplePacketLittleEndianWriter packet = new MaplePacketLittleEndianWriter();
            packet.writeShort(SendPacketOpcode.INVENTORY_OPERATION.getValue());
            packet.write(1);
            packet.write(0); // 1.2.391 ++
            packet.writeInt(1);
            packet.write(0);
            packet.write(5);
            packet.write(type.getType());
            ...
            PacketHelper.addEquipStats(packet, equip);

            //packet.write(-1);
            packet.writeInt(isLock ? ItemSortType.EQUIP_LOCK.getValue() : ItemSortType.NONE_VALUE.getValue()); // 0x1000

            packet.writeLong(0);
            packet.writeLong(0);
            packet.write(0);

            packet.writeLong(0); // 1.2.391 ++
            packet.writeShort(0); // 1.2.391 ++

            packet.writeLong(2031305540);
            ...
            packet.writeZeroBytes(7); // 1.2.391 ++

            return packet.getPacket();
        }

        public static byte[] ItemSortLockConsume(MapleInventoryType type, short slot, int Itemid, int quantity, boolean isLock) {
            MaplePacketLittleEndianWriter packet = new MaplePacketLittleEndianWriter();
            packet.writeShort(SendPacketOpcode.INVENTORY_OPERATION.getValue());
            packet.write(1);
            packet.write(0); // 1.2.391 ++
        ...
        public static byte[] moveInventoryItem(MapleInventoryType type, short source, short target, boolean bag, boolean bothBag) {
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.INVENTORY_OPERATION.getValue());
            //  System.out.println("아이템: moveInventoryItem 1 " );
            mplew.write(1);
            mplew.write(1);
            mplew.write(1); // 1.2.372 ++
            mplew.write(0);
            mplew.writeShort(0);
            mplew.write(0);
        ...
        public static byte[] moveInventoryItem(MapleInventoryType type, List<Pair<Short, Short>> updateSlots) {
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.INVENTORY_OPERATION.getValue());
            //    System.out.println("아이템: moveInventoryItem 2" );
            mplew.write(1);
        ...
        public static byte[] updateScrollandItem(Item scroll, Item item, boolean destroyed) {
            ...
            if (!destroyed) {
                mplew.write(3);
                mplew.write(GameConstants.getInventoryType(item.getItemId()).getType()); // 1.2.391 Changed.
                mplew.writeShort(item.getPosition()); // 1.2.391 Changed.
                mplew.write(0); // 1.2.391 Changed.
                mplew.write(GameConstants.getInventoryType(item.getItemId()).getType()); // 1.2.391 Changed.
                mplew.writeShort(item.getPosition());
                PacketHelper.addItemInfo(mplew, item);
            } else {
        ...
        public static byte[] getInventoryStatus(boolean fromDrop) {
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.INVENTORY_OPERATION.getValue());
            //     System.out.println("아이템: getInventoryStatus");
            mplew.write(fromDrop ? 1 : 0);
            mplew.write(0);
            mplew.write(0);
            mplew.writeShort(0);
        ...
        public static byte[] updateEquipSlot(Item item, boolean symbollevelup) {
            ...
            // System.err.println("아이템: updateEquipSlot");
            mplew.writeShort(SendPacketOpcode.INVENTORY_OPERATION.getValue());
            mplew.write(0);
            mplew.write(1);
            mplew.write(0);
    ...
    public static class BuffPacket {
        ...
        public static byte[] giveBuff(Map<SecondaryStat, Pair<Integer, Integer>> statups, SecondaryStatEffect effect, MapleCharacter chr) {
            return giveBuff(statups, effect, chr, new ArrayList<>());
        }

        public static byte[] giveBuff(Map<SecondaryStat, Pair<Integer, Integer>> statups, SecondaryStatEffect effect, MapleCharacter chr, List<Pair<SecondaryStat, Integer>> buffSkillid) {
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GIVE_BUFF.getValue());
            List<Pair<SecondaryStat, Pair<Integer, Integer>>> newstatups = PacketHelper.sortBuffStats(statups);

            PacketHelper.writeBuffMask(mplew, newstatups); // 1.2.391 ok.

            for (Pair<SecondaryStat, Pair<Integer, Integer>> stat : newstatups) {
                if (!(stat.getLeft()).canStack() && !(stat.getLeft()).isSpecialBuff() && !statups.containsKey(SecondaryStat.PinkbeanRollingGrade)) {
                    if (SecondaryStat.isEncode4Byte(statups) || (stat.getLeft() == SecondaryStat.IgnisRore && effect.getSourceId() == 400031017)) {
                        mplew.writeInt(((stat.getRight()).left).intValue());
                    } else {
                        mplew.writeShort(((stat.getRight()).left).intValue());
                    }
                    ...
                    } else if (stat.getLeft() == SecondaryStat.SpectorGauge) { // 1.2.390 ++
                        mplew.writeInt(chr.getJob());
                    ...
                    } else if (stat.getLeft() == SecondaryStat.PoseType && effect.getSourceId() == 11101032) {
                        mplew.writeInt(11001025);
                    } else if ((stat.getLeft() == SecondaryStat.Buckshot || stat.getLeft() == SecondaryStat.PoseType) && effect.getSourceId() == 11101032) {
            ...
            PacketHelper.encodeForLocal(mplew, effect, statups, chr, newstatups);
            ...
            for (Map.Entry<SecondaryStat, Pair<Integer, Integer>> stat : statups.entrySet()) {
                ...
                int value = 1;
                if (statups.containsKey(SecondaryStat.NewFlying) && effect.getSourceId() == 36141502) { // 오리진 아티피셜 에볼루션 구현
                    value = 0;
                } else if (statups.containsKey(SecondaryStat.NewFlying) && effect.getSourceId() == 80003059) {
                    value = 76;
                } else if (statups.containsKey(SecondaryStat.RWCylinder)) {
                    value = 0;
                } else if (effect.getSourceId() == 35111003) {
                    value = 16;
                } else if (effect.getSourceId() == 35001002) {
                    value = 6;
                }
            ...
            mplew.write(0);
            mplew.writeInt(0);
            mplew.write(statups.containsKey(SecondaryStat.SalamanderMischief) ? 33 : (statups.containsKey(SecondaryStat.NewFlying) && effect.getSourceId() == 36141502) ? 1 : statups.containsKey(SecondaryStat.Origin_Adrenaline_Surge) ? 1 : 0);
        ...
        private static void giveDice(MaplePacketLittleEndianWriter mplew, SecondaryStatEffect effect, MapleCharacter chr) {
            ...
            if (dice == 3 || doubledice == 3 || thirddice == 3) {
                ...
                mplew.writeInt(0);
                // mplew.writeInt(0); // OTHELLO - cheked.
            }
    ...
    public static class InfoPacket {
        ...
        public static byte[] updateQuest(MapleQuestStatus quest) {
            ...
            mplew.write(quest.getStatus()); // 1.2.390 --

            switch (quest.getStatus()) {
                case 0:
                    //mplew.writeMapleAsciiString((quest.getCustomData() != null) ? quest.getCustomData() : ""); // 1.2.390 Changed.
                    mplew.write(0); // 1.2.390 Changed.
                    break;
                case 1:
        ...
        public static byte[] AcceptQuest(int questid, int npcid) {
            ...
            mplew.write(12); // 1.2.390 Changed. (11 -> 12)
            mplew.writeInt(questid);
        ...
        public static byte[] GainEXP_Monster(MapleCharacter chr, long gain, boolean white, long flag, int eventBonusExp, int weddingExp, int partyExp, int itemEquipExp, int pcExp, int rainbowWeekExp, int boomupExp, int portionExp, int skillExp, int buffExp, int restExp, int itemExp, int valueExp, long bonusExp, int bloodExp, int iceExp, Pair<Integer, Integer> burningExp, int hpLiskExp, int fieldBonusExp, int eventBonusExp2, int fieldBonusExp2) {
            ...
            if ((flag & 0x10L) != 0L) {
                packet.writeLong(weddingExp); // 1.2.372 Changed
            }
            if ((flag & 0x20L) != 0L) {
                packet.writeLong(partyExp);// 1.2.372 Changed
            }
            if ((flag & 0x40L) != 0L) {
                packet.writeLong(itemEquipExp);// 1.2.372 Changed
            }
            if ((flag & 0x80L) != 0L) {
                packet.writeLong(pcExp);// 1.2.372 Changed
            }
            if ((flag & 0x100L) != 0L) {
                packet.writeLong(rainbowWeekExp);// 1.2.372 Changed
            }
            if ((flag & 0x200L) != 0L) {
                packet.writeLong(boomupExp);// 1.2.372 Changed
            }
            if ((flag & 0x400L) != 0L) {
                packet.writeLong(portionExp);// 1.2.372 Changed
            }
            if ((flag & 0x800L) != 0L) {
                packet.writeLong(skillExp); // 1.2.372 Changed
            }
            if ((flag & 0x1000L) != 0L) {
                packet.writeLong(buffExp);// 1.2.372 Changed
            }
            if ((flag & 0x2000L) != 0L) {
                packet.writeLong(restExp);// 1.2.372 Changed
            }
            if ((flag & 0x4000L) != 0L) {
                packet.writeLong(itemExp);// 1.2.372 Changed
            }
            if ((flag & 0x10000L) != 0L) {
                packet.writeLong(14);// 1.2.372 Changed
            }
            if ((flag & 0x20000L) != 0L) {
                packet.writeLong(valueExp);// 1.2.372 Changed
            }
            if ((flag & 0x40000L) != 0L) {
                packet.writeLong(16);// 1.2.372 Changed
            }
            if ((flag & 0x80000L) != 0L) {
                packet.writeLong(bonusExp);// 1.2.372 Changed
            }
            if ((flag & 0x100000L) != 0L) {
                packet.writeLong(bloodExp);// 1.2.372 Changed
            }
            if ((flag & 0x200000L) != 0L) {
                packet.writeLong(iceExp);// 1.2.372 Changed
            }
            if ((flag & 0x400000L) != 0L) {
                packet.writeLong(((Integer) burningExp.left).intValue());// 1.2.372 Changed
                packet.writeLong(((Integer) burningExp.right).intValue());// 1.2.372 Changed
            }
            if ((flag & 0x800000L) != 0L) {
                packet.writeLong(hpLiskExp);// 1.2.372 Changed
            }
            if ((flag & 0x1000000L) != 0L) {
                packet.writeLong(fieldBonusExp);// 1.2.372 Changed
            }
            if ((flag & 0x2000000L) != 0L) {
                packet.writeLong(23);// 1.2.372 Changed
            }
            if ((flag & 0x4000000L) != 0L) {
                packet.writeLong(eventBonusExp2);// 1.2.372 Changed
            }
            if ((flag & 0x8000000L) != 0L) {
                packet.writeLong(25);// 1.2.372 Changed
            }
            if ((flag & 0x10000000L) != 0L) {
                packet.writeLong(fieldBonusExp2);// 1.2.372 Changed
            }
            if ((flag & 0x20000000L) != 0L) {
                packet.writeLong(27);// 1.2.372 Changed
            }
            if ((flag & 0x40000000L) != 0L) {
                packet.writeLong(28);// 1.2.372 Changed
            }
            //packet.write(0); 1.2.372 Removed
            return packet.getPacket();
        }
        ...
        public static byte[] getArtipactMsg(String msg) {
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static class GuildPacket {
        ...
        public static byte[] createGuildAlliance(MapleGuildAlliance alliance) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            ...
            for (String rank : alliance.getRanks()) {
                mplew.writeMapleAsciiString(rank);
            }

            mplew.writeInt(alliance.getNoGuilds());

            mplew.write(alliance.getNoGuilds());
            for (int gid : alliance.getGuildIds()) {
        ...
        public static byte[] exitGuildAlliance(MapleGuildAlliance alliance, MapleGuild guild) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] guildEmblemChange(MapleCharacter chr, short bg, byte bgcolor, short logo, byte logocolor) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] changeCustomGuildEmblem(MapleCharacter chr, byte[] imgdata) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static void writeImageData(MaplePacketLittleEndianWriter mplew, byte[] imgdata) { // 1.2.391 OK.
        ...
        public static byte[] guildInvite(String guildname) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] guildInvite(int gid, String guildname, MapleCharacter chr) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
            ...
            mplew.writeInt(chr.getJob());
            mplew.writeInt(0);
            mplew.writeInt(0); // 받는 사람 캐릭터 ID

            return mplew.getPacket();
        }

        public static byte[] showGuildInfo(MapleCharacter c) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            ...
            mplew.writeInt(1);
            if (c == null || c.getMGC() == null || g == null) {
                ...
                boolean hasAlliance = (allianceId != 0);
                mplew.write(hasAlliance);
                if (hasAlliance) {
        ...
        public static byte[] showGuildInfo(MapleGuild g) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] LooksGuildInformation(MapleGuild guild) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static void getGuildInfo(MaplePacketLittleEndianWriter mplew, MapleGuild guild) { // 1.2.391 OK.
            mplew.writeInt(guild.getId());
            mplew.writeMapleAsciiString(guild.getName());

            for (int i = 1; i <= 10; i++) {
                mplew.writeMapleAsciiString(guild.getRankTitle(i));
                mplew.writeInt(guild.getRankRole(i));
            }
        ...
        public static byte[] newGuildInfo(MapleCharacter c) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] newGuildInfo2(MapleCharacter c) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] newGuildHash() { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());

            mplew.writeInt(104);
            mplew.writeMapleAsciiString("kvls4oCsy72x84NzHcMSYDE3cS4rAuGwzggoq_NCXbD~Lzn9b_zLCZjtrtQmpuPy5gvUR3~X6BGRXbZV0f7Vf~OsUY3IYxxyO8JgiHL7gazVu5WbkJWlJCjqBwG1h4V5IczqzdWuU4PQ_FK6gBgPii");

            return mplew.getPacket();
        }

        public static byte[] requestGuild(MapleGuild g) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] newGuildMember(MapleGuildCharacter mgc) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] newGuildMember2(MapleGuildCharacter mgc, MapleGuild g, MapleCharacter chr) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] requestGuild2(MapleGuild g, MapleCharacter chr, String message) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static void addNewMemberData(MaplePacketLittleEndianWriter mplew, MapleGuildCharacter mgc) { // 1.2.391 OK.
            mplew.writeInt(mgc.getId());
        ...
        public static byte[] RequestDeny(int id, MapleGuild g) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] RequestDenyMaster(int id, MapleGuild g) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] DelayRequest() { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] memberLeft(MapleGuildCharacter mgc, boolean bExpelled) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());

            mplew.writeInt(bExpelled ? 37 : 34);
            mplew.writeInt(mgc.getGuildId());
            mplew.writeInt(mgc.getId());
            mplew.writeMapleAsciiString(mgc.getName());
        ...
        public static byte[] guildDisband(int gid) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] guildDisband2() { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] guildCapacityChange(int gid, int capacity) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] guildContribution(int gid, int cid, int c) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] changeRank(MapleGuildCharacter mgc) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] rankTitleChange(int type, MapleCharacter chr, String[] ranks, int[] roles) { // 1.2.391 OK.
            int i;
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] updateGP(int gid, int gp, int glevel) { // 1.2.390 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
            ...
            mplew.writeInt(0); // 길드 포인트

            return mplew.getPacket();
        }

        public static byte[] guildNotice(MapleCharacter chr, String notice) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] guildMemberOnline(MapleGuildCharacter mgc, int gid, int cid, boolean bOnline) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] showGuildRanks(byte type, MapleClient c, MapleGuildRanking ranks) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            ...
            if (type == 1 || type == 2) {
                for (int i = 0; i < 3; i++) {
                    ...
                    if (rank == null) {
                        ...
                        for (MapleGuildRanking.GuildRankingInfo info : rank) {
                            ...
                            System.err.println("info.getName() =" + info.getName());
                ...
                mplew.writeInt(c.getPlayer().getGuild().getId());
                mplew.writeInt(0);
                mplew.write(0);
            } else if (type == 6) {
                mplew.writeLong(0);
        ...
        public static byte[] reloadGuildSkill(int gid) { // 1.2.390 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] guildSkillPurchased(int gid, int sid, int level, long expiration, String purchase, String activate) { // 1.2.390 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] guildLeaderChanged(int gid, int oldLeader, int newLeader, int allianceId) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
            ...
            mplew.write(0);
            mplew.write(0); // allianceId ?

            return mplew.getPacket();
        }

        public static byte[] denyGuildInvitation(String charname) { // 1.2.390 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        public static byte[] genericGuildMessage(int code, String name) { // 1.2.390 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
            mplew.writeInt(code);
        ...
        public static byte[] genericGuildMessage(int code) {
            ...
            if (code == 38 || code == 127 || code == 135 || code == 118) {
                mplew.writeInt(11);
            }

            if (code == 68 || code == 4 || code == 5 || code == 103 || code == 104 || code == 100 || code == 101 || code == 102) {
                mplew.writeMapleAsciiString("");
            }
        ...
        public static byte[] RecruitmentGuild(MapleCharacter chr) { // 1.2.390 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        public static byte[] RequestListGuild(List<MapleGuild> g) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
            mplew.writeInt(131);
        ...
        public static byte[] showSearchGuildInfo(MapleCharacter chr, List<MapleGuild> gss, String text, byte mode, int option) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.SEARCH_GUILD.getValue());
        ...
        public static byte[] updateGP(int gid, int contribution, int GP, int glevel) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
            ...
            mplew.writeInt(glevel);
            mplew.writeInt(GP); // 1.2.391 Changed. (Long -> Int)

            return mplew.getPacket();
        }

        public static byte[] GainGP(MapleGuild guild, MapleCharacter chr, int GP) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
            ...
            mplew.writeInt(guild.getId());
            mplew.writeInt(chr.getId());
            mplew.writeInt(GP); // Contribution
            mplew.writeInt(GP);
        ...
        public static byte[] guildLoad1(MapleCharacter chr) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] guildLoadAattendance() { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
        ...
        public static byte[] guildAattendance(MapleGuild guild, MapleCharacter chr) { // 1.2.391 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
    ...
    public static class PartyPacket {
        ...
        public static byte[] partyCreated(MapleParty party, MapleCharacter chr) { // 1.2.390 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            ...
            addPartyStatus(chr.getPlayer(), -1, World.Party.getParty(party.getId()), mplew);

            mplew.writeInt(party.getLeader().getId());
            return mplew.getPacket();
        }

        public static byte[] partyInvite(MapleCharacter from) { // 1.2.390 OK.
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.PARTY_OPERATION.getValue());
        ...
        public static void addPartyStatus(MapleCharacter chr, int forchannel, MapleParty party, MaplePacketLittleEndianWriter mplew, boolean leaving, boolean exped, byte type) {
            ...
            for (MaplePartyCharacter partychar : partymembers) {
                ...
                if (partychar.getId() > 0) {
                    ...
                    mplew.writeInt(0); // 1.2.372 ++
                    mplew.writeLong(PacketHelper.getTime(-1)); // 1.2.372 ++
            ...
            if (type > 0) { // 파티 생성을 제외하고..
                ...
                for (MaplePartyCharacter partychar : partymembers) {
                    mplew.writeInt(partychar.getChannel() == forchannel ? partychar.getMapid() : partychar.getChannel());
                }
    ...
    public static class AlliancePacket {
        ...
        public static byte[] allianceMemberOnline(MapleGuildCharacter mgc, int aid, int cid, boolean bOnline) {
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
    ...
    public static byte[] updatePlayerStats(final Map<MapleStat, Long> mystats, final boolean itemReaction, final boolean itemReaction2, final MapleCharacter chr, boolean isPet) {
        ...
        mplew.write(chr == null ? -1 : chr.getAddColor());
        mplew.write(chr == null ? -1 : chr.getBaseProb());
...
//        mplew.write(0); // 1.2.372 ++
    ...
    public static byte[] LieDetector(MapleClient c, int type, int count) {
        ...
        if (type == 0) {
            mplew.writeLong(63223549761L);

            mplew.write(HexTool.getByteArrayFromHexString("89 1E F0 CA")); //buffer4
            mplew.write(HexTool.getByteArrayFromHexString("FB 53 9B AA")); //buffer4
            mplew.write(HexTool.getByteArrayFromHexString("86 18 86 89")); // buffer4
            mplew.write(HexTool.getByteArrayFromHexString("72 B1")); // stirng
            mplew.write(count); //count
            ...
            c.setLIEDETECT("브하이레프보병");
            mplew.write(HexTool.getByteArrayFromHexString("C0 1D 00 00 FF D8 FF E0 00 10 4A 46 49 46 00 01 01 00 00 01 00 01 00 00 FF DB 00 43 00 08 06 06 07 06 05 08 07 07 07 09 09 08 0A 0C 14 0D 0C 0B 0B 0C 19 12 13 0F 14 1D 1A 1F 1E 1D 1A 1C 1C 20 24 2E 27 20 22 2C 23 1C 1C 28 37 29 2C 30 31 34 34 34 1F 27 39 3D 38 32 3C 2E 33 34 32 FF DB 00 43 01 09 09 09 0C 0B 0C 18 0D 0D 18 32 21 1C 21 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 32 FF C0 00 11 08 00 40 00 D8 03 01 22 00 02 11 01 03 11 01 FF C4 00 1F 00 00 01 05 01 01 01 01 01 01 00 00 00 00 00 00 00 00 01 02 03 04 05 06 07 08 09 0A 0B FF C4 00 B5 10 00 02 01 03 03 02 04 03 05 05 04 04 00 00 01 7D 01 02 03 00 04 11 05 12 21 31 41 06 13 51 61 07 22 71 14 32 81 91 A1 08 23 42 B1 C1 15 52 D1 F0 24 33 62 72 82 09 0A 16 17 18 19 1A 25 26 27 28 29 2A 34 35 36 37 38 39 3A 43 44 45 46 47 48 49 4A 53 54 55 56 57 58 59 5A 63 64 65 66 67 68 69 6A 73 74 75 76 77 78 79 7A 83 84 85 86 87 88 89 8A 92 93 94 95 96 97 98 99 9A A2 A3 A4 A5 A6 A7 A8 A9 AA B2 B3 B4 B5 B6 B7 B8 B9 BA C2 C3 C4 C5 C6 C7 C8 C9 CA D2 D3 D4 D5 D6 D7 D8 D9 DA E1 E2 E3 E4 E5 E6 E7 E8 E9 EA F1 F2 F3 F4 F5 F6 F7 F8 F9 FA FF C4 00 1F 01 00 03 01 01 01 01 01 01 01 01 01 00 00 00 00 00 00 01 02 03 04 05 06 07 08 09 0A 0B FF C4 00 B5 11 00 02 01 02 04 04 03 04 07 05 04 04 00 01 02 77 00 01 02 03 11 04 05 21 31 06 12 41 51 07 61 71 13 22 32 81 08 14 42 91 A1 B1 C1 09 23 33 52 F0 15 62 72 D1 0
B 6D 2C B6 77 96 51 44 5C 49 24 B1 95 F3 A4 0B B5 15 9C 67 7A 00 5D 8F 53 95 42 33 83 9E 9D 56 29 FC BB 94 76 65 20 32 15 90 ED 61 83 83 80 70 46 18 FE 9E 83 19 B1 3E A1 6B 6D 71 F6 6B 3B 0B A4 0F 23 46 2D A4 F2 77 B9 24 B6 E0 41 00 F9 9B B7 1D C4 F5 38 27 8A 73 69 1A 75 C4 32 4B 73 6B E4 9B AC 19 17 2B 1B 0D C0 03 1B 34 64 6E 04 F5 04 B0 24 F7 E2 AB 95 21 B7 1D 19 85 A4 45 FF 00 09 1D CD E9 D6 A5 9D 8A C8 CA 2C 83 3A C7 10 52 39 6C 60 67 9C 0C F5 C1 EB 83 8A 9A 4E 97 A5 CB E2 2B BB 1D 3E 0F 37 46 48 D0 B2 AB B1 8D 5D 7E E8 18 3C 8E 4F 1C FE 82 BA 3B 9D 1E 39 2E 55 4C F6 93 CA C8 76 25 FD B2 CC C1 14 8F BA 41 56 20 6E 19 2C 5B A8 E7 9E 5F 68 B7 90 4B 04 6D A4 DB C1 6E AE F8 4B 52 AD B4 E7 01 C9 3B 76 8D A5 BA 06 27 3F C3 8C 1A E6 5D 0D 5D 4B 5E DD 4D 75 50 AA 15 40 0A 06 00 03 80 28 AC 88 E0 12 DE 99 2E 9A 48 4B 43 25 B2 88 9A 45 12 20 75 01 9D C8 04 3E 4F C8 33 9F 99 CA 96 CE 41 44 54 1F C4 ED F2 BF EA 62 D5 8F FF D9 2C 14 D2 25 04 00 00 00 59 FA D3 51"));
        } else if (type == 1) {
            mplew.write(HexTool.getByteArrayFromHexString("FC FA 23 7B 0E 00 00 00 84 A5 36 08 84 A5 36 08 84 A5 36 08 01 01"));
        } else if (type == 2) { // 성공
            mplew.write(HexTool.getByteArrayFromHexString("E5 01 7B 0C 0E 00 00 00 84 B0 89 7F 20 B0 F5 68 A7 AB C1 9E 2F 22"));
        } else if (type == 3) {
    ...
    public static byte[] charInfoMe(MapleCharacter chr) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.CHAR_INFO_ME.getValue());
        mplew.writeInt(0);
        mplew.writeInt(0);
        mplew.write(0);
    ...
    public static byte[] charInfoOther(MapleCharacter chr) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.CHAR_INFO_OTHER.getValue());

        mplew.writeInt(0); // Unk

        mplew.writeInt(chr.getAccountID()); // Account Id
        ...
        // sub_140E00210
        mplew.write(0); // Unk
        mplew.writeShort(0); // 레벨
        mplew.writeInt(chr.getJob()); // 직업
        mplew.writeInt(chr.getStat().getStr()); // 힘
        mplew.writeInt(chr.getStat().getDex()); // 덱
        mplew.writeInt(chr.getStat().getInt()); // 인
        mplew.writeInt(chr.getStat().getLuk()); // 럭
        mplew.writeInt(chr.getFame()); // 인기도
        mplew.writeInt(chr.getStat().getMaxHp()); // 최대 체력
        mplew.writeInt(chr.getStat().getMaxMp()); // 최대 마나
        mplew.writeInt(chr.getStat().getMaxHp()); // 최대 체력
        mplew.writeInt(0); // 방어력 무시
        mplew.writeInt(0); // Unk
        mplew.writeInt(0); // Unk
        mplew.writeInt(0); // Unk
        mplew.writeInt(0); // Unk
        ...
        SecondaryStatEffect effect = new SecondaryStatEffect();
        ...
        mplew.writeMapleAsciiString(((chr.getGuild() != null && chr.getGuild().getAllianceId() != 0) ? World.Alliance.getAlliance(chr.getGuild().getAllianceId()).getName() : "")); // 길드 연합
        mplew.writeMapleAsciiString((chr.getGuild() != null ? chr.getGuild().getName() : "")); // 길드

        mplew.writeInt(0); // 무릉 도장

        KoreaCalendar kc = new KoreaCalendar();
        String now = kc.getYears() + kc.getMonths() + kc.getDays();
        mplew.writeMapleAsciiString(now); // Now

        int unionLevel = 0;
        for (MapleUnion union : chr.getUnions().getUnions()) {
            unionLevel += union.getLevel();
        }
        mplew.writeInt(unionLevel); // 유니온 레벨
        ...
        mplew.writeLong(0); // Unk

        mplew.writeInt(0); // Unk

        mplew.writeInt(0); // Unk
        // [SEX] 전투력 7777조 해결
        mplew.writeLong(0); // 전투력
        mplew.writeInt(0); // Unk

        mplew.writeInt(0); // HEAD_TITLE
        ...
        mplew.writeInt(0); // 하이퍼 스텟

        // 길드 스킬
        int guildSkillSize = 0;
        mplew.writeInt(guildSkillSize);
        for (int i = 0; i < guildSkillSize; i++) {
            mplew.writeInt(0); // Skill Id
            mplew.writeInt(0); // Skill Level
        }

        // 유니온 배치 스킬
        int unionSkillSize = 0;
        mplew.writeInt(unionSkillSize);
        for (int i = 0; i < unionSkillSize; i++) {
            mplew.writeInt(0); // Skill Id
            mplew.writeInt(0); // Skill Level
        }
    ...
    public static byte[] HyperMegaPhone(String msg, String name, String rawmsg, int channel, boolean ear, Item item) {
        ...
        mplew.write(channel - 1);
        mplew.write(ear ? 1 : 0);
        mplew.writeZeroBytes(14); // 1.2.391 ++ (Unk)
        mplew.writeShort(0); // 1.2.391 ++ (Character Level)
        mplew.writeInt(5076100);
        mplew.writeInt(1); // 1.2.391 ++ (Unk)
    ...
    public static byte[] spawnPlayerNPC(PlayerNPC npc, MapleCharacter chr) {
        ...
        AvatarLook.encodeAvatarLook(mplew, chr, true, (GameConstants.isZero(chr.getJob()) && chr.getGender() == 1), true);
        return mplew.getPacket();
    }
    ...
    public static byte[] AddCore(int kind, ArrayList<Core> cores) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.ADD_CORE.getValue());

        mplew.writeInt(kind);

        mplew.writeInt(cores.size());
        for (Core core : cores) {
    ...
    public static byte[] MiracleCirculator(List<InnerSkillValueHolder> newValues, int itemId, int preset) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        if (itemId == 5062800 || itemId == 5062801) {
            ...
            mplew.write(preset);
            mplew.writeInt(19);
        } else if (itemId == 2702007 || itemId == 2702008) {
            mplew.writeLong(0);
            mplew.write(2);
            mplew.write(preset);
            mplew.writeInt(84);
    ...
    public static byte[] setBossReward(MapleCharacter player) {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            mplew.writeLong(((Item) items.get(i)).getReward().getPrice());
            mplew.writeLong(0);
        ...
        switch (op) {
            case 50:
                ...
                for (EquipmentScroll es : ess) {
                    ...
                    mplew.writeInt(es.getName().contains("민첩") ? 352 : es.getName().contains("행운") ? 328 : es.getName().contains("지력") ? 336 : es.getName().contains("힘") ? 324 : es.getName().contains("체력") ? 328 : es.getName().contains("올스텟") ? 60 : 0);
                    ...
                    if (EnchantFlag.Acc.check(es.getFlag())) {
                        mplew.writeInt(((Integer) (es.getFlag(EnchantFlag.Acc)).right).intValue());
                    }
                    ...
                    mplew.writeInt(es.getJuhun());
                    mplew.write(es.getName().contains("100%") ? 1 : 0);
                }
                break;
            case 51:
                mplew.write(0);
            ...
            case 52:
                ...
                switch (currentDayOfWeek) {
                    ...
                    case THURSDAY:
                    case SATURDAY:
                        ServerConstants.starForceSalePercent = 5;
                        break;
                    case FRIDAY:
                        ServerConstants.starForceSalePercent = 7;
                        break;
                    case SUNDAY:
    ...
    public static byte[] initSecurity() {
        ...
        mplew.writeMapleAsciiString("10010-30CC0A-CBB733-C61559-22CBD0-1EE4E7B-078B");
    ...
    public static byte[] updateSecurity() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            mplew.writeMapleAsciiString("Fancy PC");
    ...
    public static byte[] checkFiveSecond() {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.SHOW_STATUS_INFO.getValue());
    ...
    public static byte[] UseMakeUpCouponZero(MapleCharacter chr, int itemid, int type, int... make) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.USE_MAKEUP_COUPON.getValue());
        mplew.write(101);
        mplew.writeInt(itemid);
        mplew.writeInt(1);
        mplew.write(type);// type = 0 skin
        mplew.write(chr.isdressup);
        mplew.write((GameConstants.isZero(chr.getJob()) && chr.getGender() == 1) ? 1 : 0);
        mplew.write(0);
        mplew.write(make.length);

        for (int i = 0; i < make.length; i++) { // isAlpha
            mplew.writeInt(make[i]);
        }

        mplew.write(make.length); // isBeta
    ...
    public static byte[] UseSymbolLevelup(Item item) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.SYMBOL_EFFECT.getValue());
        mplew.writeInt(1);
        mplew.writeInt(0);
        mplew.writeShort(item.getPosition());
        mplew.writeShort(-1);
    ...
    public static byte[] updateInnerPreset(byte preset) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.UPDATE_INNER_PRESET.getValue());
    ...
    public static byte[] reloadChar(MapleCharacter chr) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.RELOAD_CHAR.getValue());
