...
public class PlayerShopPacket {
    ...
    public static final byte[] getPlayerStore(MapleCharacter chr, boolean firstTime) {
        ...
        AvatarLook.encodeAvatarLook(mplew, ((MaplePlayerShop) ips).getMCOwner(), false, (GameConstants.isZero(chr.getJob()) && chr.getGender() == 1), true);
        ...
        for (Pair<Byte, MapleCharacter> storechr : ips.getVisitors()) {
            ...
            AvatarLook.encodeAvatarLook(mplew, (MapleCharacter) storechr.right, false, (GameConstants.isZero(((MapleCharacter) storechr.right).getJob()) && ((MapleCharacter) storechr.right).getGender() == 1), true);
    ...
    public static final byte[] shopChat(MapleCharacter chr, String name, int cid, String message, int slot) {
        ...
        mplew.writeInt(0); // 365++
        mplew.writeMapleAsciiString(message); // 1.2.366
    ...
    public static final byte[] shopVisitorAdd(MapleCharacter chr, int slot) {
        ...
        mplew.write(slot);
        AvatarLook.encodeAvatarLook(mplew, chr, false, (GameConstants.isZero(chr.getJob()) && chr.getGender() == 1), true);
        mplew.writeMapleAsciiString(chr.getName());
    ...
    public static final byte[] shopCashVisitorAdd(MapleCharacter chr, int slot) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.PLAYER_INTERACTION.getValue());
        mplew.writeInt(PlayerInteractionHandler.Interaction.VISIT.action);
        mplew.write(slot);
    ...
    public static byte[] getMiniGame(MapleClient c, MapleMiniGame minigame) {
        ...
        AvatarLook.encodeAvatarLook(mplew, minigame.getMCOwner(), false, (GameConstants.isZero(c.getPlayer().getJob()) && c.getPlayer().getGender() == 1), true);
        ...
        for (Pair<Byte, MapleCharacter> visitorz : minigame.getVisitors()) {
            ...
            AvatarLook.encodeAvatarLook(mplew, visitorz.getRight(), false, (GameConstants.isZero(((MapleCharacter) visitorz.right).getJob()) && ((MapleCharacter) visitorz.right).getGender() == 1), true);
    ...
    public static byte[] getMiniGameNewVisitor(MapleCharacter c, int slot, MapleMiniGame game) {
        ...
        mplew.writeShort(0);
        mplew.write(slot);
        AvatarLook.encodeAvatarLook(mplew, c, false, (GameConstants.isZero(c.getJob()) && c.getGender() == 1), true);
