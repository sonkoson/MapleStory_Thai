...
public class BitFlagCalculator {
    public static void main(String[] args) {
      ...
      //  String giveBuffPacket = "00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 04 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 B7 7B 1D 00 29 8E F7 01 00 00 00 00 00 00 00 00 00 01 01 01 01 00 00 00 00 01";

        LittleEndianAccessor giveBuffStream = new LittleEndianAccessor(new ByteArrayByteStream(HexTool.getByteArrayFromHexString(giveBuffPacket)));
