        ...
        if (client != null) {
            ...
            try {
                ...
                if (ServerConstants.DEBUG_SEND) {
                    ...
                    if (MOVE_MONSTER_RESPONSE.getValue() != opcode
                            && SPAWN_MONSTER.getValue() != opcode
                            && SPAWN_MONSTER_CONTROL.getValue() != opcode) {
                        client.lastPacketSendOpcode = SendPacketOpcode.getOpcodeName(opcode) + " / " + HexTool.toString(msg);
