    ...
    public static final void RemoveObstacle(LittleEndianAccessor slea, MapleClient c) {// mush will
        ...
        for (int i = 0; i < size; ++i) {
            ...
            if (hit == 1) {
                ...
                if (ob != null && (c.getPlayer().getMapId() == 450009450 || c.getPlayer().getMapId() == 450009400) && ob.getKey() == 65) { // Dusk Curse
                    MobSkill ms = MobSkillFactory.getMobSkill(133, 1);
                    ms.setDuration(3000L);
                    c.getPlayer().giveDebuff(SecondaryStat.Undead, ms);
                    break;
                }
                if (ob != null && (c.getPlayer().getMapId() == 450009450 || c.getPlayer().getMapId() == 450009400) && ob.getKey() == 66) { // Dusk Stun
                    MobSkill ms = MobSkillFactory.getMobSkill(123, 83);
                    c.getPlayer().giveDebuff(SecondaryStat.Stun, ms);
                    break;
                }
                if (ob != null && (c.getPlayer().getMapId() == 450009450 || c.getPlayer().getMapId() == 450009400) && ob.getKey() == 67) { // Dusk Darkness
