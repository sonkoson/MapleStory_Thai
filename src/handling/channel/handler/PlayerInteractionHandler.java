...
public class PlayerInteractionHandler {
    ...
    public static final void PlayerInteraction(final LittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
        byte a = (byte) (slea.readByte() & 0xFF);
        System.out.println(c.getPlayer().getName() + " type: " + a + " slea: " + slea);
        ...
        switch (action) {
            ...
            case RESET_HIRED: {
                ...
                //임시로 캐교 뚫어놓기
                if (subpacket == 16 && type3 == 7 || c.SecondPwUse == 1) {
                    final String secondPassword = slea.readMapleAsciiString();
                    if (c.CheckSecondPassword(secondPassword)) {
                ...
                if (subpacket == 19 && type3 == 7) {
                    if (c.SecondPwUse == 1) {
                        ...
                        final String secondPassword = slea.readMapleAsciiString();
                        if (c.SecondPwUse == 1) { //c.CheckSecondPassword(secondPassword) ||
            ...
            case GIVE_UP: {
                ...
                for (Pair<Byte, MapleCharacter> visitorz : game2.getVisitors()) {
                    if (!chr.getName().equals(visitorz.right.getName())) {
                        visitorz.right.MiniGameAddWin(game2);
                    }
                }
    ...
    public enum Interaction {
        ...
        CLOSE_MERCHANT(50),
        TAKE_MESOS(52),
        VIEW_MERCHANT_VISITOR(53),
        VIEW_MERCHANT_BLACKLIST(54),
        MERCHANT_BLACKLIST_ADD(55),
        //  MERCHANT_BLACKLIST_REMOVE(56),
        ...
        WEDDING_START(105),
        WEDDING_END(108),
        INVITE_ROCK_PAPER_SCISSORS(83), // 377
        ONECARD(155),
        ONECARD_EMOTION(156);
