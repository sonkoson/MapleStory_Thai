...
public class MapleItemInformationProvider {
    ...
    public final Item scrollEquipWithId(Item equip, Item scrollId, boolean ws, MapleCharacter chr) {
        if (equip.getType() == 1) {
            ...
            switch (scrollId.getItemId()) {
                ...
                case 2049136: //[othello] - 놀라운 긍정의 Fancy 주문서
                    nEquip.setStr((short) (nEquip.getStr() + 6));
                    nEquip.setInt((short) (nEquip.getInt() + 6));
                    nEquip.setDex((short) (nEquip.getDex() + 6));
                    nEquip.setLuk((short) (nEquip.getLuk() + 6));
                    if (Randomizer.isSuccess(60)) {
                        ...
                        nEquip.setWatk((short) (nEquip.getWatk() + 8));
                        nEquip.setMatk((short) (nEquip.getMatk() + 8));
                ...
                case 2047406:
                    ...
                    break;
                case 2046996: // 후원 한손무기 공격력/마력 주문서
                case 2047818: // 후원 두손무기 공격력/마력 주문서
                    nEquip.addWatk((short) 20);
                    nEquip.addMatk((short) 20);
                    break;
                case 2047949: // 후원 방어구 공격력/마력 주문서
                case 2046875: // 후원 악세서리 공격력/마력 주문서
                    nEquip.addWatk((short) 20);
                    nEquip.addMatk((short) 20);
                    break;
                case 2046991:
                ...
                default:
                    ...
                    if (scrollId.getItemId() == 2049360) {
                        int chane, ordinary, data[];
                        MapleData IData = getItemData(nEquip.getItemId());
                        MapleData info = IData.getChildByPath("info");
                        int level = MapleDataTool.getInt("reqLevel", info, 0);
                        if (level > 300) {
                            chr.dropMessage(6, "300레벨 이하의 장비 아이템에만 사용하실 수 있습니다.");
                            break;
                        }
    ...
    public final Item getEquipById(int equipId) {
        return getEquipById(equipId, -1L, false);
    }
