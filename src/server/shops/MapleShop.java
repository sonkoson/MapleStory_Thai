...
public class MapleShop {
    ...
    public void buy(MapleClient c, int itemId, short quantity, short position) {
        ...
        if (index >= 0) {
            ...
            long price = (long) Math.max(Math.ceil(ii2.getPrice(itemId) * (double) (GameConstants.isRechargable(itemId) ? (short) 1 : i.getQuantity())), 0.0);
    ...
    public void sellAllBossReward(MapleClient c, MapleInventoryType type, int total, short slot, short quantity) {
