...
public class ResetTask implements Runnable {
    ...
    public ResetTask() {
        System.out.println("[Loading Completed] ResetTask Start");
    }
    ...
    public static void resetArtipactMission(String now, final long time) {
        ...
        if (!alreadyReset(name, time)) {
            ...
            try {
                ...
                datas.add(new Pair(503155, "attendance=4;mobCount=20000;resetDate=" + now + ";attendance_lastDate=" + now));
                ...
                datas.add(new Pair(503135, "missionState=2222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222"));
                datas.add(new Pair(503136, "missionState=2222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222"));
            ...
            for (ChannelServer cs : ChannelServer.getAllInstances()) {
                ...
                for (MapleCharacter player : cs.getPlayerStorage().getAllCharacters().values()) {
                    ...
                    player.updateInfoQuest(503155, "attendance=4;mobCount=20000;resetDate=" + now + ";attendance_lastDate=" + now); // 주간 접속, 레벨 범위 몬스터 처치, 초기화 일자, 마지막 주간 접속 일자
                    ...
                    player.updateInfoQuest(503135, "missionState=2222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222"); // 스페셜 미션 1
                    player.updateInfoQuest(503136, "missionState=2222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222"); // 스페셜 미션 2

                    player.getClient().getSession().writeAndFlush(CWvsContext.InfoPacket.getArtipactMsg("보스 아티팩트 미션이 초기화 되었습니다."));
                }
            }

            saveReset(name, time);

            System.out.println("[알림] 보스 아티팩트 미션이 초기화 되었습니다.");
        }
    }
    ...
    public static void resetRebornInfo(String now, final long time) {
        ...
        if (!alreadyReset(name, time)) {
            ...
            System.out.println("[알림] 환생 정보가 초기화 되었습니다.");
        }
    }
