...
public class SecondaryStatEffect implements Serializable {
    ...
    private static String calcLog(String path, String data, int level) { // Skill.wz 데이터 로그 함수 자동 처리 구현
        data = data.replaceAll("\\(", "").replaceAll("\\)", "");

        int bottomIndex = 0;
        int topIndex = 3;

        while ((topIndex + 4) <= (data.length() - 1)) {
            if (data.substring(bottomIndex, topIndex).equals("log")) {
                double base = SecondaryStatEffect.baseLog(Double.parseDouble(data.substring((topIndex + 2), level >= 10 ? (topIndex + 4) : (topIndex + 3))), Double.parseDouble(data.substring(topIndex, (topIndex + 2))));

                data = String.valueOf(base) + data.substring(level >= 10 ? (topIndex + 4) : (topIndex + 3));
            }
    ...
    private static final int parseEval(String path, MapleData source, int def, String variables, int level) {
        ...
        String ddd = MapleDataTool.getString(dd).replaceAll("y", "x").replaceAll("X", "x");
        String dddd = ddd.replaceAll(variables, String.valueOf(level));
        if (dddd.contains("log")) {
            dddd = calcLog(path, dddd, level);
        } else if (dddd.substring(0, 1).equals("-")) {
            dddd = dddd.substring(1, 2).equals("u") || dddd.substring(1, 2).equals("d") ? "n(" + dddd.substring(1, dddd.length()) + ")" : "n" + dddd.substring(1, dddd.length());
        } else if (dddd.substring(0, 1).equals("=")) {
            dddd = dddd.substring(1, dddd.length());
        ...
        return (int) new CaltechEval(dddd.replaceAll("\\r\\n", "").replaceAll("log", "")).evaluate();
    }
            ...
            if (ret.skill) {
                switch (sourceid) {
                    ...
                    case 1121054: { // 발할라
                        ...
                        ret.statups.put(SecondaryStat.ComboCounter, new Pair<Integer, Integer>(10, -1));
                        break;
                    }
                    case 1200014:
                    case 1220010: {
                    ...
                    case 23111008: //엘리멘탈 나이트
                        ret.statups.put(SecondaryStat.ElementalKnight, new Pair<Integer, Integer>(1, 0));
                        break;
                    case 13121005:
                    case 33121004:
                    case 400001002: {
                    ...
                    /*case 3210016:
                    case 3220021: { //인핸스 애로우
                        ret.statups.put(SecondaryStat.EnhanceArrow, new Pair<Integer, Integer>(ret.x, ret.duration));
                        break;
                    }*/
                    case 3221006: {
                        ret.statups.put(SecondaryStat.IndieDex, new Pair<Integer, Integer>(Integer.valueOf(ret.indieDEX), ret.duration));
                    ...
                    case 400021042: { // 플레임 디스차지
                        ret.duration = 0;
                        ret.statups.put(SecondaryStat.Ember, new Pair<Integer, Integer>(ret.x, ret.duration));
                        break;
                    }
                    case 64121053: {
                    ...
                    case 65121011:
                    case 65141002: { // 소울 시커 엑스퍼트 VI 구현
                        ret.duration = 0;
                    ...
                    case 61101009: {
                        ret.duration = 0;
                        ret.statups.put(SecondaryStat.WillofSwordStrike, new Pair<Integer, Integer>(ret.x, ret.duration));
                        break;
                    }
                    case 65121053: {
                        ret.statups.put(SecondaryStat.IndiePad, new Pair<Integer, Integer>(Integer.valueOf(ret.indiePad), ret.duration));
                    ...
                    case 80002280: { // 해방된 룬의 힘
                        ret.duration = 180000;
                        ret.statups.put(SecondaryStat.IndieExp, new Pair<Integer, Integer>(0, ret.duration));
                        break;
                    }
                    case 80002281: {
                    ...
                    case 400021000: {
                        ...
                        ret.statups.put(SecondaryStat.IndieDamR, new Pair<>(ret.z, ret.duration));
                        break;
                    }
                    case 400021003: {
                    ...
                    case 400007009:
                    case 400007010: {
                        ret.statups.put(SecondaryStat.IndieDamR, new Pair<Integer, Integer>(Integer.valueOf(ret.indieDamR), ret.duration * 1000));
                        break;
                    }
                    case 400007003: {
                        ret.statups.put(SecondaryStat.IndieCr, new Pair<Integer, Integer>(Integer.valueOf(ret.indieCr), ret.duration));
                ...
                switch (sourceid) {
                    ...
                    case 2450038: {
                        ret.statups.put(SecondaryStat.ExpBuffRate, new Pair<Integer, Integer>(150, ret.duration));
                        break;
                    }
                    case 2450064: {  // 2배 쿠폰
                    ...
                    case 2450135: { // [Fancy] 경험치 10배 쿠폰
                        ret.statups.put(SecondaryStat.ExpBuffRate, new Pair<Integer, Integer>(900, ret.duration));
                        break;
                    }
                    case 2023072: {
    ...
    public final boolean applyTo(MapleCharacter applyfrom, MapleCharacter applyto, boolean primary, Point pos, int localDuration, byte rltype, boolean showEffect) {
        block196:
        {
            block197:
            {
                block195:
                {
                    ...
                    if (mpchange != 0L && applyto.isAlive() && !noCon) {
                    ...
                    if (this.sourceid == 2121003 && !applyto.getPosionNovas().isEmpty()) {
                        ...
                        //[othello] 플레임 위자드 소환수 변경 - 쉐도우 배트, 래버너스 배트 응용
                        ...
                        //[othello] 쉐도우 배트, 래버너스 배트 사용시 버프캔슬
                    } else if ((this.sourceid == 14001027 || this.sourceid == 14121016 || this.sourceid == 14141004 || this.sourceid == 14141012) && primary) {
                        if (applyfrom.getBuffedValue(14001027)) {
                            applyfrom.cancelEffect(applyfrom.getBuffedEffect(14001027));
                        }
                        if (applyfrom.getBuffedValue(14121016)) {
                            applyfrom.cancelEffect(applyfrom.getBuffedEffect(14121016));
                        }
                        if (applyfrom.getBuffedValue(14141004)) {
                            applyfrom.cancelEffect(applyfrom.getBuffedEffect(14141004));
                        }
                        if (applyfrom.getBuffedValue(14141012)) {
                            applyfrom.cancelEffect(applyfrom.getBuffedEffect(14141012));
                        }
                    }
                    ...
                    if ((summonMovementType = this.getSummonMovementType()) != null && ((this.sourceid == 400021071 || this.sourceid == 35111008 || this.sourceid == 35120002 || this.sourceid == 35111002 || this.sourceid == 400021092) && primary || this.sourceid != 400021071 && this.sourceid != 35111008 && this.sourceid != 35120002 && this.sourceid != 400021092)) {
                        if (this.sourceid == 400011001) {
                            if (applyto.getBuffedValue(1101013)) {
                                statups.put(SecondaryStat.ComboCounter, new Pair<Integer, Integer>(11, -1));
                                applyto.getClient().getSession().writeAndFlush((Object) CWvsContext.BuffPacket.giveBuff(statups, null, applyto));
                            }
                        ...
                        } else if (this.sourceid != 35111002 && this.sourceid != 400021047 && this.sourceid != 400011065 && this.sourceid != 14000027 && this.sourceid != 14120017 && this.sourceid != 14100027 && this.sourceid != 0xD74D4D && this.sourceid != 14120008 && this.sourceid != 151100002 && primary) {
                            if (applyto.getBuffedValue(this.sourceid)) {
                                ...
                                if (this.sourceid == 500001002 || this.sourceid == 500001003 || this.sourceid == 500001004) { // HEXA 솔 야누스 구현
                                    int maxCount = (applyfrom.getSkillLevel(500001000) / 10 + 1);
                                    int summId = maxCount == 1 ? 500001002 : maxCount == 2 ? 500001003 : 500001004;

                                    if (applyfrom.getSummons(summId).size() < maxCount) { // HEXA 솔 야누스 구현
                                        cancels = false;
                                    }
                                }
                                if (cancels) {
                        ...
                        if (spawn) {
                            ...
                            if (this.sourceid == 500001002 || this.sourceid == 500001003 || this.sourceid == 500001004) { // HEXA 솔 야누스 구현
                                int maxCount = (applyfrom.getSkillLevel(500001000) / 10);

                                summId = maxCount == 0 ? 500001002 : maxCount == 1 ? 500001003 : 500001004;
                                localDuration = (60000 + (applyfrom.getSkillLevel(500001000) / 10 * 10000));

                                if (applyfrom.getSummons(summId).size() >= maxCount && !applyfrom.skillisCooling(500001002)) {
                                    applyfrom.getClient().getSession().writeAndFlush(CField.skillCooldown(500001002, this.getCooldown(applyfrom)));
                                    applyfrom.addCooldown(500001002, System.currentTimeMillis(), this.getCooldown(applyfrom));
                                }
                            }

                            applyto.dropMessageGM(-8, "summon sourceId : " + summId);
                            
                            if (summId == 2341502 || summId == 2341503) { // 오리진 홀리 어드밴트 구현
                                rltype = 1;
                            }
                            ...
                            MapleSummon tosummon = new MapleSummon(
                                    applyfrom,
                                    summId,
                                    new Point(pos == null ? applyfrom.getTruePosition() : pos),
                                    summonMovementType,
                                    rltype,
                                    aftercancel ? Integer.MAX_VALUE : localDuration);
                            ...
                            if (localDuration != 0 && localDuration < 2100000000 && this.sourceid < 400000000 && this.sourceid != 35111002
                                    && GameConstants.getHexaOriginFirst(applyto.getJob()) != this.sourceid
                                    && (GameConstants.getHexaOriginFirst(applyto.getJob()) + 1) != this.sourceid
                                    && (GameConstants.getHexaOriginFirst(applyto.getJob()) + 2) != this.sourceid
                                    && (GameConstants.getHexaOriginFirst(applyto.getJob()) + 3) != this.sourceid
                                    && (GameConstants.getHexaOriginFirst(applyto.getJob()) + 4) != this.sourceid) {
                            ...
                            } else if (this.sourceid == 5221022 || this.sourceid == 5221027) {
                                if (applyfrom.getBuffedValue(5221022) && applyfrom.getBuffedValue(5221027)) {
                                    applyfrom.cancelEffect(applyfrom.getBuffedEffect(5221022));
                                    applyfrom.cancelEffect(applyfrom.getBuffedEffect(5221027));
                                }
                            } else if (this.sourceid == 5241002 || this.sourceid == 5241003) { // 배틀쉽 봄버 VI 구현
                                if (applyfrom.getBuffedValue(5241002) && applyfrom.getBuffedValue(5241003)) {
                                    applyfrom.cancelEffect(applyfrom.getBuffedEffect(5241002));
                                    applyfrom.cancelEffect(applyfrom.getBuffedEffect(5241003));
                                }
                            }
                            ...
                            if (this.sourceid == 400011077) {
                            ...
                            } else if (this.sourceid == 35111002) { // 마그네틱 필드 구현
                                ...
                                if (count.size() == 3) {
                                    ...
                                    for (MapleSummon s : applyfrom.getMap().getAllSummonsThreadsafe()) {
                                        ...
                                        s.removeSummon(applyfrom.getMap(), false);
                                    }

                                    applyfrom.cancelEffect(this);

                                    MapleSummon s = new MapleSummon(applyfrom, this, pos, SummonMovementType.STATIONARY);
                                    s.setDuration(70000);
                                    applyfrom.addSummon(s);
                                    applyfrom.getMap().spawnSummon(s);
                    ...
                    int maxCount = (applyfrom.getSkillLevel(500001000) / 10);
                    int summId = maxCount == 0 ? 500001002 : maxCount == 1 ? 500001003 : 500001004;

                    if ((this.sourceid == 500001002 || this.sourceid == 500001003 || this.sourceid == 500001004) && applyfrom.getSummons(summId).size() == 1) { // HEXA 솔 야누스 구현
                        this.applyBuffEffect(applyfrom, applyto, primary, localDuration, pos, showEffect);
                    } else {
                        if ((this.sourceid != 500001002 && this.sourceid != 500001003 && this.sourceid != 500001004)) {
                            this.applyBuffEffect(applyfrom, applyto, primary, localDuration, pos, showEffect);
                        }
                    }
                ...
                //[othello] 미스트류 지속시간 세팅
                if (this.sourceid == 151121041) {
                    mist.setDuration(1050);
                    mist.setEndTime(1050);
                }
                if (this.sourceid == 80001839) {
                    if (GameConstants.보스맵(applyfrom.getMap().getId())) {
                        localDuration = 10 * 1000;
                        mist.setDuration(10 * 1000);
                        mist.setEndTime(10 * 1000);
                    } else {
                        localDuration = 10 * 60 * 1000;
                        mist.setDuration(10 * 60 * 1000);
                        mist.setEndTime(10 * 60 * 1000);
                    }
                    //몹 모으기, 바인드 스킬추가 - 후원스킬
                    if (applyfrom.getMap() != null) {
                        ...
                        if (mist != null) {
                            ...
                            for (MapleMapObject monstermo : applyfrom.getMap().getMapObjectsInRange(mist.getPosition(), range, Arrays.asList(MapleMapObjectType.MONSTER))) {
                                mob = (MapleMonster) monstermo;
                                if (mob != null) {
                                    mob.applyStatus(applyfrom.getClient(), MonsterStatus.MS_Freeze, new MonsterStatusEffect(100001261, 15000), 15000, mist.getSource());
                                }
                            }
                        }
                    }
                ...
                if (applyfrom.isGM()) {
                    applyfrom.dropMessageGM(-8, "spawnMist : " + this.sourceid + " / Duration : " + duration + " / pos : " + mist.getTruePosition());
        ...
        //[othello] 칼리 오블리비온 쿨타임 감소
        if (isKhaliHyper() && (System.currentTimeMillis() - applyto.lastTimeleapTime) >= duration) {
            for (MapleCoolDownValueHolder i : applyto.getCooldowns()) {
                if (i.skillId != 154121043 && !SkillFactory.getSkill(i.skillId).isHyper()) {
                    applyto.lastTimeleapTime = System.currentTimeMillis();
                    applyto.removeCooldown(i.skillId);
                    applyto.getClient().getSession().writeAndFlush(CField.skillCooldown(i.skillId, 0));
                }
    ...
    private final void applyBuffEffect(MapleCharacter applyfrom, MapleCharacter applyto, boolean primary, int newDuration, Point pos, boolean showEffect) {
        ...
        List<Pair<SecondaryStat, Integer>> SkillList = new ArrayList<>();
...
//        if (applyto.isGM()) { //스킬 이름 제대로 출력
//            applyto.dropMessageGM(6, "SkillID : " + this.sourceid + " | Name : " + SkillFactory.getSkillName(this.sourceid));
//        }
        ...
        if (this.sourceid == 500001002 || this.sourceid == 500001003 || this.sourceid == 500001004) { // HEXA 솔 야누스 구현
            int maxCount = (applyfrom.getSkillLevel(500001000) / 10);
            int summonId = maxCount == 0 ? 500001002 : maxCount == 1 ? 500001003 : 500001004;
            int nowCount = applyfrom.getSummons(summonId).size();

            if (nowCount == 1) {
                this.sourceid = 500001002;
            } else if (nowCount == 2) {
                this.sourceid = 500001003;
            } else {
                this.sourceid = 500001004;
            }
        }

        // 6차 구현
        switch (this.sourceid) {
            case 1241501: { // 오리진 세이크리드 바스티온 구현
                MapleMist mist = new MapleMist(new Rectangle(pos.x + 50, pos.y + 50, pos.x - 50, pos.y - 50), applyfrom, this, localDuration, (byte) 0);
                applyfrom.getMap().spawnMist(mist, false);

                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 2141502: { // 오리진 인페르날 베놈 구현
                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 2241504: { // 오리진 프로즌 라이트닝 구현
                localstatups.put(SecondaryStat.Origin_Frozen_Lightning, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 2341004: { // 트라이엄프 페더 VI 구현
                localstatups.put(SecondaryStat.Triumph, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 2341501: { // 오리진 홀리 어드밴트 구현
                SkillFactory.getSkill(2341502).getEffect(applyfrom.getSkillLevel(2341500)).applyTo(applyfrom, new Point(pos.x - 600, pos.y));
                SkillFactory.getSkill(2341503).getEffect(applyfrom.getSkillLevel(2341500)).applyTo(applyfrom, new Point(pos.x + 600, pos.y));
                
                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 2341505: { // 오리진 홀리 어드밴트 구현
                MapleSummon summon = applyfrom.getSummon(2341501);
                MapleSummon summon2 = applyfrom.getSummon(2341502);
                MapleSummon summon3 = applyfrom.getSummon(2341503);

                summon.setPosition(applyfrom.getPosition());
                summon2.setPosition(new Point(applyfrom.getPosition().x - 600, applyfrom.getPosition().y));
                summon3.setPosition(new Point(applyfrom.getPosition().x + 600, applyfrom.getPosition().y));

                applyfrom.getMap().broadcastMessage(CField.SummonPacket.removeSummon(summon, false));
                applyfrom.getMap().broadcastMessage(CField.SummonPacket.spawnSummon(summon, true));
                
                applyfrom.getMap().broadcastMessage(CField.SummonPacket.removeSummon(summon2, false));
                applyfrom.getMap().broadcastMessage(CField.SummonPacket.spawnSummon(summon2, true));
                
                applyfrom.getMap().broadcastMessage(CField.SummonPacket.removeSummon(summon3, false));
                applyfrom.getMap().broadcastMessage(CField.SummonPacket.spawnSummon(summon3, true));
                break;
            }
            case 3141501: { // 오리진 어센던트 셰이드 구현
                localstatups.put(SecondaryStat.Unk_733, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 3341501: { // 오리진 포세이큰 렐릭 구현
                localstatups.put(SecondaryStat.Origin_Forsaken_Relic, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 4141002: { // 마크 오브 어쌔신 VI 구현
                localDuration = 0;

                localstatups.put(SecondaryStat.Mark_Of_Assassin, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 4141502: { // 오리진 생사여탈 구현
                localstatups.put(SecondaryStat.Origin_Life_And_Death, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 4361001: { // 아수라 VI 구현
                localstatups.put(SecondaryStat.Asura, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 4361501: { // 오리진 카르마 블레이드 구현
                applyfrom.hexaMasterySkillStack = 50;

                localstatups.put(SecondaryStat.Origin_Karma_Blade_Stack, new Pair<Integer, Integer>(applyfrom.hexaMasterySkillStack, localDuration));
                break;
            }
            case 5141001: { // 피스트 인레이지 VI 구현
                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 5141501: { // 오리진 리버레이트 넵투누스 구현
                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            ...
            case 5241502: { // 오리진 드레드노트 구현
                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 11141501: { // 오리진 아스트랄 블리츠 구현
                localstatups.put(SecondaryStat.IndiePmdR, new Pair<Integer, Integer>(5, localDuration));
                break;
            }
            case 12141500: { // 오리진 이터니티 구현
                applyfrom.hexaSkillTimer = Timer.WorldTimer.getInstance().register(new Runnable() {

                    @Override
                    public void run() {
                        if (applyfrom.getBuffedValue(12141500)) {
                            List<Triple<Integer, Integer, Integer>> mobList = new ArrayList<>();

                            applyfrom.getMap().broadcastMessage(CField.bonusAttackRequest(12141501, mobList, true, 0, null));
                        } else {
                            if (applyfrom.hexaSkillTimer != null) {
                                applyfrom.hexaSkillTimer.cancel(true);
                            }
                        }
                    }
                }, 3000, 3000);
            ...
            case 13141501: { // 오리진 미스트랄 스프링 구현
                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 13141505: { // 오리진 미스트랄 스프링 구현
                MapleSummon summon = applyfrom.getSummon(13141501);
            ...
            case 14141502: { // 오리진 사일런스 구현
                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 14141004: { // 쉐도우 배트 VI 구현
                localDuration = 0;

                localstatups.put(SecondaryStat.ShadowBatt, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 14141012: { // 래버너스 배트 VI 구현
                localDuration = 0;

                localstatups.put(SecondaryStat.HiddenPossession, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 21141506: { // 오리진 아드레날린 서지 구현
                if (applyfrom.getBuffedEffect(SecondaryStat.Origin_Adrenaline_Surge) != null) {
                    applyfrom.setCombo((short) 0);
                    SkillFactory.getSkill(21000000).getEffect(applyfrom.getSkillLevel(21000000)).applyTo(applyfrom, false);
                    applyfrom.getClient().getSession().writeAndFlush(CField.aranCombo(applyfrom.getCombo()));

                    applyfrom.cancelEffectFromBuffStat(SecondaryStat.Stance, 21141506);
                    applyfrom.cancelEffectFromBuffStat(SecondaryStat.AdrenalinBoost, 21141506);
                    applyfrom.cancelEffectFromBuffStat(SecondaryStat.Origin_Adrenaline_Surge, 21141506);
                    break;
                }
                ...
                localstatups.put(SecondaryStat.Origin_Adrenaline_Surge, new Pair<Integer, Integer>(2, localDuration));

                if (primary) {
                    applyfrom.setSkillCustomInfo(21110016, 1L, 0L);
                    break;
                }

                applyfrom.setSkillCustomInfo(21110016, 0L, 0L);

                break;
            }
            case 22201501: { // 오리진 조디악 버스트 구현
                localDuration = 45000;

                localstatups.put(SecondaryStat.Unk_559, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 23141501: { // 오리진 언페이딩 글로리 구현
                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 23141503: { // 오리진 언페이딩 글로리 구현
                MapleSummon summon = applyfrom.getSummon(23141501);
            ...
            case 24141501: { // 오리진 디파잉 페이트 구현
                localstatups.put(SecondaryStat.SalamanderMischief, new Pair<Integer, Integer>(50, localDuration));
                break;
            }
            case 25141506: { // 오리진 호신강림 구현
                localDuration = 0;
            ...
            case 31141501: { // 오리진 나이트메어 구현
                applyfrom.hexaMasterySkillStack = 0;

                localstatups.put(SecondaryStat.Origin_Nightmare, new Pair<Integer, Integer>(applyfrom.hexaMasterySkillStack, localDuration));
                break;
            }
            case 31141503: { // 오리진 나이트메어 구현
                if (applyfrom.getBuffedEffect(SecondaryStat.Origin_Nightmare) != null) {
                    applyfrom.cancelEffectFromBuffStat(SecondaryStat.Origin_Nightmare, 31141501);
                    break;
                }

                break;
            }
            case 31241501: { // 오리진 레퀴엠 구현
                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 31241502: { // 오리진 레퀴엠 구현
                if (applyfrom.getBuffedEffect(31241501) != null) {
                    applyfrom.cancelEffectFromBuffStat(SecondaryStat.IndieSummon, 31241501);
                }
            ...
            case 33141004: { // 와일드 발칸 VI 구현
                if (primary) {
                    localDuration = 10000;
                    
                    localstatups.put(SecondaryStat.Unk_763, new Pair<Integer, Integer>(1, localDuration));
                    break;
                }
                
                localDuration = 30000;
                
                localstatups.put(SecondaryStat.Unk_764, new Pair<Integer, Integer>(applyfrom.hexaMasterySkillStack, localDuration));
                break;
            }
            case 33141503: { // 오리진 네이쳐스 빌리프 구현
                localstatups.put(SecondaryStat.Unk_765, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 35141501: { // 오리진 그라운드 제로 구현
                applyfrom.hexaSkillTimer = Timer.WorldTimer.getInstance().register(new Runnable() {

                    @Override
                    public void run() {
                        if (applyfrom.getBuffedValue(35141501)) {
                            List<Triple<Integer, Integer, Integer>> mobList = new ArrayList<>();

                            applyfrom.getMap().broadcastMessage(CField.bonusAttackRequest(35141501, mobList, true, 0, null));
                        } else {
                            if (applyfrom.hexaSkillTimer != null) {
                                applyfrom.hexaSkillTimer.cancel(true);
                            }
                ...
                localstatups.put(SecondaryStat.DropRIncrease, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 36141502: { // 오리진 아티피셜 에볼루션 구현 1
                localstatups.put(SecondaryStat.NewFlying, new Pair<Integer, Integer>(1, 30000));
                break;
            }
            case 36141503: { // 오리진 아티피셜 에볼루션 구현 2
                localstatups.put(SecondaryStat.Origin_Artificial_Evolution, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 61141006: { // 윌 오브 소드 VI 구현
                localDuration = 0;

                localstatups.put(SecondaryStat.StopForceAtominfo, new Pair<Integer, Integer>(5, localDuration));
                break;
            }
            ...
            case 63141503: { // 오리진 어나일레이션 구현
                localstatups.put(SecondaryStat.Unk_678, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 65141501: { // 오리진 그랜드 피날레 구현
                localDuration = 30000;

                localstatups.put(SecondaryStat.Unk_733, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 151141003: { // 원더 VI 구현
                localDuration = 0;

                localstatups.put(SecondaryStat.Wonder, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 152141501: { // 오리진 언리미티드 크리스탈 구현
                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 154141502: { // 헥스 : 샌드스톰 구현
                localstatups.put(SecondaryStat.IndiePmdR, new Pair<Integer, Integer>(10, localDuration));
                break;
            }
            case 155141501: { // 오리진 가장 오래된 심연 구현
                if (applyfrom.getSkillLevel(155141000) > 0) { // 깨어난 심연 구현
                    applyfrom.hexaMasterySkillStack = 300;

                    EnumMap<SecondaryStat, Pair<Integer, Integer>> statups = new EnumMap<SecondaryStat, Pair<Integer, Integer>>(SecondaryStat.class);
                    statups.put(SecondaryStat.Unk_771, new Pair<Integer, Integer>(applyfrom.hexaMasterySkillStack, 0));
                    SecondaryStatEffect eff = SkillFactory.getSkill(155141001).getEffect(applyfrom.getSkillLevel(155141000));
                    applyfrom.getClient().getSession().writeAndFlush(CWvsContext.BuffPacket.giveBuff(statups, eff, applyfrom));
                }
                
                localstatups.put(SecondaryStat.Unk_559, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 162141002: { // 분출 : 너울이는 강 VI 구현
                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 162141005: { // 분출 : 돌개바람 VI 구현
                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 162141007: { // 분출 : 해돋이 우물 VI 구현
                SkillFactory.getSkill(162141008).getEffect(applyfrom.getSkillLevel(162141008)).applyTo(applyfrom, applyfrom.getPosition());

                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(1, localDuration));
                localstatups.put(SecondaryStat.IndieUnk1, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 164141029: { // 천지만물 구현
                localstatups.put(SecondaryStat.IndiePmdR, new Pair<Integer, Integer>(5, localDuration));
                break;
            }
            case 500001001: { // HEXA 솔 야누스 구현
                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 500001002: { // HEXA 솔 야누스 구현
                localDuration = (60000 + (applyfrom.getSkillLevel(500001000) / 10 * 10000));

                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            default: // 모든 6차 스킬 도입부 무적 & 바인딩
                if (applyfrom.getLevel() >= 260) {
                    if (this.sourceid == GameConstants.getHexaOriginFirst(applyfrom.getJob())) {
                        long originDuration = 5000;

                        if (!applyfrom.getBuffedValue(this.sourceid) && applyfrom.getKeyValue(7777777, "Origin Cooltime") <= System.currentTimeMillis()) {
                            if (applyfrom.getBuffedValue(21141506)) { // 오리진 아드레날린 서지 구현
                                return;
                            }

                            if (this.sourceid == 15141500) { // 오리진 뇌명벽해파 구현
                                applyfrom.lightning = 5;
                                applyfrom.hexaMasterySkillStack = 3;

                                SkillFactory.getSkill(15001022).getEffect(applyfrom.getSkillLevel(15001022)).applyTo(applyfrom, applyfrom.getBuffedEffect(SecondaryStat.CygnusElementSkill) == null);
                                SkillFactory.getSkill(15110025).getEffect(15110025).applyTo(applyfrom);
                            }

                            if (this.sourceid == 22201500) { // 오리진 조디악 버스트 구현
                                SkillFactory.getSkill(22201501).getEffect(applyfrom.getSkillLevel(22201501)).applyTo(applyfrom);
                            }

                            // 오리진 하모닉 패러독스 구현 [S]
                            SecondaryStatEffect eff = applyfrom.getBuffedEffect(20040219);
                            if (eff != null) {
                                applyfrom.hexaMasterySkillStack = (int) ((10000 + SkillFactory.getSkill((int) 27120008).getEffect((int) applyto.getSkillLevel((int) 27120008)).duration) - (System.currentTimeMillis() % 1000000000L - eff.getStarttime()) + 10000);

                                SkillFactory.getSkill(20040219).getEffect(applyfrom.getSkillLevel(20040219)).applyTo(applyfrom);
                            }

                            eff = applyfrom.getBuffedEffect(20040220);
                            if (eff != null) {
                                applyfrom.hexaMasterySkillStack = (int) ((10000 + SkillFactory.getSkill((int) 27120008).getEffect((int) applyto.getSkillLevel((int) 27120008)).duration) - (System.currentTimeMillis() % 1000000000L - eff.getStarttime()) + 10000);

                                SkillFactory.getSkill(20040220).getEffect(applyfrom.getSkillLevel(20040220)).applyTo(applyfrom);
                            }
                            // 오리진 하모닉 패러독스 구현 [E]

                            // 오리진 마이트 오브 노바 구현 [S]
                            eff = applyfrom.getBuffedEffect(61111008);
                            if (eff != null) {
                                applyfrom.hexaMasterySkillStack = (int) (eff.getDuration() - (System.currentTimeMillis() % 1000000000L - eff.getStarttime()) + 10000);

                                SkillFactory.getSkill(61111008).getEffect(applyfrom.getSkillLevel(61111008)).applyTo(applyfrom);

                                applyfrom.setKaiserCombo((short) 1201);
                                SkillFactory.getSkill(61111008).getEffect(1).applyKaiserCombo(applyfrom, applyfrom.getKaiserCombo());
                            }

                            eff = applyfrom.getBuffedEffect(61120008);
                            if (eff != null) {
                                applyfrom.hexaMasterySkillStack = (int) (eff.getDuration() - (System.currentTimeMillis() % 1000000000L - eff.getStarttime()) + 10000);

                                SkillFactory.getSkill(61120008).getEffect(applyfrom.getSkillLevel(61120008)).applyTo(applyfrom);

                                applyfrom.setKaiserCombo((short) 1201);
                                SkillFactory.getSkill(61111008).getEffect(1).applyKaiserCombo(applyfrom, applyfrom.getKaiserCombo());
                            }

                            eff = applyfrom.getBuffedEffect(61121053);
                            if (eff != null) {
                                applyfrom.hexaMasterySkillStack = (int) (eff.getDuration() - (System.currentTimeMillis() % 1000000000L - eff.getStarttime()) + 10000);

                                SkillFactory.getSkill(61121053).getEffect(applyfrom.getSkillLevel(61121053)).applyTo(applyfrom);
                            ...
                            if (this.sourceid == 155141500) { // 오리진 가장 오래된 심연 구현
                                SkillFactory.getSkill(155141501).getEffect(applyfrom.getSkillLevel(155141500)).applyTo(applyfrom);
                            }

                            int ndTime = SkillFactory.getSkill(this.sourceid).getNDTime();

                            localstatups.put(SecondaryStat.IndieNotDamaged, new Pair<Integer, Integer>(1, ndTime != 0 ? ndTime : 5000));
                            //localstatups.put(SecondaryStat.IndieNotMove, new Pair<Integer, Integer>(1, ndTime != 0 ? ndTime : 5000));

                            applyfrom.setKeyValue(7777777, "Origin Cooltime", (System.currentTimeMillis() + originDuration) + "");
                        }
                    }
                }
        ...
        switch (this.sourceid) {
            ...
            case 13120003:
            case 13120010:
            case 13141001: { // 트라이플링 윔 VI 구현
                localDuration = 0;

                localstatups.put(SecondaryStat.TryflingWarm, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
        }
        ...
        switch (this.sourceid) {
            ...
            case 21120019: {
                localstatups.clear();
                if (applyfrom.getSkillCustomValue0(21120019) < 6) {
                    localstatups.put(SecondaryStat.AranBoostEndHunt, new Pair<>((int) applyfrom.getSkillCustomValue0(21120019), localDuration));
                    localstatups.put(SecondaryStat.IndieNotDamaged, new Pair<>(1, localDuration));
                }
                break;
            }
            case 21120026: { // 부스트 엔드 - 헌티즈 타게팅
                localstatups.put(SecondaryStat.IndieNotDamaged, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 400011015:
                localstatups.put(SecondaryStat.UnkBuffStat707, new Pair<>(1, localDuration));
                break;
            case 1200014:
            case 1220010: {
            ...
            case 2211015: {
                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(1, 60000));
                break;
            }
            case 1211014: {
            ...
            // 작업 - 플레임 위자드 인피니티 플레임 서클 - 3
            case 400021072: {
                localstatups.put(SecondaryStat.InfinityFlameCircle, new Pair<Integer, Integer>(this.z, 0));
                break;
            }
            // 작업 -플레임위자드 피닉스 드라이브브
            case 12121054: {
                localstatups.put(SecondaryStat.PhoenixDrive, new Pair<Integer, Integer>(1, localDuration));
                // todo 스킬 쿨타임 줄때
            ...
            case 1121055: { // Valhala Summon
                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(this.x, 10000));
                break;
            }
            case 25121131:
            case 25121133: {
                localstatups.clear();
                aftercancel = false;
                System.out.println("aftercancel : " + aftercancel);
                ...
                localstatups.put(SecondaryStat.IndieBooster, new Pair<Integer, Integer>(-1, this.duration));
                break;
            }

            case 1321015: {
                this.hpR = (double) this.y / 100.0;
                localstatups.put(SecondaryStat.IgnoreTargetDEF, new Pair<Integer, Integer>(this.x, localDuration));
                localstatups.put(SecondaryStat.IndieBDR, new Pair<Integer, Integer>(Integer.valueOf(this.indieBDR), localDuration));
                break;
            }
            ...
            case 1301013: { // 비홀더
                ...
                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(1, localDuration));
                localstatups.put(SecondaryStat.Beholder, new Pair<Integer, Integer>(1, localDuration));
                if (applyto.hasSkill(1310013)) {
                    applyto.getSkillEffect(1310013).applyTo(applyto);
            ...
            case 400031000: { // 가이디드 애로우
                localstatups.put(SecondaryStat.GuidedArrow, new Pair<Integer, Integer>(1, 0));
                break;
            }
            ...
            case 1310016: { // 비홀더스 버프
                ...
                localstatups.put(SecondaryStat.EnhancedPad, new Pair<Integer, Integer>(epad, localDuration));
                localstatups.put(SecondaryStat.EnhancedPdd, new Pair<Integer, Integer>(n, localDuration));
                localstatups.put(SecondaryStat.IndieCr, new Pair<Integer, Integer>(indieCr, localDuration));
                break;
            }
            ...
            case 3310006: { //에인션트 가이던스
                ...
                localstatups.clear();
                localstatups.put(SecondaryStat.IndiePmdR, new Pair<Integer, Integer>(8, localDuration));
            ...
            case 80000757: { // 환생 전용 버프
                localDuration = 0;
                
                if (applyfrom.getKeyValue(7777778, "Reborn") == -1) {
                    applyfrom.setKeyValue(7777778, "Reborn", 0 + "");
                }
                
                int increase = (int) applyfrom.getKeyValue(7777778, "Reborn");
                
                localstatups.put(SecondaryStat.IndieStr, new Pair<>(increase * 10, localDuration));
                localstatups.put(SecondaryStat.IndieDex, new Pair<>(increase * 10, localDuration));
                localstatups.put(SecondaryStat.IndieInt, new Pair<>(increase * 10, localDuration));
                localstatups.put(SecondaryStat.IndieLuk, new Pair<>(increase * 10, localDuration));
                break;
            }
            case 80000783: { // 유일 전용 버프
                localDuration = 0;
                
                localstatups.put(SecondaryStat.IndiePmdR, new Pair<>(applyfrom.getOneItemEquippedCount() * 3, localDuration));
                break;
            }
            case 2321055: {
                bufftimeR = false;
            ...
            case 4221016: {
                ...
                localstatups.put(SecondaryStat.IndieNotDamaged, new Pair<Integer, Integer>(applyto.shadowerDebuff, 3000));
                break;
            }
            case 4221054: {
                bufftimeR = false;
            ...
            case 80002924: {
                if (applyto.isGM()) {
                    localstatups.put(SecondaryStat.IndiePad, new Pair<Integer, Integer>(500000000, 0));
                    localstatups.put(SecondaryStat.IndieMad, new Pair<Integer, Integer>(200000000, 0));
                    localstatups.put(SecondaryStat.IndieDamR, new Pair<Integer, Integer>(1000000000, 0));
                    localstatups.put(SecondaryStat.IndieMadR, new Pair<Integer, Integer>(80000000, 0));
                    localstatups.put(SecondaryStat.IndieCr, new Pair<Integer, Integer>(1000, 0));
                    localstatups.put(SecondaryStat.IndieIgnoreMobPdpR, new Pair<Integer, Integer>(1000, 0));
                    localstatups.put(SecondaryStat.IndieCD, new Pair<Integer, Integer>(1000, 0));
                    localstatups.put(SecondaryStat.IndiePmdR, new Pair<Integer, Integer>(Integer.MAX_VALUE, 0));
                }
            }
            case 4331006: {
                bufftimeR = false;
            ...
            case 35120014: {
                ...
                if (this.isDoubleDice() && doubledice > 0) {
                    //[othello] - 더블 럭키 다이스 숫자 제대로 출력
                    applyto.getMap().broadcastMessage(applyto, CField.EffectPacket.showDiceEffect(applyto, 0, n, dice * 10 + doubledice, -1, false), false);
                    applyto.getClient().getSession().writeAndFlush((Object) CField.EffectPacket.showDiceEffect(applyto, 0, n, dice * 10 + doubledice, -1, true));
            ...
            case 12120007: {
                ...
                // localstatups.put(SecondaryStat.Ember, new Pair<Integer, Integer>(this.x , localDuration));
                break;
            }
            case 400021042: { // 플레임 디스차지
                //   System.err.println("stack =" + applyfrom.ignitionstack);
                localstatups.put(SecondaryStat.Ember, new Pair<Integer, Integer>(applyfrom.ignitionstack, localDuration));
                break;
            }
            case 12111023: {
                localstatups.clear();
            ...
            case 15001022: { // 엘리멘탈 : 라이트닝
                ...
                localstatups.put(SecondaryStat.IgnoreTargetDEF, new Pair<>((applyto.getSkillLevel(15121054) > 0 ? 9 : this.x) * applyto.lightning, this.y * 1000));
                localstatups.put(SecondaryStat.IndiePmdR, new Pair<>((applyto.getSkillLevel(15121054) > 0 ? 5 : 0) * applyto.lightning, this.y * 1000));
                break;
            }
            case 15110025: { // 연쇄 구현
                localstatups.put(SecondaryStat.IndiePmdR, new Pair<>(applyfrom.hexaMasterySkillStack * 6, 30000));
                break;
            }
            case 21121017: {
            ...
            case 20040220: {
                ...
                if (applyfrom.hexaMasterySkillStack != 0) { // 오리진 하모닉 패러독스 구현
                    localDuration = applyfrom.hexaMasterySkillStack;
            ...
            case 33111007: { //비스트 폼
                ...
                localstatups.put(SecondaryStat.IndieNotDamaged, new Pair<Integer, Integer>(1, 2000)); // 무적
            ...
            case 35111002: {
                if (applyfrom.tesla == 3) {
                    System.err.println("tesla pass : " + applyfrom.tesla);
                    if (applyto.getCooldownLimit(35111002) <= 0L && applyfrom.tesla > 4) {
                        break;
                    }
            ...
            case 36121054: { //아마란스 제너레이터
                ...
                if (applyto.getBuffedValue(SecondaryStat.Overload) != null) {
                    applyto.setXenonSurplus((short) 40, SkillFactory.getSkill(this.sourceid));
                    applyto.updateXenonSurplus((short) 40, SkillFactory.getSkill(this.sourceid));
                } else if (applyto.getXenonSurplus() < 20) {
            ...
            case 51141002: { // 로얄 가드 VI 구현
                ...
                SkillFactory.getSkill(51141003).getEffect(1).applyTo(applyto, false);
                break;
            }
            case 51141004: // 로얄 가드 VI 구현
            case 51141005: // 로얄 가드 VI 구현
            case 51141006: // 로얄 가드 VI 구현
            case 51141007: { // 로얄 가드 VI 구현
                bufftimeR = false;
                aftercancel = true;
                int duration1 = (applyto.getRoyalStack() != 5) ? ((applyto.getRoyalStack() != 4) ? ((applyto.getRoyalStack() != 3) ? ((applyto.getRoyalStack() != 2) ? 1420 : 1330) : 1280) : 1230) : 150;
                if (applyto.getBuffedValue(400011083)) {
            ...
            case 51001006: {
                bufftimeR = false;
                localDuration = applyto.getRoyalStack() * 2000; // 클라우 솔라스
                localstatups.put(SecondaryStat.IndieNotDamaged, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 51001011:
            ...
            case 51141003: { // 로얄 가드 VI 구현
                bufftimeR = false;
                localDuration = applyto.getRoyalStack() * 2000; // 클라우 솔라스
                localstatups.put(SecondaryStat.IndieNotDamaged, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 51141010: // 로얄 가드 VI 구현
            case 51141011: // 로얄 가드 VI 구현
            case 51141012: { // 로얄 가드 VI 구현
                bufftimeR = false;
                localstatups.put(SecondaryStat.IndieNotDamaged, new Pair<Integer, Integer>(1, 4000));
                break;
            }
            ...
            case 51141008: // 로얄 가드 VI 구현
            case 51141009: { // 로얄 가드 VI 구현
                int pad = 0;
                switch (applyto.getRoyalStack()) {
                    case 4: {
                        pad = this.getW2();
            ...
            case 51111008: {
                ...
                if (applyfrom.getId() == applyto.getId()) {
                    ...
                    if (leader != null) {
                        ...
                        boolean isHexa = leader.getSkillLevel(51141002) > 0;
                        if (leader.getBuffedValue(isHexa ? 51141002 : 51001005)) {
            ...
            case 61120008:
            case 61121053: {
                if (applyfrom.hexaMasterySkillStack != 0) { // 오리진 마이트 오브 노바 구현
                    localDuration = applyfrom.hexaMasterySkillStack;
                ...
                final int[] array2;
                final int[] skilllist = array2 = new int[]{61101002, 61110211, 61120007, 61121217, 61141006, 61141007}; // 윌 오브 소드 VI 구현
                for (final Integer skill : array2) {
                    if (applyto.getBuffedValue(skill)) {
                        applyto.cancelEffect(applyto.getBuffedEffect(skill));
                    }
                }
                if (applyfrom.getSkillLevel(61141006) > 0) { // 윌 오브 소드 VI 구현
                    SkillFactory.getSkill(61141007).getEffect(applyto.getSkillLevel(61141007)).applyTo(applyfrom);
                    break;
                }
            ...
            case 65141000: { // 트리니티 VI 구현
                localstatups.clear();
                int value = (int) (applyto.getSkillCustomValue(this.sourceid) == null ? 0L : applyto.getSkillCustomValue0(this.sourceid));
                if (value >= 2) {
                    break;
                }
                applyto.setSkillCustomInfo(this.sourceid, value + 1, 0L);
                if (applyto.getSkillCustomValue0(this.sourceid) > 3L) {
                    applyto.setSkillCustomInfo(this.sourceid, 3L, 0L);
                    value = (int) applyto.getSkillCustomValue0(this.sourceid);
                }
                localstatups.put(SecondaryStat.Trinity, new Pair<Integer, Integer>(this.x * (value + 1), 30000));
                localstatups.put(SecondaryStat.DamR, new Pair<Integer, Integer>(this.x * (value + 1), 30000));
                localstatups.put(SecondaryStat.IgnoreMobPdpR, new Pair<Integer, Integer>(this.x * (value + 1), 30000));
                localDuration = 30000;
                break;
            }
            case 80000268:
            ...
            case 400001066: { //제로 : 트랜센던트 [수정필요]
                localstatups.put(SecondaryStat.Transcendent, new Pair<Integer, Integer>(1, 30000));
                break;
            }
            case 100001263: //제로 : 디바인오라
            {
                if (primary) {
                    localDuration = 0;
            ...
            case 80003224:
            case 150030241: {//칼리 : 이네이트 기프트
                localstatups.clear(); //IndieUnk1
                localstatups.put(SecondaryStat.IndieUnk1, new Pair<Integer, Integer>(this.w, 5000));
                localstatups.put(SecondaryStat.IndiePmdR, new Pair<Integer, Integer>(this.w, 5000));
                break;
            }
            case 400041089: { //칼리 : 레조네이트 - 얼티메이텀
                // localstatups.clear();
                localstatups.put(SecondaryStat.Ultimatum, new Pair<Integer, Integer>(1, 50000));
                break;
            }
            ...
            case 154120003:
            case 154101009: { // 칼리 : 보이드 러쉬
                localstatups.put(SecondaryStat.DarkSight, new Pair<Integer, Integer>(Integer.valueOf(this.level), 3000));
                break;
            }
            ...
            case 400041084:
            case 400041085:
            case 400041086: { // 칼리 : 보이드버스트 [작업 필요]
                localstatups.put(SecondaryStat.IndieNotDamaged, new Pair<Integer, Integer>(1, 3500));
                localstatups.put(SecondaryStat.VoydBust, new Pair<Integer, Integer>(1, 3500));
                break;
            }

            case 400051070: { //[othello] 바이퍼 : 하울링 피스트
                localstatups.put(SecondaryStat.IndieNotDamaged, new Pair<Integer, Integer>(1, 3000));
                break;
            }
            case 11121157: { //[othello] 소울마스터 : 블레이징 어썰트, 러스터 차지
            ...
            case 80002632: {
                localstatups.clear();
                localstatups.put(SecondaryStat.YalBuff, new Pair<Integer, Integer>(15, 0));
                localstatups.put(SecondaryStat.IndiePmdR, new Pair<Integer, Integer>(10, 0));
                break;
            }
            case 80002633: {
                localstatups.clear();
            ...
            case 400011053: {
                if (applyto.hasDonationSkill(400011052)) {
                    localstatups.put(SecondaryStat.BlessedHammer2, new Pair<Integer, Integer>(applyto.getElementalCharge(), 0));
                } else {
            ...
            case 400011110: {
                localstatups.put(SecondaryStat.IndieNotDamaged, new Pair<>(1, (int) this.t * 1000));
                break;
            }
            case 400011111: {
            ...
            case 400031006: {
                ...
                localstatups.put(SecondaryStat.IndieNotDamaged, new Pair<Integer, Integer>(1, 1000));
            ...
            case 400031017: { // 팅스킬?
                localstatups.put(SecondaryStat.UnkBuffStat2, new Pair<Integer, Integer>(1932417, 1000));
                localstatups.put(SecondaryStat.IndiePadR, new Pair<Integer, Integer>(1, 1000));
                localstatups.put(SecondaryStat.IndieKeyDownMoving, new Pair<Integer, Integer>(1, 1000));
...
//                localstatups.put(SecondaryStat.IgnisRore, new Pair<Integer, Integer>(10, localDuration));
            ...
            case 400031055: { //리피팅 크로스보우 카트리지
                applyto.repeatingCrossbowCatridge = 32;
                int Cartridge = applyto.repeatingCrossbowCatridge / 4;
                localstatups.put(SecondaryStat.RepeatingCrossbowCatridge, new Pair<Integer, Integer>(Cartridge, localDuration));
                break;
            }
            ...
            case 400041009: { //조커
                if (primary) {
                    localstatups.put(SecondaryStat.IndieDamageReduce, new Pair<Integer, Integer>(this.y, 6500));
            ...
            case 400041026:
            case 400041027: { //절개
                localstatups.put(SecondaryStat.NotDamaged, new Pair<Integer, Integer>(0, 3000));
                break;
            }
            ...
            case 400051077: { // 풀 메이커 버프
                applyto.addHP(applyto.getStat().getCurrentMaxHp() / 10L);
                localstatups.put(SecondaryStat.IndieDamR, new Pair<Integer, Integer>(Integer.valueOf(this.indieDamR), localDuration));
                break;
            }
            case 400051078: {
            ...
            case 5121052: { //서펜트 스피릿
                localDuration = 91000;
                localstatups.put(SecondaryStat.IndieCD, new Pair<Integer, Integer>(applyto.수룡의의지 * 5, localDuration));
                break;
            }
            case 5120011: { //디펜스 폼
                localstatups.put(SecondaryStat.IndieUnk1, new Pair<Integer, Integer>(1, 4000));
                localstatups.put(SecondaryStat.IndieDamReduceR, new Pair<Integer, Integer>(1, 4000));
                break;
            }
            case 5220012: {//오펜스 폼
                localstatups.put(SecondaryStat.IndieDamR, new Pair<Integer, Integer>(Integer.valueOf(this.indieDamR), localDuration));
            ...
            case 3111015: {
                if (!applyto.getBuffedValue(3111015)) {
                    applyto.removeSkillCustomInfo(3111015);
                    applyto.removeSkillCustomInfo(3111016);
                }
                aftercancel = true;
                localstatups.put(SecondaryStat.FlashMirage, new Pair<>((int) (1 + applyto.getSkillCustomValue0(3111015)), 0));
                break;
            }
            case 1320016: {
            ...
            // 작업 221213 다크나이트
            case 1310013: { //다크나이트: 비홀더 도미넌트
                localDuration = 0;
                localstatups.put(SecondaryStat.Beholder, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 1321020:
                localstatups.put(SecondaryStat.ReincarnationAccept, new Pair<>((int) applyto.getSkillCustomValue0(1321020), 0));
                break;
            case 1320019: {
                int buffType = (int) applyfrom.getSkillCustomValue0(1321020);
                SecondaryStatEffect eff = SkillFactory.getSkill(1320016).getEffect(level);

                int data = 0;
                int cooldown = 0;
                int notDamageDuration = 0;
                int needCountDuration = 0;
                int skillid = 1320020 + buffType;
                switch (buffType) {
                    case 1: {
                        data = eff.getZ();
                        cooldown = eff.getCooldown(applyto);
                        notDamageDuration = eff.getDuration();
                        needCountDuration = eff.getQ() * 1000;
                        break;
                    }
                    case 2: {
                        data = eff.getW();
                        cooldown = eff.getQ2() * 1000;
                        notDamageDuration = eff.getU2() * 1000;
                        needCountDuration = eff.getDOT() * 1000;
                        break;
                    }
                    case 3: {
                        data = eff.getV();
                        cooldown = eff.getV2() * 1000;
                        notDamageDuration = eff.getU() * 1000;
                        needCountDuration = 40000;
                        break;
                    }
                }
                SkillList.add(new Pair<>(SecondaryStat.Reincarnation, skillid));
                applyto.addCooldown(1320019, System.currentTimeMillis(), cooldown);
                applyto.getClient().send(CField.skillCooldown(1320019, cooldown));
                SkillFactory.getSkill(1320016).getEffect(level).applyTo(applyto, cooldown);
                if (applyfrom.getSkillLevel(1320047) > 0) {
                    data -= (data * SkillFactory.getSkill(1320047).getEffect(1).getX()) / 100;
                }
                localstatups.put(SecondaryStat.IndieNotDamaged, new Pair<>(1, notDamageDuration));
                localstatups.put(SecondaryStat.Reincarnation, new Pair<>(data, needCountDuration));
                localstatups.put(SecondaryStat.ChargeBuff, new Pair<>(buffType, notDamageDuration));
                applyto.getClient().send(CField.EffectPacket.showEffect(applyto, 0, skillid, 1, 0, 0, (byte) (applyto.isFacingLeft() ? 1 : 0), true, null, null, null));
                applyto.getMap().broadcastMessage(applyto, CField.EffectPacket.showEffect(applyto, 0, skillid, 1, 0, 0, (byte) (applyto.isFacingLeft() ? 1 : 0), false, null, null, null), false);
                applyto.setSkillCustomInfo(1320016, data, 0);
                applyto.setReinCarnation(data);
                break;
            }
            case 5101017: {
            ...
            // MapleExtremeBoss DamageReducing Buff
            case 80002636: {
                int reduceValue = MapleExtremeBoss.getDamReduceByMap(applyto.getMapId());
                if (reduceValue > 0) {
                    localstatups.put(SecondaryStat.IndieDamReduceR, new Pair<Integer, Integer>(reduceValue, 0));
                } else {
                    System.err.println("Error - SecondaryStat[80002636] - reduceValue is null Or negative number");
                }
                break;
            }
            case 80001537: { // GM BUFF
                if (applyto.isGM()) {
                    localstatups.put(SecondaryStat.IndiePad, new Pair<Integer, Integer>(500000000, 0));
                    localstatups.put(SecondaryStat.IndieMad, new Pair<Integer, Integer>(200000000, 0));
                    localstatups.put(SecondaryStat.IndieDamR, new Pair<Integer, Integer>(1000000000, 0));
            ...
            case 80002889: {
                localstatups.put(SecondaryStat.BeyondNextAttackProb, new Pair<Integer, Integer>(1, 30000));
                break;
            }
            case 400001052: {
            ...
            case 80001740: {
                localstatups.clear();
                localstatups.put(SecondaryStat.PVPUnk_441, new Pair<Integer, Integer>((int) applyto.getSkillCustomValue0(80001740), localDuration));
                break;
            }
            case 80002673: {
                localstatups.clear();
            ...
            case 80001733: {
                localstatups.clear();
                localDuration = 4000;
                localstatups.put(SecondaryStat.PVPUnk_440, new Pair<Integer, Integer>(30, localDuration));
            ...
            case 80001675: {
                localstatups.clear();
                localDuration = 10000;
                localstatups.put(SecondaryStat.Poison, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 80001658: {
                localstatups.clear();
            ...
            case 80001732: {
                localstatups.clear();
                localstatups.put(SecondaryStat.PVPUnk_439, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 80001649: {
                localstatups.clear();
            ...
            case 142121005: { //[othello] 얼티메이트- b.p.m
                localstatups.clear();
                localstatups.put(SecondaryStat.UltimateBPM, new Pair<Integer, Integer>(1, 0));
                break;
            }
            case 60001216:
            case 60001217: {
            ...
            case 400051041: { //메탈아머: 전탄발사
                localstatups.clear();
                if (primary) {
                    localstatups.put(SecondaryStat.NotDamaged, new Pair<Integer, Integer>(1, 50000));
                    break;
                }
            ...
            case 400001064: { // 에르다 파운틴
                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 400011126: { // 소드 일루젼
                if (applyto.getBuffedValue(1101013)) {
                    localstatups.put(SecondaryStat.IndiePmdR, new Pair<Integer, Integer>(72, 8000));
                }
                break;
            }
            case 400001042: {
            ...
            case 1111003: {
                localstatups.clear();
                localstatups.put(SecondaryStat.ScaringSword, new Pair<Integer, Integer>((int) applyto.getSkillCustomValue0(1111003), localDuration));
                break;
            }
            case 1110009: {
                localstatups.clear();
                localstatups.put(SecondaryStat.IndiePmdR, new Pair<Integer, Integer>(25, 5000));
                localstatups.put(SecondaryStat.IndieCD, new Pair<Integer, Integer>(20, 5000));
                break;
            }
            ...
            case 37000013:
            case 37001002:
            case 37141002: // 릴리즈 파일 벙커 VI
            case 37141003: // 릴리즈 파일 벙커 VI
            case 37141004: // 릴리즈 파일 벙커 VI
            case 37141005: // 릴리즈 파일 벙커 VI
            case 37141006: // 릴리즈 파일 벙커 VI
            case 37141007: { // 버스트 파일 벙커
                localstatups.clear();
            ...
            case 63111013:
            case 63120001: { //데스 블레싱
                localstatups.clear();
                localstatups.put(SecondaryStat.DeathBlessing, new Pair<Integer, Integer>(this.x + SkillFactory.getSkill(63120001).getEffect(20).getX(), localDuration));
                break;
            }
            case 63111009: {
                localstatups.clear();
        ...
        if (applyto.getKeyValue(800023, "indiepmer3") > 0) {
            damRs += (int) applyto.getKeyValue(800023, "indiepmer3");
            //  applyto.dropMessage(6, "0번 수치 : " + applyto.getKeyValue(800023, "indiepmer3"));
        }

        if (applyto.getKeyValue(9919, "DamageTear") > 0) {
            int tear = (int) applyto.getKeyValue(9919, "DamageTear");
            damRs += tear == 8 ? 240 : tear == 7 ? 190 : tear == 6 ? 145 : tear == 5 ? 105 : tear == 4 ? 75 : tear == 3 ? 55 : tear == 2 ? 35 : 10;
        }
        if (this.sourceid == 80002924 && applyto.getKeyValue(53714, "atk") != -1L) {
            localstatups.put(SecondaryStat.IndieDamR, new Pair<Integer, Integer>((int) applyto.getKeyValue(53714, "atk") + damRs, 0));
            // applyto.dropMessage(6, "1번 수치 : " + applyto.getKeyValue(53714, "atk"));
        }
        if (this.sourceid == 80002419 && applyto.getKeyValue(800024, "indiepmer") > 0) {
            localstatups.put(SecondaryStat.IndieDamR, new Pair<Integer, Integer>((int) applyto.getKeyValue(800024, "indiepmer") + damRs, 0));
            //  applyto.dropMessage(6, "2번 수치 : " + applyto.getKeyValue(800023, "indiepmer"));
        ...
        if (this.isMonsterRiding() && !localstatups.containsKey(SecondaryStat.RideVehicle)) {
            ...
            if (applyfrom.getMapId() == ServerConstants.warpMap && this.sourceid / 10000 == 8000) {
                applyfrom.getClient().getSession().writeAndFlush(SLFCGPacket.BlackLabel("#fn나눔고딕 ExtraBold##fs32##b#e잠수포인트 적립을 시작합니다.", 100, 1000, 4, 0, 0, 1, 4));
        ...
        if (this.skill && !applyto.isHidden() && !isPetBuff && applyfrom.getId() == applyto.getId()) {
            ...
            if (!GameConstants.isLinkMap(applyto.getMapId()) && showEffect && !GameConstants.isKhali(applyto.getJob())) { //[othello]칼리 멀티팅 체크 6만원짜리 지렸따~ && !GameConstants.isKhali(applyto.getJob())
...
//                System.out.println("버프 종착점 : " + SkillFactory.getSkill(this.sourceid).getName() + " / " + SkillFactory.getSkill(this.sourceid).getId());
        ...
        if (localstatups.size() > 0) {
            applyto.getClient().getSession().writeAndFlush(CWvsContext.BuffPacket.giveBuff(localstatups, this, applyto, SkillList));
            applyto.getMap().broadcastMessage(applyto, CWvsContext.BuffPacket.giveForeignBuff(applyto, localstatups, this), false);

            if (sourceid == 162121012 || sourceid == 162121012) {
                List<Integer> skillList = new ArrayList<>();
                for (int i = 0; i < 8; i++) {
                    skillList.add(sourceid == 162121012 ? 162121013 : 162101004);

                }
                applyto.getClient().getSession().writeAndFlush(CField.SummonPacket.NewSummonSkill(sourceid, skillList));
            }
        }
    ...
    private boolean isPartyBuff(MapleCharacter applyfrom, MapleCharacter applyto) {
        ...
        switch (this.sourceid) {
            case 2321006: //[othello] 리저렉션 파티버프 적용
            case 400011021: //[othello] 홀리유니티 파티버프 적용
            case 1101006:
            case 1211011:
            case 1301006:
            case 1301007:
    ...
    public final boolean isKhaliHyper() {
        return this.skill && this.sourceid == 154121043;
    }
    ...
    public final int getCooldown(final MapleCharacter chra) { // 쿨타임
        ...
        if (cooltime > 0) {
            ...
            if (sourceid == 27121303) {
                localCooltime = 12000;
            } else if (sourceid == 27121303) { // 앱솔루트 킬 VI 구현
                localCooltime = 10000;
            }
        ...
        //몹 모으기, 바인드 스킬추가 - 후원스킬
        if (this.sourceid == 80001839) {
            if (GameConstants.보스맵(chra.getMap().getId())) {
                cooltime = 3 * 60 * 1000;
                cooltimeMS = 3 * 60 * 1000;
                localCooltime = 3 * 60 * 1000;
            } else {
                cooltime = 30 * 60 * 1000;
                cooltimeMS = 30 * 60 * 1000;
                localCooltime = 30 * 60 * 1000;
            }
        }
    ...
    public final boolean isMist() {
        if (this.skill) {
            switch (this.sourceid) {
                ...
                case 11076:
                case 2100010:
                case 80001839:  //몹 모으기, 바인드 스킬추가 - 후원스킬
                case 2221055:
                case 2111003:
                case 2201009:
                case 2311011:
                ...
                case 24121052:
                case 25111206:
                case 25111014: // 오리진 호신강림 구현
                case 25141003: // 오리진 호신강림 구현
                case 32121006:
                case 35120002:
                case 35121052:
                case 36121007:
                ...
                case 162111003:
                case 162121018:
                case 162141008: // 분출 : 해돋이 우물 VI 구현
                case 400001017:
                case 400010010:
                case 400011098:
                case 400011100:
    ...
    private static boolean isHeroWill(int skillId) {
        switch (skillId) {
            case 1121011:
            case 1221012:
            case 1321010:
    ...
    public final SummonMovementType getSummonMovementType() {
        ...
        switch (this.sourceid) {
            ...
            case 500001002: // HEXA 솔 야누스 구현
            case 500001003: // HEXA 솔 야누스 구현
            case 500001004: { // HEXA 솔 야누스 구현
                return SummonMovementType.STATIONARY;
            }
            case 400001059: // 크레스트 오브 더 솔라
            case 2111010:
            case 32111006:
            case 33001007:
            case 33001008:
            ...
            case 152101000:
            case 152141505: // 오리진 언리미티드 크리스탈 구현
            case 400011088:
            case 400041028: {
