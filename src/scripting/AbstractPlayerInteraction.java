...
public abstract class AbstractPlayerInteraction {
    ...
    public final void dojowarp(int mapid) {
        ...
        this.c.getPlayer().getClient().getSession().writeAndFlush(CField.environmentChange("Map/Effect2.img/MuruengTime", 21));
    }
    ...
    public final void doJoWarpMap(final int mapid) {
        ...
        this.c.getPlayer().getClient().getSession().writeAndFlush(CField.environmentChange("dojang/start/number/" + stage, 21));
        if (stage - 1 > 1
        ...
        for (int i = 0; i < file.size(); i++) {
            for (int j = i + 1; j < file.size(); j++) {
                if (((Integer) ((Triple) file.get(i)).left).intValue() < ((Integer) ((Triple) file.get(j)).left).intValue()) {
                    ...
                    file.set(j, temp);
                } else if (((Triple) file.get(i)).left == ((Triple) file.get(j)).left && ((Integer) ((Triple) file.get(i)).mid).intValue() > ((Integer) ((Triple) file.get(j)).mid).intValue()) {
                    Triple<Integer, Integer, String> temp = file.get(i);
                    file.set(i, file.get(j));
                    file.set(j, temp);
                }
    ...
    public final void CheckTime() {
        if ((this.c.getPlayer().getMap()).PapulratusPatan == 2) {
            ...
            for (MapleMonster monster : this.c.getPlayer().getMap().getAllMonster()) {
                if (monster.getCustomValue0(구역) != 4L && (monster.getId() == 8500001 || monster.getId() == 8500011 || monster.getId() == 8500021)) {
    ...
    public final void MakePmdrItem999(int itemid, int count) {
        ...
        c.getPlayer().setKeyValue(800023, "indiepmer999", String.valueOf((c.getPlayer().getKeyValue(800023, "indiepmer999")) + count));
    }
    ...
    public final void MakePmdrItem9(int itemid, int count) {
        ...
        c.getPlayer().setKeyValue(800023, "indiepmer9", String.valueOf((c.getPlayer().getKeyValue(800023, "indiepmer9")) + count));
    }
    ...
    public final void MakePmdrItem10(int itemid, int count) {
        ...
        c.getPlayer().setKeyValue(800023, "indiepmer10", String.valueOf((c.getPlayer().getKeyValue(800023, "indiepmer10")) + count));
    }
    ...
    public final void EnterSulo() {
        ...
        server.Timer.EventTimer.getInstance().schedule(() -> {
            c.getSession().writeAndFlush((Object) CField.environmentChange("Effect/EventEffect.img/ChallengeMission/Count/3", 16));
            c.getSession().writeAndFlush((Object) SLFCGPacket.playSE("Sound/MiniGame.img/multiBingo/3"));
            c.getPlayer().dropMessage(5, "1");
            server.Timer.EventTimer.getInstance().schedule(() -> {
                c.getSession().writeAndFlush((Object) CField.environmentChange("Effect/EventEffect.img/ChallengeMission/Count/2", 16));
                c.getSession().writeAndFlush((Object) SLFCGPacket.playSE("Sound/MiniGame.img/multiBingo/2"));
                c.getPlayer().dropMessage(5, "2");
            }, 1000L);
            server.Timer.EventTimer.getInstance().schedule(() -> {
                c.getSession().writeAndFlush((Object) CField.environmentChange("Effect/EventEffect.img/ChallengeMission/Count/1", 16));
                c.getSession().writeAndFlush((Object) SLFCGPacket.playSE("Sound/MiniGame.img/multiBingo/1"));
                c.getPlayer().dropMessage(5, "3");
            }, 2000L);
            server.Timer.EventTimer.getInstance().schedule(() -> {
                c.getSession().writeAndFlush((Object) CField.environmentChange("Effect/EventEffect.img/ChallengeMission/start", 16));
