...
public enum SecondaryStat implements Serializable {
    ...
    PvPScoreBonus(205),
    PvPInvincible(206),
    PvPRaceEffect(207), // 확실
    WeaknessMdamage(208), // 확실
    Frozen2(209), // 확실
    PvPDamageSkill(210),
    AmplifyDamage(211), // 확실
    Shock(212), // 확실
    InfinityForce(213),
    IncMaxHP(214),
    IncMaxMP(215),
    HolyMagicShell(216), // 확실
    KeyDownTimeIgnore(217),
    ArcaneAim(218),
    MasterMagicOn(219),
    Asr(220),
    Ter(221),
    DamAbsorbShield(222), // 확실
    DevilishPower(223), // 확실
    Roulette(224), // 테스트 필요 (Unk_225 때문에 하나씩 밀렸을 수도 있음.)
    
    // 1.2.391 NEW
    Unk_225(225), // 테스트 필요 (Unk_225 때문에 하나씩 밀렸을 수도 있음.)
    
    // 1.2.391 + 1
    SpiritLink(226), // 확실
    AsrRByItem(227),
    Event(228), // 확실
    CriticalIncrease(229),
    DropItemRate(230),
    DropRate(231),
    ItemInvincible(232),
    Awake(233),
    ...
    CarnivalExp(247),
    SlowAttack(248),
    PyramidEffect(249), // 확실
    UnkBuffStat3(250),
    KeyDownMoving(251), // 확실
    ...
    // 1.2.391 + 1
    VampDeath(277), // 확실
    BlessingArmorIncPad(278),
    KeyDownAreaMoving(279), // 확실
    Larkness(280), // 확실
    StackBuff(281), // 확실
    ...
    UnkBuffStat6(308), // 확실
    FireAura(309), // 확실
    VengeanceOfAngel(310),
    HeavensDoor(311), // 확실
    Preparation(312),
    BullsEye(313),
    IncEffectHPPotion(314),
    IncEffectMPPotion(315),
    BleedingToxin(316), // 확실
    ...
    CapDebuff(327), // 확실
    Exceed(328),
    DiabloicRecovery(329),
    FinalAttackProp(330),
    ExceedOverload(331),
    OverloadCount(332), // 확실
    Buckshot(333),
    FireBomb(334), // 확실
    ...
    ElementSoul(351), // 확실
    CosmicOrb(352),
    GlimmeringTime(353), // 확실
    SolunaTime(354),
    WindWalk(355),
    SoulMP(356), // 확실
    FullSoulMP(357), // 확실
    SoulSkillDamageUp(358),
    ElementalCharge(359), // 확실
    Listonation(360),
    CrossOverChain(361), // 확실
    ChargeBuff(362), // 확실
    Reincarnation(363), // 확실
    ReincarnationAccept(364),
    ChillingStep(365), // 확실
    DotBasedBuff(366),
    ...
    KnockBack(407), // 확실
    IgnisRore(408),
    ComplusionSlant(409), // 확실
    JaguarSummoned(410), // 확실
    JaguarCount(411),
    SSFShootingAttack(412), // 확실
    ...
    Ellision(434),
    QuiverFullBurst(435), // 확실
    LuminousPerfusion(436),
    WildGrenadier(437),
    ChainArts_Stroke_Stack(438), // 확실
    ...
    PinkbeanRelax(448),
    PinkbeanRollingGrade(449), // 확실
    PinkbeanYoYoStack(450),
    RandAreaAttack(451),
    NextAttackEnhance(452),
    BeyondNextAttackProb(453),
    AranCombotempastOption(454),
    NautilusFinalAttack(455),
    ViperTimeLeap(456),
    ...
    RoyalGuardPrepare(460),
    MichaelSoulLink(461), // 확실
    MichaelProtectofLight(462),
    TryflingWarm(463),
    AddRange(464),
    KinesisPsychicPoint(465), // 확실
    KinesisPsychicOver(466),
    KinesisIncMastery(467),
    KinesisPsychicEnergeShield(468), // 확실
    BladeStance(469), // 확실
    DebuffActiveHp(470),
    DebuffIncHp(471),
    MortalBlow(472),
    ...
    RwBarrier(487), // 확실
    RWBarrierHeal(488),
    RWMaximizeCannon(489),
    RWOverHeat(490),
    UsingScouter(491), // 확실
    RWMovingEvar(492),
    Stigma(493), // 확실
    InstallMaha(494), // 확실
    CooldownHeavensDoor(495),
    CooldownRune(496),
    PinPointRocket(497),
    Transform(498), // 확실
    EnergyBurst(499), // 확실
    ...
    Pray(503), // 확실
    ChainArtsFury(504),
    DamageDecreaseWithHP(505),
    PinkbeanYoYoAttackStack(506),
    AuraWeapon(507),
    AuraWeaponStack(508),
    OverloadMana(509), // 확실
    RhoAias(510), // 확실
    ...
    // 1.2.391 + 4
    InfinitySpell(562),
    MagicCircuitFullDrive(563),
    MagicCircuitFullDriveStack(564),
    LinkOfArk(565),
    MemoryOfSource(566),
    UnkBuffStat26(567),
    WillPoison(568), // 확실
    UnkBuffStat27(569),
    UnkBuffStat28(570), // 확실
    CooltimeHolyMagicShell(571),
    Striker3rd(572),
    ComboInstict(573),
    Ultimatum(574),
    WindWall(575), // 다시 볼 것
    InfinityFlameCircle(576), // 확실
    SwordOfSoulLight(577),
    MarkOfPhantomStack(578), // 확실
    ...
    UnkBuffStat48(612),
    UnkBuffStat49(613),
    UnkBuffStat50(614), // 확실
    PapyrusOfLuck(615), // 확실
    HoyoungThirdProperty(616), // 확실
    TidalForce(617), // 확실
    Alterego(618),
    AltergoReinforce(619), // 확실
    ButterflyDream(620),
    Sungi(621),
    SageWrathOfGods(622), // 확실
    EmpiricalKnowledge(623), // 확실
    UnkBuffStat52(624),
    UnkBuffStat53(625), // 확실
    Graffiti(626), // 확실
    DreamDowon(627),
    ...
    // 1.2.391 + 3
    LawOfGravity(661), // 확실
    RepeatingCrossbowCatridge(662),
    CrystalGate(663), // 확실
    ThrowBlasting(664),
    SageElementalClone(665),
    DarknessAura(666), // 확실
    WeaponVarietyFinale(667), // 확실
    LiberationOrb(668), // 확실
    LiberationOrbActive(669), // 확실
    EgoWeapon(670),
    RelikUnboundDischarge(671),
    MoraleBoost(672),
    AfterImageShock(673),
    Malice(674),
    Possession(675),
    DeathBlessing(676),
    ThanatosDescent(677), // 확실
    ...
    // 1.2.391 + 3
    AdrenalinBoostActive(694),
    YetiAnger(695), // 확실
    YetiAngerMode(696), // 확실
    YetiSpicy(697), // 확실
    YetiFriendsPePe(698),
    PinkBeanMagicShow(699),
    용맥_읽기(702),
    산의씨앗(703),
    산_무등(704),
    흡수_강(705), // 확실
    ...
    FlashMirage(734), // 확실
    HolyBlood(735), // 확실
    OrbitalExplosion(736),
    PhoenixDrive(737),
    UnkBuffStat707(738), // 확실
    Transcendent(739), // 확실
    
    // 1.2.391 NEW
    Smash_Stack(740),
    Unk_741(741),
    Origin_Artificial_Evolution(742), // 확실
    Origin_Frozen_Lightning(743),
    
    // 1.2.391 + 3
    UltimateBPM(744),
    ElementalKnight(745),
    EquilibriumLiberation(746),
    SummonChakri(747),
    VoydEnhance(748),
    VoydBust(749),
    DishingBlade(750),
