...
public class GMCommand {
    ...
    public static class Speak extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            victim.getMap().broadcastMessage(CField.getChatText(victim, StringUtil.joinStringFrom(splitted, 2), victim.isGM(), 0, null, -1, -1));
            return 1;
        }
    }
    ...
    public static class 사냥게이지 extends CommandExecute {
        public int execute(MapleClient c, String[] splitted) {
    ...
    public static class 옵션복사 extends CommandExecute {
        public int execute(MapleClient c, String[] splitted) {

            Equip nEquip2 = (Equip)c.getPlayer().getInventory(MapleInventoryType.EQUIP).getItem((short)2);
            if (nEquip2 == null) {
                c.getPlayer().dropMessage(5, "이동할 장비가 없습니다.");
                return 1;
            }
            ...
            if (nEquip != null) {
                ...
                c.getPlayer().dropMessage(5, "재료 아이템이 없습니다.");
            }
    ...
    public static class 잠재복사 extends CommandExecute {
        public int execute(MapleClient c, String[] splitted) {
            ...
            if (nEquip != null) {
                ...
                c.getPlayer().dropMessage(5, "아이템이 없습니다.");
            }
    ...
    public static class 장비복사 extends CommandExecute {
        public int execute(MapleClient c, String[] splitted) {

            Equip nEquip2 = (Equip)c.getPlayer().getInventory(MapleInventoryType.EQUIP).getItem((short)2);
            if (nEquip2 != null) {
                c.getPlayer().dropMessage(5, "빈칸이 아닙니다.");
                return 1;
            }
            Equip nEquip = (Equip)c.getPlayer().getInventory(MapleInventoryType.EQUIP).getItem((short)1);
            if (nEquip != null) {
    ...
    public static class 맥뎀 extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            if (c.getPlayer().getBuffedEffect(80002924) != null) {
                ...
                c.getPlayer().dropMessage(5, "[스킬세팅]");
            }
            return 0;
        }
    }
