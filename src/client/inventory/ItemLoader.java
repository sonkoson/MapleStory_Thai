            ...
            while (rs.next()) {
                ...
                if (rs.getInt("itemid") / 1000000 == 1) {
                    ...
                    if (!login) {
                        ...
                        equip.setBossDamage((short) rs.getShort("bossDamage"));
                        equip.setIgnorePDR((short) rs.getShort("ignorePDR"));
                        ...
                        if (this.table_enchant != null && type.getType() != 6) {
                            ps1 = con.prepareStatement("SELECT * FROM `" + this.table_enchant + "` WHERE inventoryitemid = ?");
                            ...
                            if (rs1.next()) {
                                ...
                                equip.setStarforceStr(rs1.getShort("starforcestr"));
                                equip.setStarforceDex(rs1.getShort("starforcedex"));
                                equip.setStarforceInt(rs1.getShort("starforceint"));
                                equip.setStarforceLuk(rs1.getShort("starforceluk"));
                                equip.setStarforceWatk(rs1.getShort("starforcewatk"));
                                equip.setStarforceMatk(rs1.getShort("starforcematk"));
                            }
                            rs1.close();
                            ps1.close();
                        }
