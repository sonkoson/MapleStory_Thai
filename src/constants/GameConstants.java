...
public class GameConstants {
    ...
    public static ArrayList<Integer> jobOrders = new ArrayList<>();

    static {
        jobOrders.add(112); // 1.2.390 OK. OK.
        jobOrders.add(122); // 1.2.390 OK. OK.
        jobOrders.add(132); // 1.2.390 OK. OK.
        jobOrders.add(212); // 1.2.390 OK. OK.
        jobOrders.add(222); // 1.2.390 OK. OK.
        jobOrders.add(232); // 1.2.390 OK. OK.
        jobOrders.add(312); // 1.2.390 OK. OK.
        jobOrders.add(322); // 1.2.390 OK. OK.
        jobOrders.add(332); // 1.2.390 OK. OK.
        jobOrders.add(412); // 1.2.390 OK. OK.
        jobOrders.add(422); // 1.2.390 OK. OK.
        jobOrders.add(434); // 1.2.390 OK. OK.
        jobOrders.add(512); // 1.2.390 OK. OK.
        jobOrders.add(522); // 1.2.390 OK. OK.
        jobOrders.add(532); // 1.2.390 OK. OK.
        jobOrders.add(5112); // 1.2.390 OK. 72
        jobOrders.add(1112); // 1.2.390 OK. -4
        jobOrders.add(1212); // 1.2.390 OK. -4
        jobOrders.add(1312); // 1.2.390 OK. -4
        jobOrders.add(1412); // 1.2.390 OK. -4
        jobOrders.add(1512); // 1.2.390 OK. -4
        jobOrders.add(2112); // 1.2.390 OK. -4
        jobOrders.add(2217); // 1.2.390 OK. -4
        jobOrders.add(2712); // 1.2.390 OK. 8
        jobOrders.add(2312); // 1.2.390 OK. -8
        jobOrders.add(2412); // 1.2.390 OK. -8
        jobOrders.add(2512); // 1.2.390 OK. -8
        jobOrders.add(3712); // 1.2.390 OK. 20
        jobOrders.add(3212); // 1.2.390 OK. OK.
        jobOrders.add(3312); // 1.2.390 OK. OK.
        jobOrders.add(3612); // 1.2.390 OK. OK.
        jobOrders.add(3512); // 1.2.390 OK. OK.
        jobOrders.add(3112); // 1.2.390 OK. -24
        jobOrders.add(3122); // 1.2.390 OK. -24
        jobOrders.add(6112); // 1.2.390 OK. OK.
        jobOrders.add(6312); // 1.2.390 OK. OK.
        jobOrders.add(6412); // 1.2.390 OK. OK.
        jobOrders.add(6512); // 1.2.390 OK. OK.
        jobOrders.add(10112); // 1.2.390 OK. OK. 
        jobOrders.add(14212); // 1.2.390 OK. OK.
        jobOrders.add(15112); // 1.2.390 OK. OK.
        jobOrders.add(15212); // 1.2.390 OK. OK.
        jobOrders.add(15412); // 1.2.390 OK. OK.
        jobOrders.add(15512); // 1.2.390 OK. OK.
        jobOrders.add(16212); // 1.2.390 OK. OK.
        jobOrders.add(16412); // 1.2.390 OK. OK.
    }
    ...
    static {
        ...
        for (a = 260; a < 300; a++) {
            if (a == 260) {
                exp[a] = 1731919984062L;
            } else if (a == 265) {
                exp[a] = (long) Math.floor(exp[a - 1] * 1.30D);
            } else if (a == 270) {
                exp[a] = (long) Math.floor(exp[a - 1] * 2.22D);
            } else if (a == 275 || a == 280 || a == 285 || a == 290 || a == 295) {
                exp[a] = (long) Math.floor(exp[a - 1] * 2.02D);
            } else if (a < 276) {
                exp[a] = (long) Math.floor(exp[a - 1] * 1.01D);
            } else {
                exp[a] = (long) Math.floor(exp[a - 1] * 1.10D);
            }
        }

        exp[300] = Long.MAX_VALUE;
    }
    ...
    public static boolean isSolaAndLunaSkill(int skillId) {
        switch (skillId) {
            case 11001226:
            case 11110228:
            case 11120217:
            case 11100228:
            case 11141200: // 솔라 슬래시 VI
                return true;
            case 11001126:
            case 11100128:
            case 11110128:
            case 11120117:
            case 11141100: // 루나 디바이드 VI
                return true;
        }
    ...
    public static final boolean isDemonSlash(int skillid) {
        switch (skillid) {
            ...
            case 31110010:
            case 31120011:
            case 31141002: // 데몬 슬래시 VI 구현
            case 31141003: // 데몬 슬래시 VI 구현
            case 31141004: // 데몬 슬래시 VI 구현
            case 31141005: // 데몬 슬래시 VI 구현
                return true;
        }
        return false;
    }
    ...
    public static boolean isAuthenticSymbol(int itemid) {
        return (itemid >= 1713000 && itemid <= 1713005);
    }
    ...
    //[SEX] 준비된 정령의 펜던트 수정
    public static int[] expbuff = new int[]{1122334};
    ...
    public static short getSlotMax(int itemId) {
        switch (itemId) {
            ...
            case 5064000:
            case 5064300:
            case 2049371: // 17성 스타포스
            case 2434021: //명예의 훈장
            case 2702003:
            case 2702004:
            case 2702006:
            case 2702002: //써큘레이터
            case 2436338: //어센틱 선택권
            case 2631717:
            case 2434311:
            case 4034939:
            case 4001178:
    ...
    public static long needArcSymbolMeso(int itemId, int level) {
        switch (itemId) {
            case 1712001:
                switch (level) {
                    case 1:
    ...
    public static long needAutSymbolMeso(int itemId, int level) {
        switch (itemId) {
            case 1713000:
                switch (level) {
                    case 1:
    ...
    public static boolean isExceedAttack(int id) {
        switch (id) {
            ...
            case 31221011:
            case 31221012:
            case 31241002: // 익시드 : 엑스큐션 VI 구현
            case 31241003: // 익시드 : 엑스큐션 VI 구현
            case 31241004: // 익시드 : 엑스큐션 VI 구현
            case 31241005: // 익시드 : 엑스큐션 VI 구현
            case 31241006: // 익시드 : 엑스큐션 VI 구현
                return true;
        }
        return false;
    }
    ...
    public static boolean isEquilibriumSkills(int skillid) {
        switch (skillid) {
            case 27111303:
            case 27121303:
            case 27141000: // 앱솔루트 킬 VI 구현
            case 27141500: // 오리진 하모닉 패러독스 구현 1
            case 27141501: // 오리진 하모닉 패러독스 구현 2
                return true;
        }
        return false;
    }
    ...
    public static boolean isTryFling(int skillid) {
        switch (skillid) {
            ...
            case 13120003:
            case 13120010:
            case 13141001: // 트라이플링 윔 VI 구현 1
            case 13141002: // 트라이플링 윔 VI 구현 2
                return true;
        }
        return false;
    }
    ...
    public static boolean isZeroSkill(int a1) {
        ...
        return (v1 == 10000 || v1 == 10100 || v1 == 10110 || v1 == 10111 || v1 == 10112 || v1 == 10114);
    }
    ...
    public static boolean sub_140D58510(int a1) { // 1.2.390 ++
        return a1 == 21121057
                || a1 == 13121052
                || a1 == 14121052
                || a1 == 15121052
    ...
    public static boolean is_thunder_rune(int a1) {
        return (a1 == 80001752 || a1 == 80002212 || a1 == 80002463);
    }
...
//         // 0 : 돼지고기볶음, 1 : 달팽이요리, 2 : 해파리냉채, 3 : 버섯칼국수, 4 : 슬라임푸딩
    ...
    public static void attackBonusRecv(LittleEndianAccessor COutPacket, AttackInfo attackInfo) {
        COutPacket.readByte();
        COutPacket.readByte();

        attackInfo.slot = COutPacket.readShort();
        attackInfo.item = COutPacket.readInt();
        ...
        attackInfo.position = new Point(COutPacket.readInt(), COutPacket.readInt());

        COutPacket.readInt();
        COutPacket.readInt();

        int unkValue = COutPacket.readInt();

        for (int i = 0; i < unkValue; i++) {
            COutPacket.readInt();
        }
        ...
        for (int i = 0; i < 0; i++) { // i < unkValue ?
            COutPacket.readInt();
        }

        COutPacket.readInt(); // 1.2.390 ++
        COutPacket.readInt(); // 1.2.390 ++
        COutPacket.readInt(); // 1.2.390 ++
        COutPacket.readInt(); // 1.2.390 ++
        COutPacket.readInt(); // 1.2.390 ++
        COutPacket.readMapleAsciiString(); // 1.2.390 ++
        COutPacket.readInt(); // 1.2.390 ++
    }
    ...
    public static void attackSkeletonImage(LittleEndianAccessor lea, AttackInfo ret) { // 1.2.390 OK.
    ...
    public static int getLinkedSkill(int id) {
        switch (id) {
            case 1141002: // 레이지 업라이징 VI
                return 1121052;
            case 1241004: // 디바인 스티그마 VI
                return 1221021;
            case 1341001: // 다크 임페일 VI
                return 1321012;
            case 1341003: // 다크 신서시스 VI
                return 1321052;
            case 2141000: // 플레임 스윕 VI
                return 2121006;
            case 2141003: // 플레임 헤이즈 VI
                return 2121011;
            case 2141005: // 미스트 이럽션 VI
                return 2121003;
            case 2241000: // 체인 라이트닝 VI
                return 2221006;
            case 2241002: // 프로즌 오브 VI
                return 2221012;
            case 2241003: // 블리자드 VI
                return 2221007;
            case 2241004: // 블리자드 VI (파이널 어택)
                return 2220014;
            case 2341000: // 엔젤레이 VI
                return 2321007;
            case 2341002: // 빅뱅 VI
                return 2321001;
            case 2341004: // 트라이엄프 페더 VI
                return 2311015;
            case 3141000: // 폭풍의 시 VI
                return 3121020;
            case 3141004: // 애로우 플래터 VI
                return 3111013;
            case 3241000: // 스나이핑 VI
                return 3221007;
            case 3241001: // 인핸스 스나이핑 VI
                return 3221025;
            case 3241002: // 인핸스 스나이핑 VI (추가타)
                return 3221026;
            case 3341001: // 카디널 블래스트 VI
                return 3321005;
            case 4241007: // 메소 익스플로젼 VI
                return 4241006;
            case 4361001: // 아수라 VI
                return 4341052;
            case 5141009: // 전함 노틸러스 VI
                return 5121013;
            case 5141501: // 오리진 리버레이트 넵투누스
            case 5141502: // 오리진 리버레이트 넵투누스
            case 5141503: // 오리진 리버레이트 넵투누스
            case 5141504: // 오리진 리버레이트 넵투누스
            case 5141505: // 오리진 리버레이트 넵투누스
            case 5141506: // 오리진 리버레이트 넵투누스
                return 5141500; // 오리진 리버레이트 넵투누스
            case 5241002: // 배틀쉽 봄버 VI
                return 5221022;
            case 5241003: // 배틀쉽 봄버 VI
                return 5241002;
            case 5341005: // 마그네틱 앵커 VI
                return 5321003;
            case 5341006: // 전함 노틸러스 VI
                return 5321001;
            case 11141002: // 코스믹 샤워 VI
                return 11111029;
            case 21141001: // 비욘더 VI
            case 21141002: // 비욘더 VI
            case 21141003: // 비욘더 VI
                return 21141000; // 비욘더 VI
            case 21141501: // 오리진 아드레날린 서지
            case 21141502: // 오리진 아드레날린 서지
            case 21141503: // 오리진 아드레날린 서지
            case 21141504: // 오리진 아드레날린 서지
            case 21141505: // 오리진 아드레날린 서지
            case 21141506: // 오리진 아드레날린 서지
                return 21141500; // 오리진 아드레날린 서지
            case 23141003: // 래쓰 오브 엔릴 VI
                return 23121052;
            case 23141005: // 레전드리 스피어
                return 23121002;
            case 24141000: // 템페스트 오브 카드 VI
                return 24121005;
            case 25141504: // 오리진 호신강림 구현
                return 400051043;
            case 27141000: // 앱솔루트 킬 VI
                return 27121303;
            case 31141000: // 데몬 임팩트 VI
                return 31121001;
            case 31141003: // 데몬 슬래시 VI
            case 31141004: // 데몬 슬래시 VI
            case 31141005: // 데몬 슬래시 VI
                return 31141002; // 데몬 슬래시 VI
            case 31241000: // 실드 체이싱 VI
                return 31221001;
            case 31241001: // 실드 체이싱 VI
                return 31241000;
            case 32141000: // 데스 VI
                return 32001014;
            case 32141002: // 배틀킹 바 VI 1
                return 32121052;
            case 32141003: // 배틀킹 바 VI 2
                return 32120055;
            case 33141006: // 클로우 컷 VI
                return 33001016;
            case 33141007: // 프로보크 VI
                return 33001025;
            case 33141008: // 크로스 로드 VI
                return 33101115;
            case 33141010: // 소닉붐 VI
                return 33111015;
            case 33141011: // 재규어 소울 VI
                return 33121017;
            case 33141012: // 램피지 애즈 원 VI
            case 33141013: // 플래쉬 레인 VI
                return 33121155;
            case 37141000: // 매그넘 펀치 VI
                return 37001000;
            case 37141001: // 더블 팡 VI
                return 37101000;
            case 63141000: // 폴링 더스트 VI
                return 63121002;
            case 63141004: // [처형] 포이즌 니들 VI
                return 63121006;
            case 63141007: // 스트라이크 애로우 VI
                return 63001000;
            case 63141010: // [처형] 테어링 나이프 VI
                return 63111007;
            case 63141011: // [처형] 체인 시클 VI
                return 63121004;
            case 63141100: // [발현] 폴링 더스트 VI
                return 63121102;
            case 63141107: // [발현] 스트라이크 애로우 VI
                return 63101100;
            case 63141109: // [발현] 스캐터링 샷 VI
                return 63101104;
            case 101141000: // 기가 크래시 VI
                return 101121100;
            case 101141014: // 터닝 드라이브 VI
                return 101111100;
            case 101141017: // 롤링 커브 VI
                return 101111200;
            case 142141000: // 얼티메이트-메테리얼 VI
                return 142001002;
            case 151141002: // 샤드 VI
                return 151001001;
            case 151141003: // 원더 VI
                return 151101013;
            case 151141004: // 오더 VI
                return 151111003;
            case 151141005: // 트레드 VI
                return 151121002;
            case 154141003: // 보이드 러쉬 VI
                return 154121009;
            case 154141008: // 보이드 블리츠 VI
                return 154121003;
            case 154141001: // 아츠 : 크레센텀 VI
                return 154101001;
            case 154141002: // 아츠 : 크레센텀 VI (쿨타임 감소)
                return 154101002;
            case 154141009: // 헥스 : 차크람 스플릿 VI
                return 154121001;
            case 155141000: // 플레인 차지드라이브 VI
                return 155001100;
            case 155141004: // 스칼렛 차지드라이브 VI 1
                return 155101100;
            case 155141005: // 스칼렛 차지드라이브 VI 2
                return 155101101;
            case 155141006: // 스칼렛 차지드라이브 VI 3
                return 155101112;
            case 155141007: // 스칼렛 차지드라이브 VI 4
                return 155101013;
            case 155141008: // 스칼렛 차지드라이브 VI 5
                return 155101015;
            case 155141011: // 거스트 차지드라이브 VI 1
                return 155111102;
            case 155141012: // 거스트 차지드라이브 VI 2
                return 155111111;
            case 155141016: // 어비스 차지드라이브 VI 1
                return 155121102;
            case 155141017: // 어비스 차지드라이브 VI 2
                return 155121002;
            case 155141021: // 지워지지 않는 상처 VI 1
                return 155101200;
            case 155141022: // 지워지지 않는 상처 VI 2
                return 155101201;
            case 155141024: // 채워지지 않는 굶주림 VI 1
                return 155111202;
            case 155141025: // 채워지지 않는 굶주림 VI 2
                return 155111211;
            case 155141026: // 채워지지 않는 굶주림 VI 3
                return 155111212;
            case 155141027: // 걷잡을 수 없는 혼돈 VI 1
                return 155121202;
            case 155141028: // 걷잡을 수 없는 혼돈 VI 2
                return 155121215;
            case 164141000: // 멸화염 : 천 VI
                return 164121000;
            case 164141005: // 지진쇄 : 지 VI
                return 164111003;
            case 164141011: // 금고봉 : 인 VI
                return 164121003;
            case 164141030: // 여의선 : 인 VI
                return 164001000;
            case 164141033: // 토파류 : 지 VI
                return 164101000;
            case 164141035: // 파초풍 : 천 VI
                return 164111000;
            case 5221027:
                return 5221022;
            case 400051097:
            ...
            case 36121013:
            case 36121014:
            case 36141004: // 홀로그램 그래피티 : 관통 VI
            case 36141005: // 홀로그램 그래피티 : 역장 VI
            case 36141006: // 홀로그램 그래피티 : 지원 VI
                return 36121002;
            case 36121011:
            case 36121012:
                return 36121001;
    ...
    public static boolean isExceptionSkill(int jobId, int skillId) { // 쿨타임 도중 데미지 적용 예외 처리 스킬
        int originSkillId = getHexaOriginFirst(jobId);

        if (skillId == originSkillId) {
            return true;
        } else {
            switch (skillId) {
                case 1241502: // 오리진 세이크리드 바스티온 구현
                case 3341503: // 오리진 포세이큰 렐릭 구현
                case 14141501: // 오리진 사일런스 구현
                case 31141006: // 데모닉 스피어 구현
                case 80003365: // 오리진 바인드 구현
                case 155141004: // 스칼렛 차지드라이브 VI 구현
                case 400021092:
                    return true;
                default:
                    return false;
    ...
    public static boolean isExceptionSpecialMove(int skillId) { // HEXA 스페셜 무브 예외 처리
        switch (skillId) {
            ...
            case 13141501: // 오리진 미스트랄 스프링 구현 1
            case 13141505: // 오리진 미스트랄 스프링 구현 2
            case 14141502: // 오리진 사일런스 구현
            case 23141501: // 오리진 언페이딩 글로리 구현 1
            case 23141503: // 오리진 언페이딩 글로리 구현 2
            case 25111014: // 오리진 호신강림 구현 1
            case 25141003: // 오리진 호신강림 구현 2
            case 25141506: // 오리진 호신강림 구현 3
            case 31141501: // 오리진 나이트메어 구현 1
            case 31141503: // 오리진 나이트메어 구현 2
            case 31241501: // 오리진 레퀴엠 구현 1
            case 31241502: // 오리진 레퀴엠 구현 2
            case 33141503: // 오리진 네이쳐스 빌리프
            case 35141501: // 오리진 그라운드 제로 구현
            case 36141004: // 홀로그램 그래피티 : 관통 VI 구현
            case 36141005: // 홀로그램 그래피티 : 역장 VI 구현
            case 36141006: // 홀로그램 그래피티 : 지원 VI 구현
    ...
    public static int getDifferencePatchNumber(int jobId) { // 특정 직업 군 강화 코어 특수 처리
        switch (jobId) {
            case 1112:
            case 1212:
            case 1312:
    ...
    public static int getHexaOriginFirst(int jobId) {
        if (isEvan(jobId)) { // 에반 특수 처리
            jobId++;
        }

        int skillCode = Integer.parseInt(((jobId + 2) + "1500"));

        return skillCode;
    }

    public static int getHexaActiveFirst(int jobId) {
        if (isEvan(jobId)) { // 에반 특수 처리
            jobId++;
        }

        String number = "1000";
        if (isSoulMaster(jobId)) {
            number = "1200";
        }

        int skillCode = Integer.parseInt(((jobId + 2) + number));

        return skillCode;
    }

    public static ArrayList<Integer> getHexaActiveFirstOption(int jobId) {
        ArrayList<Integer> skillCodes = new ArrayList<>();

        if (isPaladin(jobId)) {
            skillCodes.add(1240001);
        } else if (isPathFinder(jobId)) {
            skillCodes.add(3341002);
        } else if (isBlaster(jobId)) {
            skillCodes.add(37141001);
        } else if (isCain(jobId)) {
            skillCodes.add(63141004);
        } else if (isZero(jobId)) {
            skillCodes.add(101141001);
            skillCodes.add(101141003);
            skillCodes.add(101141006);
            skillCodes.add(101141008);
            skillCodes.add(101141009);
            skillCodes.add(101141012);
        } else if (isAdel(jobId)) {
            skillCodes.add(151141002);
            skillCodes.add(151141003);
        } else if (isKhali(jobId)) {
            skillCodes.add(154141001);
        } else if (isArk(jobId)) {
            skillCodes.add(155141004);
            skillCodes.add(155141011);
            skillCodes.add(155141016);
        } else if (isHoyeong(jobId)) {
            skillCodes.add(164141005);
            skillCodes.add(164141011);
            skillCodes.add(164141029);
        }

        return skillCodes;
    }

    public static int getHexaActiveSecond(MapleCharacter chr, int count, boolean isHexaSkillData) {
        ...
        String number = "1001";
        if (isPathFinder(jobId)) {
            number = "1004";
        } else if (isViper(jobId)) {
            number = "0004";
        } else if (isSoulMaster(jobId)) {
            number = "1002";
        ...
        Skill hexaActiveSecondSkill = SkillFactory.getSkill((skillCode + count));

        if (isHexaSkillData) {
            while (hexaActiveSecondSkill == null || hexaActiveSecondSkill.isInvisible()) {
                hexaActiveSecondSkill = SkillFactory.getSkill((skillCode + count));

                count++;
            }
        } else {
            if (hexaActiveSecondSkill == null) {
                if (count != 0) {
                    if (isKhali(jobId)) {
                        if ((skillCode + count) == 154141005 || (skillCode + count) == 154141006) {
                            return 0;
                        }
                    }
            ...
            if (hexaActiveSecondSkill.isInvisible()) {
                return 0;
            }
        }

        return hexaActiveSecondSkill.getId();
    }

    public static ArrayList<Integer> getHexaActiveSecondOption(int jobId) {
        ArrayList<Integer> skillCodes = new ArrayList<>();

        if (isViper(jobId)) {
            skillCodes.add(5141009);
        }

        return skillCodes;
    }

    public static int getHexaEnhanceFirst(int jobOrder) {
        return (500004000 + (jobOrder * 4));
    }

    public static int getHexaEnhanceSecond(int jobOrder) {
        return (500004000 + (jobOrder * 4 + 1));
    }

    public static int getHexaEnhanceThird(int jobOrder) {
        return (500004000 + (jobOrder * 4 + 2));
    }

    public static int getHexaEnhanceFourth(int jobOrder) {
        return (500004000 + (jobOrder * 4 + 3));
    }

    public static int 잠수포인트(final int mapid) { //잠수포인트 조정
        int 포인트량 = 0;
        switch (mapid) {
            case 993236200: //마을
                포인트량 = 2;
