...
public class test {
    ...
    public static void main(String[] args) {
        byte[] msg = HexTool.getByteArrayFromHexString("3A FD D7 17 01 00 00 00 A1 EA 9B 21 01 05 00 00 00 FF FF FF FF D0 06 00 00 02 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 1F 02 31 01 00 9E C1 1A 60 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 66 8F F2 D2 B8 AA 01 A7 C3 C3 33 F2 01 00 00 00 3A FD D7 17 01 00 00 00 09 00 00 00 00 00 00 00 00 00 ED 01 13 01 00 00 00 00 1E 00 00 00 01 00 00");
            ...
            do {
                ...
                switch (k) {
                    ...
                    case 8: // 1.2.390 OK.
                        ...
                        if (ret.across) {
                            ret.acrossPosition = new Rectangle(slea.readInt(), slea.readInt(), slea.readInt(), slea.readInt());
                        }
                    ...
                    case 34: // 1.2.390 OK.
                        ...
                        if (x > 0) {
                            ...
                            for (int i = 0; i < size; i++) {
                                ret.attackObjects.add(new Pair(Integer.valueOf(slea.readInt()), Integer.valueOf(slea.readInt())));
                            }
                        }
        ...
        slea.skip(4);
        slea.skip(4);
        if (skillid == 3321004 || skillid == 400031034
        ...
        System.out.println("skillid : " + skillid + " level : " + level + " aa : " + aa + " k : " + k + " unk1 : " + unk1 + " unk2 : " + unk2 + " bullet : " + bullet);
        /*
        int buffstat = 0x100;
        int pos = 10;
