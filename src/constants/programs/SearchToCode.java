...
public class SearchToCode extends javax.swing.JFrame {
    ...
    private void 장비ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_장비ActionPerformed
        아이템.setSelected(false);
        체크[1] = false;
        체크[0] = true;
    }//GEN-LAST:event_장비ActionPerformed

    private void 아이템ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_아이템ActionPerformed
