...
public class UserInformation extends javax.swing.JFrame {
    ...
    public UserInformation(String ip, String id, int accountId, String name, int characterId, short level, long seasonPassLevel, long meso, int num_4310282, String accountCreate) {
        this.ip = ip;
        this.id = id;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("[세션 아이피] ");

        jLabel2.setText("[계정 아이디] ");

        jLabel4.setText("[캐릭터 닉네임] ");

        jLabel6.setText("[레벨] ");

        jLabel7.setText("[시즌패스 레벨] ");

        jLabel10.setText("[메소] ");

        jLabel11.setText("[보스 코인 갯수] ");

        jLabel12.setText("[계정 생성일] ");

        jLabel3.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 153, 153));
        jLabel3.setText("캐릭터 정보");
